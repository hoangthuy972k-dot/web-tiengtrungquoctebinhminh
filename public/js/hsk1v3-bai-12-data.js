...
var vocabData = [
  {n:1,zh:'天气',py:'tiānqì',pos:'Danh từ',vn:'thời tiết',em:'🌦️',lesson:1,
   ...
   hanzi:[
     {c:'天',p:'tiān',type:'独体字 · Chỉ sự',st:4,ord:'一→一→丿→㇏',rad:'大 (đại – to lớn)',mean:'trời, bầu trời, ngày',
      ...
      cf:'太 (tài – "quá, thái", cũng từ 大 thêm dấu chấm)',w:'天气 / 今天 / 明天'},
     {c:'气',p:'qì',type:'独体字 · Tượng hình',st:4,ord:'丿→一→一→乙',rad:'气 (khí – tự thành bộ)',mean:'khí, hơi, không khí',
  ...
  {n:2,zh:'这里',py:'zhèlǐ',pos:'Đại từ',vn:'ở đây, chỗ này',em:'📍',lesson:1,
   ...
   hanzi:[
     {c:'这',p:'zhè',type:'半包围结构 · Bán bao vây',st:7,ord:'文(văn) trong → 辶(sước) bao ngoài dưới-trái',rad:'辶 (sước – đi, chuyển động)',mean:'này, đây',
      tip:'Bộ 辶(đi, tiến đến gần) bao lấy 文(dấu hiệu, sự vật) → chỉ sự vật đang ở NGAY GẦN, TRƯỚC MẮT → NÀY, ĐÂY.',
      cf:'那 (nà – "kia, đó", đối lập vị trí xa-gần với 这)',w:'这里 / 这个 / 这是'},
     {c:'里',p:'lǐ',type:'上下结构 · Trên-dưới',st:7,ord:'田(điền) trên → 土(thổ) dưới',rad:'里 (lý – tự thành bộ)',mean:'bên trong, dặm (đơn vị đo)',
  ...
  {n:3,zh:'天',py:'tiān',pos:'Danh từ',vn:'thời tiết, trời',em:'☁️',lesson:1,
   ...
   exList:[{zh:'这里的天不太好，下雨了。',py:'Zhèlǐ de tiān bú tài hǎo, xià yǔ le.',vn:'Thời tiết ở đây không ổn lắm, mưa rồi ạ.'}],
   hanzi:[
     {c:'天',p:'tiān',type:'独体字 · Chỉ sự',st:4,ord:'一→一→丿→㇏',rad:'大 (đại – to lớn)',mean:'trời, bầu trời, thời tiết',
  ...
  {n:4,zh:'下雨',py:'xià yǔ',pos:'Động từ',vn:'mưa, mưa rơi',em:'🌧️',lesson:1,
   ...
   hanzi:[
     {c:'雨',p:'yǔ',type:'独体字 · Tượng hình',st:8,ord:'一→冂→丨→丶丶丶丶',rad:'雨 (vũ – tự thành bộ)',mean:'mưa',
      ...
      cf:'雪 (xuě – "tuyết")',w:'下雨'},
     {c:'下',p:'xià',type:'独体字 · Chỉ sự',st:3,ord:'一(ngang, mốc) → 丨(sổ) → 丶(chấm dưới)',rad:'一 (nhất – nét ngang, chỉ vị trí)',mean:'dưới, xuống, rơi xuống',
  ...
  {n:5,zh:'了',py:'le',pos:'Trợ từ',vn:'(dùng cuối câu chỉ sự thay đổi tình hình hoặc trạng thái)',em:'❕',lesson:1,
   ...
   exList:[{zh:'这里的天不太好，下雨了。',py:'Zhèlǐ de tiān bú tài hǎo, xià yǔ le.',vn:'Thời tiết ở đây không ổn lắm, mưa rồi ạ.'}],
   hanzi:[
     {c:'了',p:'le',type:'独体字 · Chữ đơn',st:2,ord:'乛(ngang gập) → 亅(sổ móc)',rad:'乙 (ất – nét cong, quy ước)',mean:'trợ từ chỉ sự hoàn thành/thay đổi',
  ...
  {n:7,zh:'有点儿',py:'yǒudiǎnr',pos:'Phó từ',vn:'hơi, hơi... một chút',em:'📏',lesson:1,
   ...
   hanzi:[
     {c:'有',p:'yǒu',type:'上下结构 · Trên-dưới',st:6,ord:'𠂇(tay, biến thể) trên → 月(nguyệt/thịt) dưới',rad:'月 (nguyệt – thịt/tháng)',mean:'có',
      tip:'𠂇(bàn tay) cầm nắm lấy 月(miếng thịt) → cầm được vật trong tay → CÓ.',
      cf:'右 (yòu – "bên phải", cùng phần trên nhưng dưới là 口 không phải 月)',w:'有点儿 / 没有 / 有的'},
     {c:'点',p:'diǎn',type:'上下结构 · Trên-dưới',st:9,ord:'占(chiêm) trên → 灬(hỏa) dưới',rad:'灬 (hỏa – lửa, biến thể 4 chấm)',mean:'chấm, điểm, một chút; giờ',
      tip:'Bộ 灬(4 chấm nhỏ tượng trưng đốm lửa) → nghĩa mở rộng thành CHẤM nhỏ, MỘT CHÚT, ĐIỂM.',
      cf:'店 (diàn – "cửa hàng", cũng có 占 nhưng thêm bộ 广")',w:'有点儿 / 一点儿 / 几点'},
     {c:'儿',p:'r',type:'独体字 · Tượng hình',st:2,ord:'丿(phẩy) → 乚(sổ cong)',rad:'儿 (nhi – tự thành bộ, người)',mean:'con, trẻ nhỏ; hậu tố uốn lưỡi (儿化音)',
  ...
  {n:8,zh:'觉得',py:'juéde',pos:'Động từ',vn:'cảm thấy',em:'💭',lesson:1,
   ...
   exList:[{zh:'有点儿大，我觉得很冷。',py:'Yǒudiǎnr dà, wǒ juéde hěn lěng.',vn:'Hơi to ạ, em cảm thấy rất lạnh.'}],
   hanzi:[
     {c:'觉',p:'jué',type:'上中下结构 · Trên-giữa-dưới',st:9,ord:'⺍(nét nhỏ) trên → 冖(che phủ) giữa → 见(kiến) dưới',rad:'见 (kiến – nhìn, thấy)',mean:'cảm thấy, nhận ra; ngủ (giấc)',
      ...
      cf:'学 (xué – "học", cũng có phần trên ⺍冖 giống nhưng dưới là 子")',w:'觉得 / 睡觉 / 感觉'},
     {c:'得',p:'de',type:'左中右结构 · Trái-giữa-phải',st:11,ord:'彳(xích) trái → 日+一 giữa → 寸(thốn) phải',rad:'彳 (xích – bước chân nhỏ, đi lại)',mean:'được, đạt được; (trong "觉得" mang nghĩa "cảm thấy")',
  ...
  {n:10,zh:'下',py:'xià',pos:'Động từ',vn:'(mưa, tuyết...) rơi',em:'🌨️',lesson:2,
   ...
   hanzi:[
     {c:'下',p:'xià',type:'独体字 · Chỉ sự',st:3,ord:'一(ngang, mốc) → 丨(sổ) → 丶(chấm dưới)',rad:'一 (nhất – nét ngang, chỉ vị trí)',mean:'dưới, xuống, (mưa/tuyết) rơi',
  ...
  {n:13,zh:'公司',py:'gōngsī',pos:'Danh từ',vn:'công ty',em:'🏢',lesson:2,
   ...
   exList:[{zh:'你昨天没来公司，生病了？',py:'Nǐ zuótiān méi lái gōngsī, shēngbìng le?',vn:'Hôm qua bạn không đến công ty, bị ốm à?'}],
   hanzi:[
     {c:'公',p:'gōng',type:'上下结构 · Trên-dưới',st:4,ord:'八(bát) trên → 厶(khư) dưới',rad:'八 (bát – chia, tách ra)',mean:'công cộng, công bằng; ông (kính xưng)',
      tip:'八(chia đều làm hai) đặt trên 厶(cái riêng tư, cá nhân) → chia sẻ CÁI RIÊNG thành CHUNG → CÔNG CỘNG, CÔNG BẰNG.',
      cf:'分 (fēn – "chia, phút", cũng có bộ 八 ở trên)',w:'公司 / 公园 / 老公'},
     {c:'司',p:'sī',type:'半包围结构 · Bán bao vây',st:5,ord:'𠃌(bao trên-trái) → 一 → 口(khẩu) bên trong',rad:'口 (khẩu – miệng)',mean:'ty, ban, cơ quan quản lý; điều hành',
  ...
  {n:14,zh:'生病',py:'shēngbìng',pos:'Động từ',vn:'ốm, bị ốm, bị bệnh',em:'🤒',lesson:2,
   ...
   hanzi:[
     ...
     {c:'生',p:'shēng',type:'独体字 · Chữ đơn',st:5,ord:'丿→一→丨→一→一',rad:'生 (sinh – tự thành bộ)',mean:'sinh ra, sống, mọc lên; (sinh) bệnh',
  ...
  {n:15,zh:'看病',py:'kànbìng',pos:'Động từ',vn:'khám bệnh',em:'🏥',lesson:2,
   ...
   hanzi:[
     {c:'看',p:'kàn',type:'上下结构 · Trên-dưới',st:9,ord:'手(thủ, biến thể) trên → 目(mục) dưới',rad:'目 (mục – mắt)',mean:'xem, nhìn; khám (bệnh)',
      tip:'Bàn 手(tay) che lên trên 目(mắt) như đang nhìn ra xa cho rõ → XEM, NHÌN; dùng với bệnh viện/bác sĩ → KHÁM (bệnh).',
      cf:'着 (zhe/zháo – cũng có 目 ở dưới nhưng phần trên là 羊")',w:'看病 / 看书 / 看电视'},
     {c:'病',p:'bìng',type:'半包围 · Bán bao (疒)',st:10,ord:'疒(bộ bệnh) → 丙 bên trong',rad:'疒 (nạch – bệnh tật)',mean:'bệnh, ốm',
      tip:'Bộ 疒 = hình người nằm trên giường bệnh. Thấy 疒 → nghĩ ngay tới ỐM ĐAU.',
  ...
  {n:17,zh:'一点儿',py:'yìdiǎnr',pos:'Số lượng từ',vn:'một chút, một ít',em:'🤏',lesson:3,
   ...
   hanzi:[
     {c:'一',p:'yì',type:'独体字 · Chỉ sự',st:1,ord:'一 (một nét ngang duy nhất)',rad:'一 (nhất – tự thành bộ, số một)',mean:'một, số 1',
      ...
      cf:'二 (èr – "số hai", thêm một nét ngang thứ hai)',w:'一点儿 / 一起 / 第一'},
     {c:'点',p:'diǎn',type:'上下结构 · Trên-dưới',st:9,ord:'占(chiêm) trên → 灬(hỏa) dưới',rad:'灬 (hỏa – lửa, biến thể 4 chấm)',mean:'chấm, điểm, một chút; giờ',
      tip:'Bộ 灬(4 chấm nhỏ tượng trưng đốm lửa) → nghĩa mở rộng thành CHẤM nhỏ, MỘT CHÚT, ĐIỂM.',
      cf:'店 (diàn – "cửa hàng", cũng có 占 nhưng thêm bộ 广")',w:'一点儿 / 有点儿 / 几点'},
     {c:'儿',p:'r',type:'独体字 · Tượng hình',st:2,ord:'丿(phẩy) → 乚(sổ cong)',rad:'儿 (nhi – tự thành bộ, người)',mean:'con, trẻ nhỏ; hậu tố uốn lưỡi (儿化音)',
      tip:'Hình người đang bước đi bằng hai chân (biến thể của 人) → dùng chỉ CON, TRẺ NHỎ; khi đứng sau âm tiết khác thì đọc lướt thành âm "-r".',
  ...
  {n:19,zh:'天',py:'tiān',pos:'Lượng từ',vn:'ngày',em:'📆',lesson:3,
   ...
   hanzi:[
     {c:'天',p:'tiān',type:'独体字 · Chỉ sự',st:4,ord:'一→一→丿→㇏',rad:'大 (đại – to lớn)',mean:'ngày, trời',
  ...
  {n:21,zh:'再',py:'zài',pos:'Phó từ',vn:'sau đó, mới (chỉ trình tự)',em:'➡️',lesson:3,
   ...
   exList:[{zh:'回家后再喝些热水。',py:'Huí jiā hòu zài hē xiē rè shuǐ.',vn:'Sau khi về nhà nhớ uống thêm ít nước ấm nhé.'}],
   hanzi:[
     {c:'再',p:'zài',type:'独体字 · Chữ đơn',st:6,ord:'一(trên) → 冂(khung bao) → 二(hai nét ngang bên trong)',rad:'冂 (quynh – khung bao ngoài)',mean:'lại, thêm lần nữa, sau đó',
