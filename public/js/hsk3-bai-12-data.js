...
var matchData = [
  ...
  {left:'如果你把重要的东西放在我这儿，',right:'我就帮你拿好。'},
...
var fillData = [
  ...
  {pre:'如果没有人帮你，你就得',blank:'自己',post:'解决。',hint:'(tự mình, bản thân)',ans:'自己'},
  {pre:'因为外面下雨，所以我把伞放在',blank:'包',post:'里了。',hint:'(cặp, túi)',ans:'包'},
  {pre:'打开包以后我才',blank:'发现',post:'钱包没了。',hint:'(phát hiện)',ans:'发现'},
  {pre:'到了机场，我才发现没带',blank:'护照',post:'，只好又回家拿。',hint:'(hộ chiếu)',ans:'护照'},
  {pre:'请大家坐好，飞机就要',blank:'起飞',post:'了。',hint:'(cất cánh)',ans:'起飞'},
  {pre:'',blank:'司机',post:'把我送到机场以后。',hint:'(tài xế)',ans:'司机'},
  {pre:'她',blank:'教',post:'我们说中文。',hint:'(dạy)',ans:'教'},
...
// ══════════════════════════════════════════
var sortData = [
  {words:['太阳','出来','以后','，','我们','就','去','跑步','了','。'],ans:'太阳出来以后，我们就去跑步了。',audio:'太阳出来以后，我们就去跑步了。'},
  ...
  {words:['如果','你','把','重要','的','东西','放在','我','这儿','，','我','就','帮','你','拿好','。'],ans:'如果你把重要的东西放在我这儿，我就帮你拿好。',audio:'如果你把重要的东西放在我这儿，我就帮你拿好。'},
...
var errorFixData = [
  ...
  {wrong:'弟弟三个小时洗才完衣服。',
   opts:['弟弟三个小时才洗完衣服。','弟弟三个小时洗才完衣服。','弟弟才三个小时洗完衣服。','弟弟三个小时洗完才衣服。'],ans:0,
   exp:'才 phải đứng NGAY TRƯỚC động từ (洗完), không chen vào giữa động từ và bổ ngữ.'},
  {wrong:'我把照片你的包在放了。',
  ...
  dictation: [
    {num:1, lines:[
      {speaker:"女1", pre:"", blank:"你的腿好点了吗", post:"？",
       py:"Nǐ de tuǐ hǎo diǎn le ma?",
       vn:"Chân bạn đỡ hơn chưa?"},
      {speaker:"女2", pre:"还有点儿疼。", blank:"今天太阳不错，你带我出去吧", post:"。",
       py:"Hái yǒudiǎnr téng. Jīntiān tàiyáng búcuò, nǐ dài wǒ chūqu ba.",
       vn:"Vẫn còn hơi đau. Hôm nay trời nắng đẹp, bạn đưa mình ra ngoài đi."}]},
    {num:2, lines:[
    ...
    {num:5, lines:[
      {speaker:"女", pre:"", blank:"会议早就开始了，你怎么现在还没来", post:"？",
       py:"Huìyì zǎo jiù kāishǐ le, nǐ zěnme xiànzài hái méi lái?",
       vn:"Cuộc họp bắt đầu lâu rồi, sao giờ bạn vẫn chưa đến?"},
      {speaker:"男", pre:"别生气，", blank:"我十分钟就到", post:"。",
       py:"Bié shēngqì, wǒ shí fēnzhōng jiù dào.",
       vn:"Đừng giận, mười phút nữa tôi đến ngay."}]},
    {num:6, stmt:"他是出租车司机。", judge:false, lines:[
    ...
    {num:7, stmt:"他不喜欢跟老师学画画儿。", judge:false, lines:[
      {pre:"我很喜欢画画儿，但是没有人教过我，我都是自己学的，", blank:"你看这个小狗就是我画的，可爱吗", post:"？",
       py:"Wǒ hěn xǐhuan huà huàr, dànshì méiyǒu rén jiāoguo wǒ, wǒ dōu shì zìjǐ xué de, nǐ kàn zhège xiǎogǒu jiùshì wǒ huà de, kě'ài ma?",
       vn:"Tôi rất thích vẽ tranh, nhưng chưa ai dạy tôi cả, tôi đều tự học đấy, bạn xem con chó nhỏ này chính là tôi vẽ đấy, đáng yêu không?"}]},
    {num:8, stmt:"老师昨天没讲明白。", judge:false, lines:[
      {pre:"老师，您昨天讲的那几个题，我今天就忘了，", blank:"您能再教我一次吗", post:"？",
       ...
       vn:"Thầy ơi, mấy câu thầy giảng hôm qua, hôm nay em quên mất rồi, thầy dạy lại em một lần được không?"}]},
    {num:9, stmt:"爸爸洗衣服的时候发现了护照。", judge:false, lines:[
      {pre:"爸爸找了很长时间都没找到他的护照，", blank:"我今天上午帮他洗衣服的时候，在他那条蓝色的裤子里找到了", post:"。",
       py:"Bàba zhǎole hěn cháng shíjiān dōu méi zhǎodào tā de hùzhào, wǒ jīntiān shàngwǔ bāng tā xǐ yīfu de shíhou, zài tā nà tiáo lánsè de kùzi li zhǎodào le.",
       vn:"Bố tìm mãi mà không thấy hộ chiếu của mình đâu, sáng nay lúc tôi giặt đồ giúp bố, tôi tìm thấy nó trong cái quần xanh của bố."}]},
    {num:10, stmt:"桌子和椅子都旧了。", judge:true, lines:[
      {pre:"我们需要换新的桌子和椅子，", blank:"你什么时候有时间，跟我一起去看看", post:"？",
       ...
       vn:"Chúng ta cần đổi bàn ghế mới, khi nào bạn rảnh, cùng tôi đi xem thử nhé?"}]}
  ],
  mc: [
    {num:11, options:["公园里边","公园西门","公园北门"], ans:1, q:"女的现在在哪儿？",
     lines:[
      {speaker:"女", pre:"喂，", blank:"我已经到公园西门了，你是在北门吗，我过去找你吧", post:"？",
       py:"Wéi, wǒ yǐjīng dào gōngyuán xīmén le, nǐ shì zài běimén ma, wǒ guòqu zhǎo nǐ ba?",
       vn:"Alo, tôi đã đến cổng tây công viên rồi, bạn ở cổng bắc à, tôi qua tìm bạn nhé?"},
      {speaker:"男", pre:"你别过来了，", blank:"我快到西门了", post:"。",
       py:"Nǐ bié guòlai le, wǒ kuài dào xīmén le.",
       vn:"Bạn đừng qua nữa, tôi sắp đến cổng tây rồi."}
     ],
     explain:"女：喂，我已经到公园西门了，你是在北门吗，我过去找你吧？男：你别过来了，我快到西门了。问：女的现在在哪儿？ → 公园西门。"},
    {num:12, options:["太阳从西边出来","女的不可能每天跑步","明天要跑一千米"], ans:1, q:"男的是什么意思？",
     lines:[
      {speaker:"女", pre:"", blank:"我决定从明天开始每天跑一千米", post:"。",
       py:"Wǒ juédìng cóng míngtiān kāishǐ měitiān pǎo yìqiān mǐ.",
       vn:"Tôi quyết định từ mai mỗi ngày chạy một nghìn mét."},
      {speaker:"男", pre:"真的吗？", blank:"太阳从西边出来了", post:"？",
    ...
    {num:13, options:["行李箱里","包里","手里"], ans:1, q:"护照在哪儿？",
     lines:[
      {speaker:"男", pre:"", blank:"你把护照放在行李箱里了吗", post:"？",
       py:"Nǐ bǎ hùzhào fàng zài xínglixiāng li le ma?",
       vn:"Bạn để hộ chiếu trong vali rồi à?"},
      {speaker:"女", pre:"没有，", blank:"在我包里呢，这样拿着比较方便", post:"。",
    ...
    {num:14, options:["学校","银行","西门"], ans:1, q:"女的要去哪儿？",
     lines:[
      {speaker:"女", pre:"请问，", blank:"学校附近有中国银行吗", post:"？",
       py:"Qǐngwèn, xuéxiào fùjìn yǒu Zhōngguó yínháng ma?",
       vn:"Xin hỏi, gần trường có ngân hàng Trung Quốc không?"},
      {speaker:"男", pre:"有，", blank:"出了西门，向左走两百米就能看见", post:"。",
       py:"Yǒu, chūle xīmén, xiàng zuǒ zǒu liǎngbǎi mǐ jiù néng kànjiàn.",
       vn:"Có, ra khỏi cổng tây, đi sang trái 200 mét là thấy."}
     ],
     explain:"女：请问，学校附近有中国银行吗？男：有，出了西门，向左走两百米就能看见。问：女的要去哪儿？ → 银行。"},
    {num:15, options:["开车","打车","坐公共汽车"], ans:1, q:"男的打算怎么去火车站？",
     lines:[
      {speaker:"女", pre:"火车站离这儿很远，坐车不太方便，", blank:"我开车送你去", post:"。",
       py:"Huǒchēzhàn lí zhèr hěn yuǎn, zuò chē bú tài fāngbiàn, wǒ kāichē sòng nǐ qù.",
       vn:"Ga tàu cách đây xa lắm, đi xe không tiện lắm, tôi lái xe đưa bạn đi."},
      {speaker:"男", pre:"不用了，谢谢您，", blank:"我还是自己打出租车去吧", post:"。",
       py:"Búyòng le, xièxie nín, wǒ háishi zìjǐ dǎ chūzūchē qù ba.",
       vn:"Không cần đâu, cảm ơn chị, tôi tự bắt taxi đi thì hơn."}
     ],
     explain:"女：火车站离这儿很远，坐车不太方便，我开车送你去。男：不用了，谢谢您，我还是自己打出租车去吧。问：男的打算怎么去火车站？ → 打车。"},
    {num:16, options:["太阳","小猫","花儿"], ans:2, q:"女的还准备画什么？",
     lines:[
      {speaker:"男", pre:"", blank:"这是你画的吗", post:"？",
       py:"Zhè shì nǐ huà de ma?",
       vn:"Đây là tranh bạn vẽ à?"},
      {speaker:"女", pre:"太阳是我画的，", blank:"小猫是妹妹画的", post:"。",
       py:"Tàiyáng shì wǒ huà de, xiǎomāo shì mèimei huà de.",
       vn:"Mặt trời là tôi vẽ, con mèo nhỏ là em gái vẽ."},
      {speaker:"男", pre:"真好看，", blank:"画好了吗", post:"？",
       py:"Zhēn hǎokàn, huàhǎo le ma?",
       vn:"Đẹp thật đấy, vẽ xong chưa?"},
      {speaker:"女", pre:"还没有，", blank:"我想在这儿再画点儿花儿", post:"。",
       py:"Hái méiyǒu, wǒ xiǎng zài zhèr zài huà diǎnr huār.",
       vn:"Chưa xong, tôi muốn vẽ thêm chút hoa ở đây nữa."}
     ],
     explain:"男：这是你画的吗？女：太阳是我画的，小猫是妹妹画的。男：真好看，画好了吗？女：还没有，我想在这儿再画点儿花儿。问：女的还准备画什么？ → 花儿。"},
    {num:17, options:["帮女的拿西瓜","想再吃点儿米饭","想吃点儿西瓜"], ans:2, q:"关于男的，可以知道什么？",
     lines:[
      {speaker:"女", pre:"吃好了吗？", blank:"要不要再来点儿米饭", post:"？",
       py:"Chīhǎo le ma? Yào bu yào zài lái diǎnr mǐfàn?",
       vn:"Ăn xong chưa? Có muốn ăn thêm chút cơm không?"},
      {speaker:"男", pre:"", blank:"不吃了。家里还有西瓜吗", post:"？",
       py:"Bù chī le. Jiā li hái yǒu xīguā ma?",
       vn:"Không ăn nữa. Nhà còn dưa hấu không?"},
      {speaker:"女", pre:"还有半个，", blank:"你自己拿吧", post:"。",
       py:"Hái yǒu bàn ge, nǐ zìjǐ ná ba.",
       vn:"Còn nửa quả, bạn tự lấy đi."},
      {speaker:"男", pre:"", blank:"好的", post:"。",
       py:"Hǎo de.",
       vn:"Được."}
     ],
     explain:"女：吃好了吗？要不要再来点儿米饭？男：不吃了。家里还有西瓜吗？女：还有半个，你自己拿吧。男：好的。问：关于男的，可以知道什么？ → 想吃点儿西瓜。"},
    {num:18, options:["去接人","坐火车","找司机"], ans:0, q:"男的明天要做什么？",
     lines:[
      {speaker:"男", pre:"喂，", blank:"是小马吗", post:"？",
       py:"Wéi, shì Xiǎomǎ ma?",
       vn:"Alo, có phải Tiểu Mã không?"},
      {speaker:"女", pre:"是我，周经理，", blank:"您有什么事", post:"？",
       py:"Shì wǒ, Zhōu jīnglǐ, nín yǒu shénme shì?",
       vn:"Là em đây, giám đốc Chu, anh có việc gì ạ?"},
      {speaker:"男", pre:"", blank:"我明天十点要去火车站接个人", post:"。",
       py:"Wǒ míngtiān shí diǎn yào qù huǒchēzhàn jiē ge rén.",
       vn:"Ngày mai 10 giờ tôi phải ra ga tàu đón người."},
      {speaker:"女", pre:"好的，我知道了，", blank:"我让司机明天九点前到楼下等您", post:"。",
       py:"Hǎo de, wǒ zhīdào le, wǒ ràng sījī míngtiān jiǔ diǎn qián dào lóuxià děng nín.",
       vn:"Vâng, em biết rồi, em bảo tài xế ngày mai trước 9 giờ xuống dưới lầu đợi anh."}
     ],
     explain:"男：喂，是小马吗？女：是我，周经理，您有什么事？男：我明天十点要去火车站接个人。女：好的，我知道了，我让司机明天九点前到楼下等您。问：男的明天要做什么？ → 去接人。"},
    {num:19, options:["骑车去上课","教女的骑车","学骑自行车"], ans:1, q:"男的要做什么？",
     lines:[
      {speaker:"女", pre:"", blank:"你会骑自行车吗", post:"？",
       py:"Nǐ huì qí zìxíngchē ma?",
       vn:"Bạn biết đi xe đạp không?"},
      {speaker:"男", pre:"当然，", blank:"我以前经常骑车去上课", post:"。",
       py:"Dāngrán, wǒ yǐqián jīngcháng qí chē qù shàngkè.",
       vn:"Đương nhiên, trước đây tôi thường đi xe đạp đến lớp."},
      {speaker:"女", pre:"那你教教我吧，", blank:"我一直想学", post:"。",
       py:"Nà nǐ jiāojiao wǒ ba, wǒ yìzhí xiǎng xué.",
       vn:"Vậy bạn dạy tôi đi, tôi muốn học mãi rồi."},
      {speaker:"男", pre:"可以啊，", blank:"你什么时候有时间", post:"？",
       py:"Kěyǐ a, nǐ shénme shíhou yǒu shíjiān?",
       vn:"Được đấy, bạn khi nào rảnh?"}
     ],
     explain:"女：你会骑自行车吗？男：当然，我以前经常骑车去上课。女：那你教教我吧，我一直想学。男：可以啊，你什么时候有时间？问：男的要做什么？ → 教女的骑车。"},
    {num:20, options:["来机场晚了","找不到护照了","忘了给女的打电话"], ans:0, q:"男的怎么了？",
     lines:[
      {speaker:"女", pre:"你怎么才来，", blank:"都八点一刻了", post:"。",
       py:"Nǐ zěnme cái lái, dōu bā diǎn yí kè le.",
       vn:"Sao giờ bạn mới đến, đã 8 giờ 15 rồi."},
      {speaker:"男", pre:"对不起，", blank:"来机场的路上才发现没带护照", post:"。",
       py:"Duìbuqǐ, lái jīchǎng de lùshang cái fāxiàn méi dài hùzhào.",
       vn:"Xin lỗi, trên đường ra sân bay mới phát hiện không mang hộ chiếu."},
      {speaker:"女", pre:"", blank:"出门的时候你怎么不好好看看呢", post:"？",
       py:"Chūmén de shíhou nǐ zěnme bù hǎohāo kànkan ne?",
       vn:"Lúc ra khỏi nhà sao bạn không xem kỹ vậy?"},
      {speaker:"男", pre:"你一直给我打电话，我很着急，", blank:"就出了问题", post:"。",
       py:"Nǐ yìzhí gěi wǒ dǎ diànhuà, wǒ hěn zháojí, jiù chūle wèntí.",
       vn:"Bạn cứ gọi điện cho tôi mãi, tôi vội quá, nên mới xảy ra vấn đề."}
     ],
