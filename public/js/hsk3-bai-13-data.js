  ...
  dictation: [
    {num:1, lines:[
      ...
      {speaker:"男", pre:"", blank:"这是爷爷送给你的生日礼物", post:"。",
       py:"Zhè shì yéye sòng gěi nǐ de shēngrì lǐwù.",
       vn:"Đây là món quà sinh nhật ông tặng cháu."}]},
    {num:2, lines:[
      {speaker:"女", pre:"", blank:"你终于来了！箱子里东西太多，我刚才搬了几次都没搬起来", post:"。",
       py:"Nǐ zhōngyú lái le! Xiāngzi li dōngxi tài duō, wǒ gāngcái bānle jǐ cì dōu méi bān qilai.",
       vn:"Anh cuối cùng cũng đến rồi! Trong thùng đồ nhiều quá, em vừa khiêng mấy lần đều không nhấc lên nổi."},
      {speaker:"男", pre:"我放下电话马上就跑过来了。", blank:"来，我帮你搬下去", post:"。",
       py:"Wǒ fàngxià diànhuà mǎshàng jiù pǎo guolai le. Lái, wǒ bāng nǐ bān xiaqu.",
       vn:"Em vừa cúp điện thoại là anh chạy đến ngay. Nào, để anh khiêng xuống giúp em."}]},
    {num:3, lines:[
      {speaker:"男", pre:"", blank:"你看我家小狗多喜欢你，见了你就跑过去了", post:"。",
       py:"Nǐ kàn wǒ jiā xiǎogǒu duō xǐhuan nǐ, jiànle nǐ jiù pǎo guoqu le.",
       vn:"Bạn xem con chó nhỏ nhà tôi thích bạn thế nào, thấy bạn là chạy tới ngay."},
      {speaker:"女", pre:"", blank:"它这么快跑过来是因为我拿着好吃的", post:"。",
       py:"Tā zhème kuài pǎo guolai shì yīnwèi wǒ názhe hǎochī de.",
       vn:"Nó chạy nhanh tới thế là vì tôi đang cầm đồ ăn ngon đấy."}]},
    {num:4, lines:[
      {speaker:"男", pre:"好久不见！", blank:"没想到在这儿遇到你了。你来这儿做什么", post:"？",
       py:"Hǎojiǔ bú jiàn! Méi xiǎngdào zài zhèr yùdào nǐ le. Nǐ lái zhèr zuò shénme?",
       vn:"Lâu rồi không gặp! Không ngờ lại gặp bạn ở đây. Bạn đến đây làm gì?"},
      {speaker:"女", pre:"", blank:"我来这家公司面试，刚面完，走，我们边走边聊", post:"。",
       py:"Wǒ lái zhè jiā gōngsī miànshì, gāng miànwán, zǒu, wǒmen biān zǒu biān liáo.",
       vn:"Tôi đến công ty này phỏng vấn, vừa phỏng vấn xong, đi nào, chúng ta vừa đi vừa nói chuyện."}]},
    {num:5, lines:[
      {speaker:"男", pre:"", blank:"你看这孩子怎么了，我过去帮他一下", post:"。",
       py:"Nǐ kàn zhè háizi zěnme le, wǒ guòqu bāng tā yíxià.",
       vn:"Bạn xem đứa trẻ này sao rồi, để tôi qua giúp nó một chút."},
      {speaker:"女", pre:"别帮他，", blank:"让他自己站起来，他一定可以", post:"。",
       py:"Bié bāng tā, ràng tā zìjǐ zhàn qilai, tā yídìng kěyǐ.",
       vn:"Đừng giúp nó, để nó tự đứng dậy, nó chắc chắn làm được."}]},
    {num:6, stmt:"那位老人遇到了问题。", judge:false, lines:[
      {pre:"住在我家旁边的是个老人，他很热情，喜欢帮助大家。", blank:"大家有了问题，都愿意请他帮忙", post:"。",
       py:"Zhù zài wǒ jiā pángbiān de shì ge lǎorén, tā hěn rèqíng, xǐhuan bāngzhù dàjiā. Dàjiā yǒule wèntí, dōu yuànyì qǐng tā bāngmáng.",
       vn:"Người sống cạnh nhà tôi là một cụ già, cụ rất nhiệt tình, thích giúp đỡ mọi người. Mọi người có vấn đề gì, đều muốn nhờ cụ giúp."}]},
    {num:7, stmt:"他一直一边吃早饭一边看报纸。", judge:false, lines:[
      {pre:"过去，我喜欢每天早上起床后，一边吃早饭一边看报纸。", blank:"现在我没有这个习惯了，因为太忙了，没时间了", post:"。",
       py:"Guòqù, wǒ xǐhuan měi tiān zǎoshang qǐchuáng hòu, yìbiān chī zǎofàn yìbiān kàn bàozhǐ. Xiànzài wǒ méiyǒu zhège xíguàn le, yīnwèi tài máng le, méi shíjiān le.",
       vn:"Trước đây, tôi thích mỗi sáng sau khi dậy, vừa ăn sáng vừa đọc báo. Bây giờ tôi không còn thói quen này nữa, vì quá bận, không có thời gian nữa."}]},
    {num:8, stmt:"他是开车来公司的。", judge:true, lines:[
      {pre:"早上我起了床就出门了，到了半路发现没带电脑和钱包，", blank:"又开回去拿，到公司的时候已经十点半了", post:"。",
       py:"Zǎoshang wǒ qǐle chuáng jiù chūmén le, dàole bànlù fāxiàn méi dài diànnǎo hé qiánbāo, yòu kāi huiqu ná, dào gōngsī de shíhou yǐjīng shí diǎn bàn le.",
       vn:"Sáng nay tôi dậy là ra khỏi nhà ngay, đi được nửa đường phát hiện không mang theo máy tính và ví tiền, lại lái xe quay về lấy, lúc đến công ty đã mười giờ rưỡi rồi."}]},
    {num:9, stmt:"爸爸很喜欢做饭。", judge:false, lines:[
      {pre:"妈妈忙了一天，回家还要做饭。我让她坐下来休息一会儿，", blank:"但她总是边笑边说：为你和你爸做饭，我很高兴", post:"。",
       py:"Māma mángle yì tiān, huí jiā hái yào zuò fàn. Wǒ ràng tā zuò xialai xiūxi yíhuìr, dàn tā zǒngshì biān xiào biān shuō: wèi nǐ hé nǐ bà zuò fàn, wǒ hěn gāoxìng.",
       vn:"Mẹ bận cả ngày, về nhà còn phải nấu cơm. Tôi bảo mẹ ngồi xuống nghỉ một lát, nhưng mẹ luôn vừa cười vừa nói: nấu cơm cho con và bố, mẹ rất vui."}]},
    {num:10, stmt:"以前方校长喜欢爬山。", judge:false, lines:[
      {pre:"方校长的办公室过去在四层，她每天都爬上去。", blank:"上个月搬到十二层以后，她开始坐电梯，不爬楼了", post:"。",
       py:"Fāng xiàozhǎng de bàngōngshì guòqù zài sì céng, tā měi tiān dōu pá shangqu. Shàng ge yuè bāndào shí'èr céng yǐhòu, tā kāishǐ zuò diàntī, bù pá lóu le.",
       vn:"Trước đây văn phòng hiệu trưởng Phương ở tầng bốn, cô ấy ngày nào cũng trèo lên. Sau khi chuyển lên tầng mười hai vào tháng trước, cô ấy bắt đầu đi thang máy, không trèo cầu thang nữa."}]}
  ],
  mc: [
    {num:11, options:["她去爬山了","她喝了很多水","她是走上楼来的"], ans:2, q:"女的为什么很累？",
     lines:[
      {speaker:"男", pre:"", blank:"你怎么这么累", post:"？",
       py:"Nǐ zěnme zhème lèi?",
       vn:"Sao bạn mệt thế?"},
      {speaker:"女", pre:"电梯坏了，", blank:"我是爬上来的。快给我喝口水", post:"。",
       py:"Diàntī huài le, wǒ shì pá shanglai de. Kuài gěi wǒ hē kǒu shuǐ.",
       vn:"Thang máy hỏng rồi, tôi trèo lên đấy. Mau cho tôi ngụm nước."}
     ],
     explain:"男：你怎么这么累？女：电梯坏了，我是爬上来的。快给我喝口水。问：女的为什么很累？ → 她是走上楼来的。"},
    {num:12, options:["走回家去","聊天儿","去超市"], ans:0, q:"女的想做什么？",
     lines:[
      {speaker:"男", pre:"超市离家这么远，", blank:"我们真的要走回去吗", post:"？",
       py:"Chāoshì lí jiā zhème yuǎn, wǒmen zhēn de yào zǒu huiqu ma?",
       vn:"Siêu thị cách nhà xa thế, chúng ta thật sự phải đi bộ về à?"},
      {speaker:"女", pre:"只有三站，我们边走边聊，一会儿就到家了。", blank:"多走走还能锻炼身体，不是吗", post:"？",
       py:"Zhǐyǒu sān zhàn, wǒmen biān zǒu biān liáo, yíhuìr jiù dào jiā le. Duō zǒuzou hái néng duànliàn shēntǐ, bú shì ma?",
       vn:"Chỉ ba trạm thôi, chúng ta vừa đi vừa nói chuyện, một lát là về đến nhà rồi. Đi bộ nhiều còn rèn luyện sức khoẻ, phải không?"}
     ],
     explain:"男：超市离家这么远，我们真的要走回去吗？女：只有三站，我们边走边聊，一会儿就到家了。多走走还能锻炼身体，不是吗？问：女的想做什么？ → 走回家去。"},
    {num:13, options:["已经不年轻了","很想爸妈","要去国外"], ans:2, q:"关于女的，可以知道什么？",
     lines:[
      {speaker:"男", pre:"你真的要出国？去那么远的地方，不是想回来就能回来的，", blank:"你爸妈多想你啊", post:"！",
       py:"Nǐ zhēn de yào chūguó? Qù nàme yuǎn de dìfang, bú shì xiǎng huílai jiù néng huílai de, nǐ bàmā duō xiǎng nǐ a!",
       vn:"Bạn thật sự muốn ra nước ngoài à? Đi nơi xa thế, không phải muốn về là về được đâu, bố mẹ bạn nhớ bạn lắm đấy!"},
      {speaker:"女", pre:"他们说年轻人应该走出去，", blank:"多看看外边的人和事", post:"。",
       py:"Tāmen shuō niánqīngrén yīnggāi zǒu chuqu, duō kànkan wàibian de rén hé shì.",
       vn:"Bố mẹ tôi nói người trẻ nên đi ra ngoài, xem nhiều hơn về con người và sự việc bên ngoài."}
     ],
     explain:"男：你真的要出国？去那么远的地方，不是想回来就能回来的，你爸妈多想你啊！女：他们说年轻人应该走出去，多看看外边的人和事。问：关于女的，可以知道什么？ → 要去国外。"},
    {num:14, options:["饭馆门口","饭馆里边","离饭馆不远的地方"], ans:2, q:"他们现在最可能在哪儿？",
     lines:[
      {speaker:"男", pre:"那么多车，", blank:"吃饭的人真不少", post:"。",
       py:"Nàme duō chē, chīfàn de rén zhēn bù shǎo.",
       vn:"Nhiều xe thế, người đến ăn thật không ít."},
      {speaker:"女", pre:"我们把车放在这儿，走过去吧，也不远，", blank:"两分钟就到了", post:"。",
       py:"Wǒmen bǎ chē fàng zài zhèr, zǒu guoqu ba, yě bù yuǎn, liǎng fēnzhōng jiù dào le.",
       vn:"Chúng ta để xe ở đây, đi bộ tới đi, cũng không xa, hai phút là đến rồi."}
     ],
     explain:"男：那么多车，吃饭的人真不少。女：我们把车放在这儿，走过去吧，也不远，两分钟就到了。问：他们现在最可能在哪儿？ → 离饭馆不远的地方。"},
    {num:15, options:["坐火车","坐飞机","开车"], ans:1, q:"男的怎么回北京？",
     lines:[
      {speaker:"女", pre:"你几号到北京？", blank:"票买好了没有", post:"？",
       py:"Nǐ jǐ hào dào Běijīng? Piào mǎihǎo le méiyǒu?",
       vn:"Bạn ngày mấy đến Bắc Kinh? Vé mua xong chưa?"},
      {speaker:"男", pre:"别担心，", blank:"我下个星期六就飞回去了", post:"。",
       py:"Bié dānxīn, wǒ xià ge xīngqīliù jiù fēi huiqu le.",
       vn:"Đừng lo, thứ Bảy tuần sau tôi bay về rồi."}
     ],
     explain:"女：你几号到北京？票买好了没有？男：别担心，我下个星期六就飞回去了。问：男的怎么回北京？ → 坐飞机。"},
    {num:16, options:["叫\"方朋\"","在商店买衣服","在洗衣店换衣服"], ans:2, q:"关于男的，可以知道什么？",
     lines:[
      {speaker:"男", pre:"您好，", blank:"昨天从你们洗衣店拿回去的衣服不是我的", post:"。",
       py:"Nín hǎo, zuótiān cóng nǐmen xǐyīdiàn ná huiqu de yīfu bú shì wǒ de.",
       vn:"Chào chị, hôm qua chiếc áo tôi lấy về từ tiệm giặt của chị không phải của tôi."},
      {speaker:"女", pre:"", blank:"这件衣服不是您的", post:"？",
       py:"Zhè jiàn yīfu bú shì nín de?",
       vn:"Chiếc áo này không phải của anh à?"},
      {speaker:"男", pre:"您看，我叫\"方明\"，", blank:"这上面写的是\"方朋\"", post:"。",
       py:"Nín kàn, wǒ jiào \"Fāng Míng\", zhè shàngmian xiě de shì \"Fāng Péng\".",
       vn:"Chị xem, tôi tên \"Phương Minh\", trên này viết là \"Phương Bằng\"."},
      {speaker:"女", pre:"一定是服务员边听音乐边工作，拿错了。真对不起，", blank:"您先坐下来喝点儿水，我马上就去给您换", post:"。",
       py:"Yídìng shì fúwùyuán biān tīng yīnyuè biān gōngzuò, ná cuò le. Zhēn duìbuqǐ, nín xiān zuò xialai hē diǎnr shuǐ, wǒ mǎshàng jiù qù gěi nín huàn.",
       vn:"Chắc chắn là nhân viên vừa nghe nhạc vừa làm việc, lấy nhầm rồi. Thật xin lỗi, anh ngồi xuống uống chút nước đã, tôi đi đổi lại cho anh ngay."}
     ],
    ...
    {num:17, options:["回公司","给老周带东西","开车"], ans:1, q:"女的想请男的做什么？",
     lines:[
      {speaker:"女", pre:"小周，你现在要回公司吗？", blank:"你是开车来的吗", post:"？",
       py:"Xiǎo Zhōu, nǐ xiànzài yào huí gōngsī ma? Nǐ shì kāichē lái de ma?",
       vn:"Tiểu Chu, giờ bạn định về công ty à? Bạn lái xe tới à?"},
      {speaker:"男", pre:"我是走过来的，", blank:"车放在公司门口了。怎么了，有事吗", post:"？",
       py:"Wǒ shì zǒu guolai de, chē fàng zài gōngsī ménkǒu le. Zěnme le, yǒu shì ma?",
       vn:"Tôi đi bộ tới đấy, xe để ở cổng công ty rồi. Sao thế, có việc gì à?"},
      {speaker:"女", pre:"你能帮我给老周带回去点儿东西吗？", blank:"他放在我这儿好长时间了", post:"。",
       py:"Nǐ néng bāng wǒ gěi Lǎo Zhōu dài huiqu diǎnr dōngxi ma? Tā fàng zài wǒ zhèr hǎo cháng shíjiān le.",
       vn:"Bạn giúp tôi mang đồ về cho lão Chu được không? Anh ấy để ở chỗ tôi lâu rồi."},
      {speaker:"男", pre:"明天可以吗？", blank:"明天我还来你们这儿，到时候开车过来", post:"。",
       py:"Míngtiān kěyǐ ma? Míngtiān wǒ hái lái nǐmen zhèr, dàoshí kāichē guolai.",
       vn:"Ngày mai được không? Ngày mai tôi vẫn đến đây, lúc đó lái xe tới."}
     ],
    ...
    {num:18, options:["司机","服务员","过去的同事"], ans:2, q:"女的在电梯里遇到了谁？",
     lines:[
      {speaker:"男", pre:"", blank:"刚才从电梯里走出去的那个瘦瘦的女孩儿你认识", post:"？",
       py:"Gāngcái cóng diàntī li zǒu chuqu de nàge shòushòu de nǚháir nǐ rènshi?",
       vn:"Cô gái gầy gầy vừa đi ra từ thang máy bạn quen à?"},
      {speaker:"女", pre:"对，", blank:"是我以前的同事，听说现在都是经理了", post:"。",
       py:"Duì, shì wǒ yǐqián de tóngshì, tīngshuō xiànzài dōu shì jīnglǐ le.",
       vn:"Đúng vậy, là đồng nghiệp cũ của tôi, nghe nói giờ đã là giám đốc rồi."},
      {speaker:"男", pre:"", blank:"以后你介绍我们认识一下吧", post:"。",
       py:"Yǐhòu nǐ jièshào wǒmen rènshi yíxià ba.",
       vn:"Sau này bạn giới thiệu chúng tôi làm quen nhé."},
      {speaker:"女", pre:"", blank:"没问题", post:"。",
       py:"Méi wèntí.",
       vn:"Không thành vấn đề."}
     ],
     explain:"男：刚才从电梯里走出去的那个瘦瘦的女孩儿你认识？女：对，是我以前的同事，听说现在都是经理了。男：以后你介绍我们认识一下吧。女：没问题。问：女的在电梯里遇到了谁？ → 过去的同事。"},
    {num:19, options:["今天是他生日","没开车来","想喝点儿酒"], ans:2, q:"关于男的，可以知道什么？",
     lines:[
      {speaker:"男", pre:"服务员，", blank:"来瓶红酒", post:"。",
       py:"Fúwùyuán, lái píng hóngjiǔ.",
       vn:"Phục vụ ơi, cho một chai rượu vang."},
      {speaker:"女", pre:"你不是开车了吗，", blank:"能喝酒吗", post:"？",
       py:"Nǐ bú shì kāichē le ma, néng hē jiǔ ma?",
       vn:"Bạn chẳng phải đang lái xe à, uống rượu được sao?"},
      {speaker:"男", pre:"今天是你的生日，", blank:"喝几口没关系", post:"。",
       py:"Jīntiān shì nǐ de shēngrì, hē jǐ kǒu méi guānxi.",
       vn:"Hôm nay là sinh nhật em, uống vài ngụm không sao đâu."},
      {speaker:"女", pre:"那你的车今天放在这儿吧，", blank:"明天再过来开回去", post:"。",
       py:"Nà nǐ de chē jīntiān fàng zài zhèr ba, míngtiān zài guolai kāi huiqu.",
       vn:"Vậy xe của anh cứ để ở đây, mai quay lại lái về."}
     ],
     explain:"男：服务员，来瓶红酒。女：你不是开车了吗，能喝酒吗？男：今天是你的生日，喝几口没关系。女：那你的车今天放在这儿吧，明天再过来开回去。问：关于男的，可以知道什么？ → 没开车来。"},
    {num:20, options:["太阳咖啡店","西西蛋糕店","西西咖啡店"], ans:1, q:"女的要去哪儿？",
     lines:[
      {speaker:"男", pre:"走累了吧？", blank:"我们去\"太阳咖啡店\"坐一会儿吧", post:"。",
       py:"Zǒu lèi le ba? Wǒmen qù \"Tàiyáng Kāfēidiàn\" zuò yíhuìr ba.",
       vn:"Đi mệt rồi phải không? Chúng ta đến \"quán cà phê Mặt Trời\" ngồi một lát đi."},
      {speaker:"女", pre:"那家店在三层，也没有电梯，要走上去，", blank:"喝完咖啡还要走下来，我腿疼", post:"。",
       py:"Nà jiā diàn zài sān céng, yě méiyǒu diàntī, yào zǒu shangqu, hēwán kāfēi hái yào zǒu xialai, wǒ tuǐ téng.",
       vn:"Quán đó ở tầng ba, cũng không có thang máy, phải đi bộ lên, uống xong cà phê còn phải đi bộ xuống, chân tôi đau."},
      {speaker:"男", pre:"", blank:"那去\"西西蛋糕店\"吧，有电梯", post:"。",
       py:"Nà qù \"Xīxī Dàngāodiàn\" ba, yǒu diàntī.",
       vn:"Vậy đến \"tiệm bánh Tây Tây\" đi, có thang máy."},
      {speaker:"女", pre:"好啊好啊，", blank:"那家店在高层，从上边看下去，特别漂亮", post:"。",
       py:"Hǎo a hǎo a, nà jiā diàn zài gāocéng, cóng shàngbian kàn xiaqu, tèbié piàoliang.",
       vn:"Được được, quán đó ở tầng cao, nhìn từ trên xuống, đẹp lắm."}
     ],
