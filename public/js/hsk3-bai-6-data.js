...
var matchData = [
  ...
  {left:'跟朋友',right:'聊天儿'},
  {left:'过来',right:'帮忙'},
  {left:'因为题特别难，',right:'所以我不会回答。'},
  {left:'虽然公园很大，',right:'但是走走也不错。'},
  {left:'如果你看不清楚，',right:'就找眼镜吧。'},
...
// ══════════════════════════════════════════
var fillData = [
  {pre:'虽然我的',blank:'眼镜',post:'有点儿旧了，但是看得还很清楚。',hint:'(mắt kính)',ans:'眼镜'},
  {pre:'昨天还好好的手机，怎么',blank:'突然',post:'不能用了？',hint:'(bỗng nhiên)',ans:'突然'},
  {pre:'我',blank:'离',post:'不开眼镜。',hint:'(rời khỏi)',ans:'离'},
  {pre:'虽然教室里的灯有点儿旧了，但是黑板上的字我还看得',blank:'清楚',post:'。',hint:'(rõ ràng)',ans:'清楚'},
  {pre:'你的手机是不是',blank:'刚才',post:'忘在教室里了？',hint:'(lúc nãy)',ans:'刚才'},
  {pre:'房间里的东西太重了，你快过来',blank:'帮忙',post:'搬一下吧。',hint:'(giúp đỡ)',ans:'帮忙'},
  {pre:'今天这些题',blank:'特别',post:'难。',hint:'(vô cùng, rất)',ans:'特别'},
  {pre:'这个问题',blank:'讲',post:'不明白。',hint:'(nói, giải thích)',ans:'讲'},
  {pre:'老师讲了两次，我才',blank:'明白',post:'这道题的意思。',hint:'(rõ ràng, dễ hiểu)',ans:'明白'},
...
var sortData = [
  ...
  {words:['虽然','音乐会','人','很','多','，','但是','我们','买','到','了','票','。'],ans:'虽然音乐会人很多，但是我们买到了票。',audio:'虽然音乐会人很多，但是我们买到了票。'},
  {words:['如果','房间','太','吵','，','我','就','睡','不','着','觉','。'],ans:'如果房间太吵，我就睡不着觉。',audio:'如果房间太吵，我就睡不着觉。'},
  {words:['因为','题','特别','难','，','所以','我','不','会','回答','。'],ans:'因为题特别难，所以我不会回答。',audio:'因为题特别难，所以我不会回答。'},
...
var errorFixData = [
  {wrong:'我找到不好地方。',
   opts:['我找不到好地方。','我找到不好地方。','我不找到好地方。','我找好地方不到。'],ans:0,
  ...
  {wrong:'我才完成作业，你呢？',
   opts:['我刚完成作业，你呢？','我才完成作业，你呢？','我完成刚作业，你呢？','刚我完成作业，你呢？'],ans:0,
   exp:'刚 (phó từ, đứng trước động từ) diễn tả hành động vừa xảy ra cách đây không lâu, phải đứng ngay trước động từ (完成); 才 mang nghĩa khác (mãi mới, muộn), không phù hợp ngữ cảnh này.'},
  {wrong:'这道题他明白讲不。',
  ...
  dictation: [
    {num:1, lines:[
      ...
      {speaker:"女", pre:"", blank:"我让你快点儿过来", post:"。",
       py:"Wǒ ràng nǐ kuài diǎnr guòlai.",
       vn:"Tôi bảo bạn nhanh lên đến đây."}]},
    {num:2, lines:[
      {speaker:"男", pre:"", blank:"怎么突然不下了", post:"？",
       py:"Zěnme tūrán bú xià le?",
       vn:"Sao đột nhiên hết mưa rồi?"},
    ...
    {num:3, lines:[
      {speaker:"男", pre:"喂，", blank:"你今天不出来跟大家一起玩儿了吗", post:"？",
       py:"Wéi, nǐ jīntiān bù chūlai gēn dàjiā yìqǐ wánr le ma?",
       vn:"Này, hôm nay bạn không ra chơi cùng mọi người à?"},
      {speaker:"女", pre:"对不起，", blank:"我孩子太小，离不开人", post:"。",
       py:"Duìbuqǐ, wǒ háizi tài xiǎo, lí bu kāi rén.",
       vn:"Xin lỗi, con tôi còn nhỏ quá, không thể rời người lớn được."}]},
    {num:4, lines:[
      {speaker:"女", pre:"喂，", blank:"我的车可能有点儿问题，你能过来帮个忙吗", post:"？",
       py:"Wéi, wǒ de chē kěnéng yǒudiǎnr wèntí, nǐ néng guòlai bāng ge máng ma?",
       vn:"Alo, xe của tôi có lẽ có vấn đề, bạn qua giúp tôi một chút được không?"},
      {speaker:"男", pre:"", blank:"我现在就过去，你在哪儿", post:"？",
       py:"Wǒ xiànzài jiù guòqu, nǐ zài nǎr?",
       vn:"Tôi qua ngay đây, bạn đang ở đâu?"}]},
    {num:5, lines:[
      ...
      {speaker:"女", pre:"", blank:"我有眼镜，看得清楚", post:"。",
       py:"Wǒ yǒu yǎnjìng, kàn de qīngchu.",
       vn:"Tôi có kính, nhìn rõ mà."}]},
    {num:6, stmt:"外面下雪了。", judge:false, lines:[
      {pre:"外边特别冷，你出去的时候多穿点儿。伞呢？", blank:"带把伞吧，可能要下雨", post:"。",
       py:"Wàibian tèbié lěng, nǐ chūqu de shíhou duō chuān diǎnr. Sǎn ne? Dài bǎ sǎn ba, kěnéng yào xiàyǔ.",
       vn:"Bên ngoài rất lạnh, lúc bạn ra ngoài mặc thêm chút đi. Ô đâu? Mang theo cái ô đi, có thể sẽ mưa đấy."}]},
    {num:7, stmt:"这辆车他们不打算上去。", judge:true, lines:[
      {pre:"车上那么多人，我们还有这么多东西，", blank:"等下一辆吧，5分钟就来车了", post:"。",
       py:"Chē shang nàme duō rén, wǒmen hái yǒu zhème duō dōngxi, děng xià yí liàng ba, wǔ fēnzhōng jiù lái chē le.",
       vn:"Trên xe đông người vậy, chúng ta lại còn nhiều đồ thế này, đợi chuyến sau đi, 5 phút nữa xe đến rồi."}]},
    {num:8, stmt:"他正在打电话。", judge:true, lines:[
      {pre:"小丽，我刚看见你给我打的电话，", blank:"刚才我去楼下送客人了，没带手机", post:"。你找我有事吗？",
       py:"Xiǎolì, wǒ gāng kànjiàn nǐ gěi wǒ dǎ de diànhuà, gāngcái wǒ qù lóuxià sòng kèrén le, méi dài shǒujī. Nǐ zhǎo wǒ yǒu shì ma?",
       vn:"Tiểu Lệ, tôi vừa thấy cuộc gọi nhỡ của bạn, lúc nãy tôi xuống dưới tiễn khách nên không mang điện thoại. Bạn tìm tôi có việc gì à?"}]},
    {num:9, stmt:"他每天都运动。", judge:true, lines:[
    ...
    {num:10, stmt:"他想知道小丽觉得作业难不难。", judge:true, lines:[
      {pre:"昨天的作业真容易，我不到一个小时就写完了。小丽，", blank:"你的作业呢？带了吗", post:"？",
       py:"Zuótiān de zuòyè zhēn róngyì, wǒ bú dào yí ge xiǎoshí jiù xiěwán le. Xiǎolì, nǐ de zuòyè ne? Dài le ma?",
       vn:"Bài tập hôm qua dễ thật, tôi chưa đến một tiếng đã viết xong. Tiểu Lệ, bài tập của bạn đâu? Mang theo chưa?"}]}
  ],
  mc: [
    {num:11, options:["蛋糕不好吃","没吃饱","蛋糕太多了"], ans:2, q:"女的是什么意思？",
     lines:[
      {speaker:"男", pre:"饭桌上的蛋糕怎么没吃完？", blank:"你们吃饱了吗", post:"？",
       py:"Fànzhuō shang de dàngāo zěnme méi chīwán? Nǐmen chībǎo le ma?",
       vn:"Bánh kem trên bàn ăn sao chưa ăn hết? Mọi người no rồi à?"},
      {speaker:"女", pre:"你买得太多了，", blank:"刚才还吃了很多饭，怎么吃得完啊", post:"？",
       py:"Nǐ mǎi de tài duō le, gāngcái hái chīle hěn duō fàn, zěnme chī de wán a?",
       vn:"Bạn mua nhiều quá, lúc nãy còn ăn nhiều cơm rồi, sao ăn hết được?"}
     ],
     explain:"男：饭桌上的蛋糕怎么没吃完？你们吃饱了吗？女：你买得太多了，刚才还吃了很多饭，怎么吃得完啊？问：女的是什么意思？ → 蛋糕太多了。"},
    {num:12, options:["没听清楚","没听明白","讲了三次"], ans:1, q:"关于男的，可以知道什么？",
     lines:[
      {speaker:"男", pre:"", blank:"这个题我还不太清楚怎么做", post:"。",
       py:"Zhège tí wǒ hái bú tài qīngchu zěnme zuò.",
       vn:"Bài này tôi vẫn chưa rõ làm thế nào."},
      {speaker:"女", pre:"我都讲了三次了，", blank:"你怎么还听不明白", post:"？",
    ...
    {num:13, options:["聊天儿","找人","问旁边办公室的人"], ans:1, q:"女的在做什么？",
     lines:[
      {speaker:"女", pre:"小雨呢？", blank:"在你们这儿吗", post:"？",
       py:"Xiǎoyǔ ne? Zài nǐmen zhèr ma?",
       vn:"Tiểu Vũ đâu? Có ở chỗ các bạn không?"},
      {speaker:"男", pre:"刚才还在这儿跟我们聊天儿呢，", blank:"您去旁边的办公室问问", post:"？",
       py:"Gāngcái hái zài zhèr gēn wǒmen liáotiānr ne, nín qù pángbiān de bàngōngshì wènwen?",
       vn:"Lúc nãy còn ở đây tán gẫu với chúng tôi mà, bác qua văn phòng bên cạnh hỏi thử xem?"}
     ],
     explain:"女：小雨呢？在你们这儿吗？男：刚才还在这儿跟我们聊天儿呢，您去旁边的办公室问问？问：女的在做什么？ → 找人。"},
    {num:14, options:["现在没有车","要去外地","这几天不在家"], ans:0, q:"关于女的，可以知道什么？",
     lines:[
      {speaker:"男", pre:"你怎么了？突然说要用我的车，", blank:"你的车呢", post:"？",
       py:"Nǐ zěnme le? Tūrán shuō yào yòng wǒ de chē, nǐ de chē ne?",
       vn:"Bạn sao vậy? Đột nhiên nói cần dùng xe tôi, xe của bạn đâu?"},
      {speaker:"女", pre:"我弟弟去外地，他开走了，", blank:"这几天回不来", post:"。",
       py:"Wǒ dìdi qù wàidì, tā kāizǒu le, zhè jǐ tiān huí bu lái.",
       vn:"Em trai tôi đi tỉnh khác, nó lái xe đi mất rồi, mấy hôm nay chưa về được."}
     ],
     explain:"男：你怎么了？突然说要用我的车，你的车呢？女：我弟弟去外地，他开走了，这几天回不来。问：关于女的，可以知道什么？ → 现在没有车。"},
    {num:15, options:["在花园","在饭馆","在宾馆"], ans:2, q:"男的现在在哪儿？",
     lines:[
      {speaker:"女", pre:"喂，", blank:"你下飞机了吗？吃饭了没有", post:"？",
       py:"Wéi, nǐ xià fēijī le ma? Chīfàn le méiyǒu?",
       vn:"Alo, bạn xuống máy bay chưa? Ăn cơm chưa?"},
      {speaker:"男", pre:"我刚到宾馆，", blank:"刚才跟朋友在下边的花园聊天儿聊得特别高兴，还没吃饭呢", post:"。",
       py:"Wǒ gāng dào bīnguǎn, gāngcái gēn péngyou zài xiàbian de huāyuán liáotiānr liáo de tèbié gāoxìng, hái méi chīfàn ne.",
       vn:"Tôi vừa đến khách sạn, lúc nãy tán gẫu với bạn ở vườn hoa phía dưới vui lắm, vẫn chưa ăn cơm đâu."}
     ],
     explain:"女：喂，你下飞机了吗？吃饭了没有？男：我刚到宾馆，刚才跟朋友在下边的花园聊天儿聊得特别高兴，还没吃饭呢。问：男的现在在哪儿？ → 在宾馆。"},
    {num:16, options:["在学校工作过","在女的的公司工作过","一直没有工作"], ans:0, q:"关于男的的妻子，可以知道什么？",
     lines:[
      {speaker:"女", pre:"", blank:"你妻子找到新工作了吗", post:"？",
       py:"Nǐ qīzi zhǎodào xīn gōngzuò le ma?",
       vn:"Vợ bạn tìm được việc mới chưa?"},
      {speaker:"男", pre:"还没呢。", blank:"她刚离开学校，最近一直在家休息", post:"。",
       py:"Hái méi ne. Tā gāng líkāi xuéxiào, zuìjìn yìzhí zài jiā xiūxi.",
       vn:"Vẫn chưa. Cô ấy vừa rời trường, dạo này luôn ở nhà nghỉ ngơi."},
      {speaker:"女", pre:"", blank:"你问问她想不想来我们公司", post:"。",
       py:"Nǐ wènwen tā xiǎng bu xiǎng lái wǒmen gōngsī.",
       vn:"Bạn hỏi thử cô ấy có muốn đến công ty chúng tôi không."},
      {speaker:"男", pre:"谢谢你，", blank:"我回家就告诉她", post:"。",
       py:"Xièxie nǐ, wǒ huí jiā jiù gàosu tā.",
       vn:"Cảm ơn bạn, tôi về nhà là báo cho cô ấy ngay."}
     ],
     explain:"女：你妻子找到新工作了吗？男：还没呢。她刚离开学校，最近一直在家休息。女：你问问她想不想来我们公司。男：谢谢你，我回家就告诉她。问：关于男的的妻子，可以知道什么？ → 在学校工作过。"},
    {num:17, options:["现在更漂亮","小时候更漂亮","最爱看照片"], ans:0, q:"关于女儿，可以知道什么？",
     lines:[
      {speaker:"男", pre:"", blank:"这些都是你女儿的照片吗", post:"？",
       py:"Zhèxiē dōu shì nǐ nǚ'ér de zhàopiàn ma?",
       vn:"Đây đều là ảnh con gái bạn à?"},
      {speaker:"女", pre:"对，", blank:"这是今年的，那是她六岁时的", post:"。",
       py:"Duì, zhè shì jīnnián de, nà shì tā liù suì shí de.",
       vn:"Đúng vậy, đây là ảnh năm nay, kia là lúc cháu 6 tuổi."},
      {speaker:"男", pre:"", blank:"你女儿越来越漂亮了", post:"！",
       py:"Nǐ nǚ'ér yuè lái yuè piàoliang le!",
       vn:"Con gái bạn ngày càng xinh!"},
      {speaker:"女", pre:"谢谢，", blank:"她最爱听这些了", post:"。",
       py:"Xièxie, tā zuì ài tīng zhèxiē le.",
       vn:"Cảm ơn, cháu thích nghe những lời này nhất đấy."}
     ],
     explain:"男：这些都是你女儿的照片吗？女：对，这是今年的，那是她六岁时的。男：你女儿越来越漂亮了！女：谢谢，她最爱听这些了。问：关于女儿，可以知道什么？ → 现在更漂亮。"},
    {num:18, options:["考得不好","睡不着","喜欢看电视"], ans:1, q:"男的有什么问题？",
     lines:[
      {speaker:"男", pre:"我刚到北京，", blank:"晚上总是睡不着", post:"。",
       py:"Wǒ gāng dào Běijīng, wǎnshang zǒngshì shuì bu zháo.",
       vn:"Tôi vừa đến Bắc Kinh, buổi tối cứ ngủ không được."},
      {speaker:"女", pre:"我睡不着的时候喜欢看电视，", blank:"你也看看吧", post:"。",
       py:"Wǒ shuì bu zháo de shíhou xǐhuan kàn diànshì, nǐ yě kànkan ba.",
       vn:"Lúc tôi ngủ không được thì thích xem tivi, bạn cũng xem thử đi."},
      {speaker:"男", pre:"我听不懂汉语，也看不懂汉字。", blank:"多没意思啊", post:"！",
       py:"Wǒ tīng bu dǒng Hànyǔ, yě kàn bu dǒng Hànzì. Duō méi yìsi a!",
       vn:"Tôi không nghe hiểu tiếng Trung, cũng không đọc hiểu chữ Hán. Chán quá!"},
      {speaker:"女", pre:"", blank:"那跟我聊聊天儿吧", post:"。",
       py:"Nà gēn wǒ liáoliao tiānr ba.",
       vn:"Vậy tán gẫu với tôi đi."}
     ],
     explain:"男：我刚到北京，晚上总是睡不着。女：我睡不着的时候喜欢看电视，你也看看吧。男：我听不懂汉语，也看不懂汉字。多没意思啊！女：那跟我聊聊天儿吧。问：男的有什么问题？ → 睡不着。"},
    {num:19, options:["去商店买东西了","找不到回家的路了","帮孩子的忙了"], ans:2, q:"男的为什么回来晚了？",
     lines:[
      {speaker:"女", pre:"怎么回来这么晚？", blank:"去哪儿了", post:"？",
       py:"Zěnme huílai zhème wǎn? Qù nǎr le?",
       vn:"Sao về muộn vậy? Đi đâu rồi?"},
      {speaker:"男", pre:"你不是让我给小猫买点儿吃的吗？", blank:"刚才我去商店了", post:"。",
       py:"Nǐ bú shì ràng wǒ gěi xiǎomāo mǎi diǎnr chī de ma? Gāngcái wǒ qù shāngdiàn le.",
       vn:"Chẳng phải bạn bảo tôi mua chút đồ ăn cho mèo con sao? Lúc nãy tôi ra cửa hàng rồi."},
      {speaker:"女", pre:"商店就在楼下。", blank:"你还去什么地方了", post:"？",
       py:"Shāngdiàn jiù zài lóuxià. Nǐ hái qù shénme dìfang le?",
       vn:"Cửa hàng ở ngay dưới lầu mà. Bạn còn đi đâu nữa?"},
      {speaker:"男", pre:"刚出商店，有个孩子找不到回家的路了，", blank:"我过去帮他给他家里打了个电话", post:"。",
       py:"Gāng chū shāngdiàn, yǒu ge háizi zhǎo bu dào huí jiā de lù le, wǒ guòqu bāng tā gěi tā jiālǐ dǎle ge diànhuà.",
       vn:"Vừa ra khỏi cửa hàng, có một đứa trẻ tìm không thấy đường về nhà, tôi qua giúp gọi điện về nhà cho cậu bé."}
     ],
     explain:"女：怎么回来这么晚？去哪儿了？男：你不是让我给小猫买点儿吃的吗？刚才我去商店了。女：商店就在楼下。你还去什么地方了？男：刚出商店，有个孩子找不到回家的路了，我过去帮他给他家里打了个电话。问：男的为什么回来晚了？ → 帮孩子的忙了。"},
    {num:20, options:["手里的东西多","看不见前边那个人","离周朋很近"], ans:0, q:"关于男的，可以知道什么？",
     lines:[
      {speaker:"女", pre:"看，", blank:"前边那个人是不是周朋", post:"？",
       py:"Kàn, qiánbian nàge rén shì bu shì Zhōu Péng?",
       vn:"Nhìn kìa, người đằng trước có phải Chu Bằng không?"},
      {speaker:"男", pre:"离得太远，", blank:"我看不清楚", post:"。",
       py:"Lí de tài yuǎn, wǒ kàn bu qīngchu.",
       vn:"Cách xa quá, tôi nhìn không rõ."},
      {speaker:"女", pre:"", blank:"我们快点儿走过去看看是不是他", post:"。",
       py:"Wǒmen kuài diǎnr zǒu guòqu kànkan shì bu shì tā.",
       vn:"Chúng ta đi nhanh qua xem có phải anh ấy không."},
      {speaker:"男", pre:"刚才买了这么多东西，你也不帮我拿，", blank:"我走不快", post:"。",
       py:"Gāngcái mǎile zhème duō dōngxi, nǐ yě bù bāng wǒ ná, wǒ zǒu bu kuài.",
       vn:"Lúc nãy mua nhiều đồ thế này, bạn cũng không giúp tôi cầm, tôi đi không nhanh được."}
     ],
