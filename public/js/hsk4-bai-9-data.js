...
var listenData = {
  type:'workbook',
  audio:'/audio/hsk4-bai-9/listen-full.mp3',
  dictation:[
  ...
  mc:[
    {num:1,options:['轻了一公斤','瘦了很多','完全没变化'],ans:0,
    ...
    {num:2,options:['太短了','太长了','刚好'],ans:0,
    ...
    {num:3,options:['很多国际大奖','很多钱','很多朋友'],ans:0,
    ...
    {num:4,options:['从来没有休息过一天','每周休息一天','只在春天练习'],ans:0,
    ...
    {num:5,options:['都不支持她','都支持她','没有表态'],ans:0,
    ...
    {num:6,options:['放弃是一种聪明的选择','放弃是失败','放弃是浪费时间'],ans:0,
    ...
    {num:7,options:['做事情的过程上','结果上','别人的看法上'],ans:0,
    ...
    {num:8,options:['上千种材料','上百种材料','十种材料'],ans:0,
    ...
    {num:9,options:['他们都坚持了下来','他们更聪明','他们更幸运'],ans:0,
    ...
    {num:10,options:['勇敢地面对困难','逃避困难','等待运气'],ans:0,
