...
var listenData = {
  type:'workbook',
  audio:'/audio/hsk4-bai-20/listen-full.mp3',
  dictation:[
  ...
  mc:[
    {num:1,options:['四五公里','十几公里','一公里'],ans:0,
    ...
    {num:2,options:['推迟了一个小时','提前了一个小时','取消了'],ans:0,
    ...
    {num:3,options:['大约半个小时','一个小时','十分钟'],ans:0,
    ...
    {num:5,options:['吃烤鸭时','女儿一回来时','放假那天'],ans:0,
    ...
    {num:6,options:['导游','少数民族','同学'],ans:0,
    ...
    {num:7,options:['存包的钥匙','手机','护照'],ans:0,
    ...
    {num:8,options:['每年12月到第二年3月','春天和秋天','夏天'],ans:0,
    ...
    {num:9,options:['5500公里','550公里','5000公里'],ans:0,
