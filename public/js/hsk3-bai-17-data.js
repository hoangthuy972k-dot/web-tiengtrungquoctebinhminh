...
var listenData = {
  ...
  mc: [
    {num:11, options:['两瓶牛奶','一条鱼','什么都没买'], ans:2,
     lines:[
       {speaker:'男', pre:'你不是去超市吗？', blank:'怎么什么都没买', post:'？', py:'Nǐ bú shì qù chāoshì ma? Zěnme shénme dōu méi mǎi?', vn:'Bạn không phải đi siêu thị à? Sao chẳng mua gì cả?'},
       {speaker:'女', pre:'我在超市里拿了两瓶牛奶，三个面包，还拿了条鱼。后来发现没带钱包，', blank:'只好都放回去了', post:'。', py:'Wǒ zài chāoshì li nále liǎng píng niúnǎi, sān ge miànbāo, hái nále tiáo yú. Hòulái fāxiàn méi dài qiánbāo, zhǐhǎo dōu fàng huiqu le.', vn:'Tôi trong siêu thị lấy hai chai sữa, ba ổ bánh mì, còn lấy một con cá. Sau đó phát hiện không mang ví tiền, đành phải để lại hết.'},
     ],
     explain:'男：你不是去超市吗？怎么什么都没买？女：我在超市里拿了两瓶牛奶，三个面包，还拿了条鱼。后来发现没带钱包，只好都放回去了。问：女的买什么回来了？ → 什么都没买。'},
    {num:12, options:['口渴','什么都不想喝','不想喝冰水'], ans:0,
     lines:[
       {speaker:'女', pre:'走了这么长时间，渴了吧？快坐下来休息休息，', blank:'你想喝点儿什么', post:'？', py:'Zǒule zhème cháng shíjiān, kě le ba? Kuài zuò xialai xiūxi xiūxi, nǐ xiǎng hē diǎnr shénme?', vn:'Đi bộ lâu thế này, khát rồi phải không? Mau ngồi xuống nghỉ ngơi, bạn muốn uống gì?'},
    ...
    {num:13, options:['国外','很多城市','什么地方都没去'], ans:2,
     lines:[
       {speaker:'男', pre:'听说你和丈夫去旅游了？', blank:'去了哪些地方？怎么样', post:'？', py:'Tīngshuō nǐ hé zhàngfu qù lǚyóu le? Qùle nǎxiē dìfang? Zěnme yàng?', vn:'Nghe nói bạn và chồng đi du lịch à? Đi những nơi nào? Thế nào?'},
    ...
    {num:14, options:['觉得考试不容易','写得很慢','题都检查过了'], ans:2,
     lines:[
       ...
       {speaker:'男', pre:'我已经检查过了，今天的考试题特别简单，', blank:'所以很快就做完了', post:'。', py:'Wǒ yǐjīng jiǎncháguo le, jīntiān de kǎoshì tí tèbié jiǎndān, suǒyǐ hěn kuài jiù zuòwán le.', vn:'Con đã kiểm tra rồi ạ, đề thi hôm nay đặc biệt đơn giản, nên làm xong rất nhanh.'},
     ],
    ...
    {num:15, options:['经理和秘书','医生和病人','丈夫和妻子'], ans:1,
     lines:[
       {speaker:'男', pre:'我昨天跑完步以后就一直腿疼，请您帮我检查检查，', blank:'看看用不用吃点儿药', post:'。', py:'Wǒ zuótiān pǎowán bù yǐhòu jiù yìzhí tuǐ téng, qǐng nín bāng wǒ jiǎnchá jiǎncha, kànkan yòng bu yòng chī diǎnr yào.', vn:'Hôm qua tôi chạy bộ xong là cứ đau chân mãi, mời chị khám thử giúp tôi, xem có cần uống thuốc gì không.'},
       {speaker:'女', pre:'你太久没运动了，所以腿疼。以后多出去运动运动，', blank:'不用吃药', post:'。', py:'Nǐ tài jiǔ méi yùndòng le, suǒyǐ tuǐ téng. Yǐhòu duō chūqu yùndòng yùndòng, búyòng chī yào.', vn:'Bạn lâu quá không vận động rồi, nên mới đau chân. Sau này ra ngoài vận động nhiều hơn đi, không cần uống thuốc.'},
     ],
    ...
    {num:16, options:['经常不来上课','什么都听得懂','没请过假'], ans:0,
     lines:[
       {speaker:'男', pre:'老师，', blank:'我可以请几天假吗', post:'？', py:'Lǎoshī, wǒ kěyǐ qǐng jǐ tiān jià ma?', vn:'Thầy ơi, em xin nghỉ mấy ngày được không ạ?'},
    ...
    {num:17, options:['天气很好','喜欢新闻','准备考试'], ans:2,
     lines:[
       {speaker:'女', pre:'你在听新闻？', blank:'太阳从西边出来了', post:'？', py:'Nǐ zài tīng xīnwén? Tàiyáng cóng xībian chūlai le?', vn:'Bạn đang nghe tin tức à? Mặt trời mọc từ hướng tây rồi à?'},
       {speaker:'男', pre:'我对新闻没兴趣，', blank:'主要是想提高提高我的汉语水平', post:'。', py:'Wǒ duì xīnwén méi xìngqù, zhǔyào shì xiǎng tígāo tígāo wǒ de Hànyǔ shuǐpíng.', vn:'Tôi không hứng thú với tin tức, chủ yếu là muốn nâng cao trình độ tiếng Trung của mình.'},
       {speaker:'女', pre:'你一个学期都没认真学习了，', blank:'现在才开始努力', post:'？', py:'Nǐ yí ge xuéqī dōu méi rènzhēn xuéxí le, xiànzài cái kāishǐ nǔlì?', vn:'Bạn cả học kỳ không học nghiêm túc, giờ mới bắt đầu cố gắng à?'},
       {speaker:'男', pre:'明天就要考试了，', blank:'我要复习复习', post:'。', py:'Míngtiān jiù yào kǎoshì le, wǒ yào fùxí fùxí.', vn:'Mai là thi rồi, tôi phải ôn tập chút.'},
     ],
    ...
    {num:18, options:['想去饭馆吃','不想吃牛肉','什么都喜欢吃'], ans:2,
     lines:[
       {speaker:'女', pre:'我有点儿饿了，', blank:'我们出去找个人少点儿的饭馆吃饭吧', post:'。', py:'Wǒ yǒudiǎnr è le, wǒmen chūqu zhǎo ge rén shǎo diǎnr de fànguǎn chī fàn ba.', vn:'Tôi hơi đói rồi, chúng ta ra ngoài tìm nhà hàng ít người ăn cơm đi.'},
       {speaker:'男', pre:'这个时间，哪个饭馆人都多，', blank:'我们在家吃吧，自己做', post:'。', py:'Zhège shíjiān, nǎge fànguǎn rén dōu duō, wǒmen zài jiā chī ba, zìjǐ zuò.', vn:'Giờ này, quán nào cũng đông người, chúng ta ăn ở nhà đi, tự nấu.'},
       ...
       {speaker:'男', pre:'怎么做都行，', blank:'我什么都爱吃。需要我帮忙吗', post:'？', py:'Zěnme zuò dōu xíng, wǒ shénme dōu ài chī. Xūyào wǒ bāngmáng ma?', vn:'Nấu kiểu gì cũng được, tôi cái gì cũng thích ăn. Cần tôi giúp không?'},
     ],
    ...
    {num:19, options:['喜欢那里的冬天','不喜欢那里的学习环境','不习惯那里的天气'], ans:2,
     lines:[
       {speaker:'女', pre:'你在国外留学这几年怎么样？', blank:'那里的生活习惯了吗', post:'？', py:'Nǐ zài guówài liú xué zhè jǐ nián zěnme yàng? Nàli de shēnghuó xíguàn le ma?', vn:'Mấy năm du học nước ngoài của bạn thế nào? Cuộc sống ở đó quen chưa?'},
    ...
    {num:20, options:['坐着上课','是老师','什么地方都想去'], ans:1,
     lines:[
       {speaker:'男', pre:'你在椅子上坐了一个多小时了，', blank:'一句话都不说，怎么了', post:'？', py:'Nǐ zài yǐzi shang zuòle yí ge duō xiǎoshí le, yí jù huà dōu bù shuō, zěnme le?', vn:'Bạn ngồi trên ghế hơn một tiếng rồi, một câu cũng không nói, sao thế?'},
       {speaker:'女', pre:'我上了一天课，给学生讲中国历史，', blank:'现在什么都不想说', post:'。', py:'Wǒ shàngle yì tiān kè, gěi xuésheng jiǎng Zhōngguó lìshǐ, xiànzài shénme dōu bù xiǎng shuō.', vn:'Tôi dạy cả ngày, giảng lịch sử Trung Quốc cho học sinh, bây giờ chẳng muốn nói gì cả.'},
       {speaker:'男', pre:'那你先休息休息，', blank:'一会儿我带你出去吃饭', post:'。', py:'Nà nǐ xiān xiūxi xiūxi, yíhuìr wǒ dài nǐ chūqu chī fàn.', vn:'Vậy bạn nghỉ ngơi trước đi, lát nữa tôi đưa bạn ra ngoài ăn cơm.'},
       {speaker:'女', pre:'我现在哪儿都不想去，', blank:'就想在家睡觉。我们晚点儿再吃饭吧', post:'。', py:'Wǒ xiànzài nǎr dōu bù xiǎng qù, jiù xiǎng zài jiā shuìjiào. Wǒmen wǎn diǎnr zài chī fàn ba.', vn:'Bây giờ tôi chẳng muốn đi đâu cả, chỉ muốn ngủ ở nhà. Chúng ta ăn cơm muộn hơn chút đi.'},
     ],
