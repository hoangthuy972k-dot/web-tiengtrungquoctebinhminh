...
var vocabData = [
  {n:1,zh:'还是',py:'háishi',pos:'Liên từ',vn:'hay, hay là',em:'🔀',lesson:1,
   ...
   exList:[
     ...
     {zh:'明天是晴天还是阴天？',py:'Míngtiān shì qíngtiān háishi yīntiān?',vn:'Ngày mai trời nắng hay trời âm u?'},
...
var matchData = [
  ...
  {left:'很',right:'甜'},
  {left:'绿',right:'茶'},
  {left:'因为工作很累，',right:'所以他想喝杯热茶。'},
  {left:'虽然这条裤子不便宜，',right:'但是质量很好。'},
  {left:'如果你不小心，',right:'就很容易感冒。'},
  {left:'只要天气好，',right:'我们就去爬山。'},
];
...
var fillData = [
  ...
  {pre:'过马路的时候要',blank:'小心',post:'点儿汽车。',hint:'(cẩn thận)',ans:'小心'},
  {pre:'这',blank:'条',post:'路虽然小，但是走得很快。',hint:'(lượng từ vật dài)',ans:'条'},
  {pre:'因为这条',blank:'裤子',post:'有点儿小，所以我打算换一条。',hint:'(quần)',ans:'裤子'},
  {pre:'你还',blank:'记得',post:'我们第一次见面的时候吗？',hint:'(nhớ)',ans:'记得'},
  {pre:'我想买件',blank:'衬衫',post:'，你陪我去商场吧。',hint:'(áo sơ mi)',ans:'衬衫'},
  {pre:'这条裤子要320',blank:'元',post:'，有点儿贵。',hint:'(đồng — tiền tệ)',ans:'元'},
  {pre:'这些水果看起来很',blank:'新鲜',post:'，我们买一点儿吧。',hint:'(tươi)',ans:'新鲜'},
  {pre:'这个西瓜真',blank:'甜',post:'，我们再买一个吧。',hint:'(ngọt)',ans:'甜'},
  {pre:'今天我',blank:'只',post:'吃了一个苹果，肚子还很饿。',hint:'(chỉ)',ans:'只'},
  {pre:'手机不知道',blank:'放',post:'哪儿了，我找了半天。',hint:'(đặt, để)',ans:'放'},
  {pre:'桌子上有很多',blank:'饮料',post:'，你想喝哪个？',hint:'(đồ uống)',ans:'饮料'},
  {pre:'你想喝茶',blank:'或者',post:'咖啡，都可以跟我说。',hint:'(hoặc)',ans:'或者'},
  {pre:'洗个热水澡以后会觉得很',blank:'舒服',post:'。',hint:'(dễ chịu)',ans:'舒服'},
...
var sortData = [
  ...
  {words:['虽然','这','件','衬衫','不','便宜','，','但是','质量','很好','。'],ans:'虽然这件衬衫不便宜，但是质量很好。',audio:'虽然这件衬衫不便宜，但是质量很好。'},
  {words:['如果','西瓜','不','甜','，','就','不','要','钱','。'],ans:'如果西瓜不甜，就不要钱。',audio:'如果西瓜不甜，就不要钱。'},
  {words:['只要','你','带','着','伞','，','下雨','就','没','关系','。'],ans:'只要你带着伞，下雨就没关系。',audio:'只要你带着伞，下雨就没关系。'},
  {words:['桌子','上','放','着','一','杯','咖啡','。'],ans:'桌子上放着一杯咖啡。',audio:'桌子上放着一杯咖啡。'},
  {words:['他','下','了','飞机','就','给','我','打电话','。'],ans:'他下了飞机就给我打电话。',audio:'他下了飞机就给我打电话。'},
  {words:['这些','水果','或者','那些','蔬菜','，','都','很','新鲜','。'],ans:'这些水果或者那些蔬菜，都很新鲜。',audio:'这些水果或者那些蔬菜，都很新鲜。'},
  {words:['喝','杯','热','茶','会','让','人','觉得','很','舒服','。'],ans:'喝杯热茶会让人觉得很舒服。',audio:'喝杯热茶会让人觉得很舒服。'},
];
...
var errorFixData = [
  ...
  {wrong:'桌子上放着咖啡一杯。',
   opts:['桌子上放着一杯咖啡。','桌子上放着咖啡一杯。','桌子上咖啡放着一杯。','一杯桌子上放着咖啡。'],ans:0,
   exp:'Trong câu tồn tại "放着", cụm [số lượng+danh từ] phải đứng NGUYÊN VẸN sau 放着: 放着 + 一杯咖啡, không tách rời số lượng ra sau danh từ.'},
  {wrong:'你要喝咖啡或者喝茶？',
   opts:['你要喝咖啡还是喝茶？','你要喝咖啡或者喝茶？','你要还是喝咖啡喝茶？','你要或者喝咖啡喝茶？'],ans:0,
   exp:'Trong CÂU HỎI lựa chọn, phải dùng 还是, không dùng 或者 (或者 chỉ dùng trong câu trần thuật).'},
  {wrong:'茶还是咖啡都可以。',
   opts:['茶或者咖啡都可以。','茶还是咖啡都可以。','茶咖啡或者都可以。','或者茶咖啡都可以。'],ans:0,
   exp:'Trong CÂU TRẦN THUẬT nêu 2 lựa chọn đều được, phải dùng 或者, không dùng 还是 (还是 chỉ dùng trong câu hỏi).'},
  {wrong:'爬山小心的时候要点儿。',
   opts:['爬山的时候要小心点儿。','爬山小心的时候要点儿。','小心爬山的时候要点儿。','爬山的时候小心要点儿。'],ans:0,
   exp:'的时候 (lúc/khi) phải đứng NGAY SAU cụm từ chỉ hành động (爬山的时候), không được chen vào giữa 小心 và 点儿.'},
  {wrong:'我不裤子记得放哪儿了。',
...
var listenData = {
  ...
  mc: [
    ...
    {num:16, options:['衬衫','裤子','饮料'], ans:0,
     lines:[
       {speaker:'男', pre:'今天买什么了？', blank:'', post:'', py:'Jīntiān mǎi shénme le?', vn:'Hôm nay mua gì vậy?'},
    ...
    {num:19, options:['不想去上学','觉得累','不舒服'], ans:1,
     lines:[
       {speaker:'女', pre:'你送儿子上学吧。', blank:'', post:'', py:'Nǐ sòng érzi shàngxué ba.', vn:'Anh đưa con trai đi học đi.'},
    ...
    {num:20, options:['牛肉不新鲜','没有牛肉了','要吃米饭'], ans:1,
     lines:[
       ...
       {speaker:'女', pre:'去晚了，', blank:'牛肉都卖完了', post:'。', py:'Qù wǎn le, niúròu dōu màiwán le.', vn:'Đi muộn rồi, thịt bò bán hết cả rồi.'},
     ],
