...
var fillData = [
  ...
  {pre:'他每天',blank:'骑',post:'自行车去公司，只要半个小时。',hint:'(cưỡi, đi xe)',ans:'骑'},
...
var errorFixData = [
  ...
  {wrong:'我们每天骑三两个小时的自行车吧。',
   opts:['我们每天骑两三个小时的自行车吧。','我们每天骑三两个小时的自行车吧。','我们每天骑两个三小时的自行车吧。','我们每天骑三个两小时的自行车吧。'],ans:0,
...
var listenData = {
  ...
  dictation: [
    {num:1, lines:[
      {speaker:"男", pre:"妈，你看，", blank:"给笑笑讲题的那个就是我们班数学老师", post:"。",
       py:"Mā, nǐ kàn, gěi Xiàoxiao jiǎng tí de nàge jiùshì wǒmen bān shùxué lǎoshī.",
       vn:"Mẹ ơi, mẹ xem, người đang giảng bài cho Tiếu Tiếu chính là giáo viên Toán lớp con đấy."},
    ...
    {num:2, lines:[
      {speaker:"女", pre:"喂，", blank:"你听得见我说话吗", post:"？",
       py:"Wéi, nǐ tīng de jiàn wǒ shuōhuà ma?",
       vn:"Alo, bạn nghe thấy tôi nói không?"},
      {speaker:"男", pre:"喂，喂，你等一会儿，", blank:"我找个安静点儿的地方再跟你说", post:"。",
       py:"Wéi, wéi, nǐ děng yíhuìr, wǒ zhǎo ge ānjìng diǎnr de dìfang zài gēn nǐ shuō.",
       vn:"Alo, alo, bạn đợi chút, tôi tìm chỗ yên tĩnh hơn rồi nói chuyện với bạn tiếp."}]},
    {num:3, lines:[
      {speaker:"男", pre:"谢谢你们请我们吃饭，", blank:"这家饭馆的环境真好，菜也很好吃，特别是主菜", post:"。",
       ...
       vn:"Cảm ơn các bạn mời chúng tôi ăn cơm, quán ăn này môi trường đẹp thật, đồ ăn cũng ngon, đặc biệt là món chính."},
    ...
    {num:4, lines:[
      ...
      {speaker:"男", pre:"对，这边请，", blank:"我来给您介绍一下吧。您有旧车吗", post:"？",
       ...
       vn:"Đúng vậy, mời anh/chị lối này, để tôi giới thiệu cho anh/chị nhé. Anh/chị có xe cũ không?"}]},
    {num:5, lines:[
      {speaker:"男", pre:"看，", blank:"那么多人踢足球，他们在比赛吗", post:"？",
       py:"Kàn, nàme duō rén tī zúqiú, tāmen zài bǐsài ma?",
       vn:"Nhìn kìa, nhiều người đá bóng thế, họ đang thi đấu à?"},
      {speaker:"女", pre:"不是，", blank:"他们在上体育课呢", post:"。",
       py:"Bú shì, tāmen zài shàng tǐyù kè ne.",
       vn:"Không phải, họ đang học thể dục đấy."}]},
    {num:6, stmt:"今天比昨天冷得多。", judge:true, lines:[
      {pre:"地面上怎么都是雪？昨天我女朋友还穿裙子呢，", blank:"今天怎么就下雪了", post:"？",
       py:"Dìmiàn shang zěnme dōu shì xuě? Zuótiān wǒ nǚpéngyou hái chuān qúnzi ne, jīntiān zěnme jiù xiàxuě le?",
       vn:"Sao mặt đất toàn tuyết vậy? Hôm qua bạn gái tôi còn mặc váy, sao hôm nay lại có tuyết rồi?"}]},
    {num:7, stmt:"他们要回家了。", judge:false, lines:[
      {pre:"走，找个环境好的地方，我早就想跟你聊聊了，", blank:"这儿附近有没有安静点儿的咖啡店", post:"？",
       py:"Zǒu, zhǎo ge huánjìng hǎo de dìfang, wǒ zǎo jiù xiǎng gēn nǐ liáoliao le, zhèr fùjìn yǒu méiyǒu ānjìng diǎnr de kāfēidiàn?",
       vn:"Đi nào, tìm chỗ môi trường tốt, mình muốn nói chuyện với bạn từ lâu rồi, gần đây có quán cà phê nào yên tĩnh hơn không?"}]},
    {num:8, stmt:"爸爸很健康，因为他喜欢运动。", judge:true, lines:[
    ...
    {num:9, stmt:"他每天工作很累。", judge:true, lines:[
      {pre:"我每天工作八九个小时，中午也不能休息，", blank:"能不累吗", post:"？",
       py:"Wǒ měitiān gōngzuò bā-jiǔ ge xiǎoshí, zhōngwǔ yě bù néng xiūxi, néng bú lèi ma?",
       vn:"Tôi mỗi ngày làm việc tám chín tiếng, trưa cũng không được nghỉ, sao mà không mệt được?"}]},
    {num:10, stmt:"以前儿子不喜欢学习。", judge:true, lines:[
  ...
  mc: [
    {num:11, options:["买两个","买三个","少买一点儿"], ans:2, q:"女的是什么意思？",
     lines:[
      {speaker:"男", pre:"前边有卖水果的，", blank:"我们买点儿苹果吧", post:"？",
       py:"Qiánbian yǒu mài shuǐguǒ de, wǒmen mǎi diǎnr píngguǒ ba?",
       vn:"Phía trước có người bán trái cây, chúng ta mua ít táo đi?"},
      {speaker:"女", pre:"现在是换季的时候，苹果不一定好吃，", blank:"别买太多，买两三个就行", post:"。",
       py:"Xiànzài shì huànjì de shíhou, píngguǒ bù yídìng hǎochī, bié mǎi tài duō, mǎi liǎng-sān ge jiù xíng.",
       vn:"Bây giờ là lúc giao mùa, táo chưa chắc đã ngon, đừng mua nhiều quá, mua hai ba quả là được rồi."}
     ],
     explain:"男：前边有卖水果的，我们买点儿苹果吧？女：现在是换季的时候，苹果不一定好吃，别买太多，买两三个就行。问：女的是什么意思？ → 少买一点儿。"},
    {num:12, options:["好点儿了","好多了","越来越不好"], ans:0, q:"女的现在怎么样了？",
     lines:[
      {speaker:"男", pre:"今天怎么样？", blank:"还发烧吗", post:"？",
       py:"Jīntiān zěnmeyàng? Hái fā shāo ma?",
       vn:"Hôm nay thế nào? Còn sốt không?"},
      {speaker:"女", pre:"吃了药比昨天好一些了，", blank:"但还头疼", post:"。",
       py:"Chīle yào bǐ zuótiān hǎo yìxiē le, dàn hái tóuténg.",
       vn:"Uống thuốc rồi đỡ hơn hôm qua một chút, nhưng vẫn đau đầu."}
     ],
     explain:"男：今天怎么样？还发烧吗？女：吃了药比昨天好一些了，但还头疼。问：女的现在怎么样了？ → 好点儿了。"},
    {num:13, options:["小刚","方明","一样高"], ans:1, q:"小刚和方明谁高？",
     lines:[
      {speaker:"女", pre:"小刚，", blank:"方明高还是你高", post:"？",
       py:"Xiǎogāng, Fāngmíng gāo háishi nǐ gāo?",
       vn:"Tiểu Cương, Phương Minh cao hay bạn cao?"},
      {speaker:"男", pre:"他个子也不高，", blank:"只比我高一点儿", post:"。",
       py:"Tā gèzi yě bù gāo, zhǐ bǐ wǒ gāo yìdiǎnr.",
       vn:"Cậu ấy vóc dáng cũng không cao, chỉ cao hơn mình một chút."}
     ],
     explain:"女：小刚，方明高还是你高？男：他个子也不高，只比我高一点儿。问：小刚和方明谁高？ → 方明。"},
    {num:14, options:["飞机上","电影院","火车上"], ans:0, q:"他们可能在哪儿？",
     lines:[
      {speaker:"男", pre:"怎么还没到？", blank:"我都看了三四个电影了", post:"。",
       py:"Zěnme hái méi dào? Wǒ dōu kànle sān-sì ge diànyǐng le.",
       vn:"Sao vẫn chưa đến? Tôi xem ba bốn bộ phim rồi đấy."},
      {speaker:"女", pre:"我们是从中国到美国，还要再飞五六个小时。", blank:"你睡一会儿，或者再看几个电影", post:"。",
       py:"Wǒmen shì cóng Zhōngguó dào Měiguó, hái yào zài fēi wǔ-liù ge xiǎoshí. Nǐ shuì yíhuìr, huòzhě zài kàn jǐ ge diànyǐng.",
       vn:"Chúng ta bay từ Trung Quốc sang Mỹ, còn phải bay thêm năm sáu tiếng nữa. Bạn ngủ một chút đi, hoặc xem thêm vài bộ phim."}
     ],
     explain:"男：怎么还没到？我都看了三四个电影了。女：我们是从中国到美国，还要再飞五六个小时。你睡一会儿，或者再看几个电影。问：他们可能在哪儿？ → 飞机上。"},
    {num:15, options:["三个","三十个","很多"], ans:2, q:"这个地方有几个姓王的老师？",
     lines:[
      {speaker:"女", pre:"喂，您好，", blank:"请找一下王老师", post:"。",
       py:"Wéi, nín hǎo, qǐng zhǎo yíxià Wáng lǎoshī.",
       vn:"Alo, chào anh, làm ơn tìm giúp tôi cô Vương."},
      {speaker:"男", pre:"我们这儿有三四个姓王的老师呢，", blank:"您找哪一个", post:"？",
       py:"Wǒmen zhèr yǒu sān-sì ge xìng Wáng de lǎoshī ne, nín zhǎo nǎ yí ge?",
       vn:"Ở đây chúng tôi có ba bốn giáo viên họ Vương, anh/chị tìm ai vậy?"}
     ],
     explain:"女：喂，您好，请找一下王老师。男：我们这儿有三四个姓王的老师呢，您找哪一个？问：这个地方有几个姓王的老师？ → 很多。"},
    {num:16, options:["可能骑自行车","可能坐公共汽车","要去上课"], ans:0, q:"关于男的，可以知道什么？",
     lines:[
      {speaker:"女", pre:"", blank:"你要出去吗", post:"？",
       py:"Nǐ yào chūqu ma?",
       vn:"Bạn định ra ngoài à?"},
      {speaker:"男", pre:"小丽，我问你，", blank:"去中山南路骑自行车快还是坐公共汽车快", post:"？",
       py:"Xiǎolì, wǒ wèn nǐ, qù Zhōngshān nánlù qí zìxíngchē kuài háishi zuò gōnggòngqìchē kuài?",
       vn:"Tiểu Lệ, hỏi bạn nè, đi đường Trung Sơn Nam đi xe đạp nhanh hay đi xe buýt nhanh?"},
      {speaker:"女", pre:"这个时间，", blank:"骑车比坐公共汽车快得多。你这么着急，要去上课吗", post:"？",
       py:"Zhège shíjiān, qí chē bǐ zuò gōnggòngqìchē kuài de duō. Nǐ zhème zháojí, yào qù shàngkè ma?",
       vn:"Giờ này, đi xe đạp nhanh hơn nhiều so với đi xe buýt. Bạn vội thế, đi học à?"},
      {speaker:"男", pre:"不，", blank:"我要去见女朋友", post:"。",
       py:"Bù, wǒ yào qù jiàn nǚpéngyou.",
       vn:"Không, tôi đi gặp bạn gái."}
     ],
     explain:"女：你要出去吗？男：小丽，我问你，去中山南路骑自行车快还是坐公共汽车快？女：这个时间，骑车比坐公共汽车快得多。你这么着急，要去上课吗？男：不，我要去见女朋友。问：关于男的，可以知道什么？ → 可能骑自行车。"},
    {num:17, options:["明天很冷","明天是阴天","下雪时最冷"], ans:0, q:"男的是什么意思？",
     lines:[
      {speaker:"女", pre:"", blank:"明天是晴天还是阴天", post:"？",
       py:"Míngtiān shì qíngtiān háishi yīntiān?",
       vn:"Ngày mai nắng hay âm u?"},
      {speaker:"男", pre:"上午下雪，", blank:"下午就晴了", post:"。",
       py:"Shàngwǔ xiàxuě, xiàwǔ jiù qíng le.",
       vn:"Sáng có tuyết, chiều thì nắng lại."},
      {speaker:"女", pre:"太好了，", blank:"明天可以穿我的新裙子了", post:"。",
       py:"Tài hǎo le, míngtiān kěyǐ chuān wǒ de xīn qúnzi le.",
       vn:"Tuyệt quá, mai có thể mặc váy mới của mình rồi."},
      {speaker:"男", pre:"雪后晴天比下雪时冷得多，", blank:"你不知道吗", post:"？",
       py:"Xuě hòu qíngtiān bǐ xiàxuě shí lěng de duō, nǐ bù zhīdào ma?",
       vn:"Trời nắng sau tuyết lạnh hơn lúc có tuyết nhiều đấy, bạn không biết à?"}
     ],
     explain:"女：明天是晴天还是阴天？男：上午下雪，下午就晴了。女：太好了，明天可以穿我的新裙子了。男：雪后晴天比下雪时冷得多，你不知道吗？问：男的是什么意思？ → 明天很冷。"},
    {num:18, options:["买了一辆旧车","买的是自行车","买了五辆车"], ans:1, q:"关于男的，可以知道什么？",
     lines:[
      {speaker:"男", pre:"我昨天换了辆新车，", blank:"比那辆旧的舒服多了", post:"。",
       py:"Wǒ zuótiān huànle liàng xīn chē, bǐ nà liàng jiù de shūfu duō le.",
       vn:"Hôm qua tôi đổi chiếc xe mới rồi, thoải mái hơn chiếc cũ nhiều."},
      {speaker:"女", pre:"又换了？", blank:"你已经换了四五辆了吧？多少钱", post:"？",
       py:"Yòu huàn le? Nǐ yǐjīng huànle sì-wǔ liàng le ba? Duōshao qián?",
       vn:"Lại đổi nữa à? Bạn đổi bốn năm chiếc rồi nhỉ? Bao nhiêu tiền?"},
      {speaker:"男", pre:"不贵，一百多。", blank:"我那辆旧车送给你吧", post:"。",
       py:"Bú guì, yìbǎi duō. Wǒ nà liàng jiù chē sòng gěi nǐ ba.",
       vn:"Không đắt, hơn một trăm thôi. Chiếc xe cũ của tôi tặng bạn luôn nhé."},
      {speaker:"女", pre:"一百多？", blank:"自行车啊", post:"！",
    ...
    {num:19, options:["妈妈高得多","一样高","女儿高得多"], ans:1, q:"关于女的和她女儿，可以知道什么？",
     lines:[
      {speaker:"男", pre:"你女儿个子真高，", blank:"比你高多了吧", post:"？",
       py:"Nǐ nǚ'ér gèzi zhēn gāo, bǐ nǐ gāo duō le ba?",
       vn:"Con gái bạn cao thật đấy, cao hơn bạn nhiều nhỉ?"},
      {speaker:"女", pre:"其实我跟她一样高，", blank:"只是她比我瘦多了", post:"。",
       py:"Qíshí wǒ gēn tā yíyàng gāo, zhǐshì tā bǐ wǒ shòu duō le.",
       vn:"Thực ra tôi cao bằng con bé, chỉ là con bé gầy hơn tôi nhiều thôi."},
      {speaker:"男", pre:"她今年多大？", blank:"十七八岁？在哪儿学习呢", post:"？",
       py:"Tā jīnnián duō dà? Shíqī-bā suì? Zài nǎr xuéxí ne?",
       vn:"Năm nay con bé bao nhiêu tuổi? Mười bảy mười tám à? Đang học ở đâu vậy?"},
      {speaker:"女", pre:"今年十九了，正在国外学习，", blank:"学历史和数学", post:"。",
    ...
    {num:20, options:["去咖啡店","听音乐会","买东西"], ans:0, q:"他们要做什么？",
     lines:[
      {speaker:"男", pre:"走了两三个小时了，还买了这么多东西，真累。", blank:"我们休息一会儿吧", post:"。",
       py:"Zǒule liǎng-sān ge xiǎoshí le, hái mǎile zhème duō dōngxi, zhēn lèi. Wǒmen xiūxi yíhuìr ba.",
       vn:"Đi bộ hai ba tiếng rồi, còn mua nhiều đồ thế này, mệt thật. Chúng ta nghỉ một chút đi."},
      {speaker:"女", pre:"那就在这儿坐坐，", blank:"喝点儿水", post:"。",
       py:"Nà jiù zài zhèr zuòzuo, hē diǎnr shuǐ.",
       vn:"Vậy ngồi đây một chút, uống chút nước."},
      {speaker:"男", pre:"楼上有个咖啡店，比这儿安静得多，环境也不错，", blank:"还有音乐", post:"。",
       py:"Lóushàng yǒu ge kāfēidiàn, bǐ zhèr ānjìng de duō, huánjìng yě búcuò, hái yǒu yīnyuè.",
       vn:"Trên lầu có một quán cà phê, yên tĩnh hơn ở đây nhiều, môi trường cũng đẹp, còn có nhạc nữa."},
      {speaker:"女", pre:"也好，", blank:"我们上去喝点儿饮料", post:"。",
       py:"Yě hǎo, wǒmen shàngqu hē diǎnr yǐnliào.",
       vn:"Cũng được, chúng ta lên đó uống chút đồ uống đi."}
     ],
