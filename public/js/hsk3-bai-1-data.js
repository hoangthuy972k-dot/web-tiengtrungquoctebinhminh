...
// ══════════════════════════════════════════
var fillData = [
  {pre:'虽然这个',blank:'周末',post:'工作很多，但是我还是想去旅游。',hint:'(cuối tuần)',ans:'周末'},
  {pre:'你周末有什么',blank:'打算',post:'？',hint:'(kế hoạch, dự định)',ans:'打算'},
  {pre:'好',blank:'啊',post:'，我们一起去吧。',hint:'(trợ từ ngữ khí)',ans:'啊'},
  {pre:'如果你明天有空，就能',blank:'跟',post:'我一起去图书馆吗？',hint:'(cùng, với)',ans:'跟'},
  {pre:'因为工作很忙，所以他',blank:'一直',post:'没有时间休息。',hint:'(suốt, liên tục)',ans:'一直'},
  {pre:'因为今天下雨，所以弟弟一整天都在玩儿',blank:'游戏',post:'。',hint:'(trò chơi)',ans:'游戏'},
  ...
  {pre:'虽然我在南方出生，但是我妈妈是',blank:'北方',post:'人。',hint:'(miền Bắc)',ans:'北方'},
...
var sortData = [
  ...
  {words:['只要','夏天','不','太','热','，','我们','就','打算','去','南方','旅游','。'],ans:'只要夏天不太热，我们就打算去南方旅游。',audio:'只要夏天不太热，我们就打算去南方旅游。'},
  {words:['他','早','就','把','作业','写','好','了','。'],ans:'他早就把作业写好了。',audio:'他早就把作业写好了。'},
  {words:['这','是','我','昨天','下午','准备','好','的','。'],ans:'这是我昨天下午准备好的。',audio:'这是我昨天下午准备好的。'},
  {words:['他','一边','准备','行李箱','，','一边','检查','地图','和','手机','。'],ans:'他一边准备行李箱，一边检查地图和手机。',audio:'他一边准备行李箱，一边检查地图和手机。'},
...
var errorFixData = [
  ...
  {wrong:'我一个面包不想吃也。',
   opts:['我一个面包也不想吃。','我一个面包不想吃也。','一个面包我也不想吃了。','我不想也一个面包吃。'],ans:0,
  ...
  {wrong:'你跟去朋友一起吗？',
   opts:['你想跟朋友一起去吗？','你跟去朋友一起吗？','你去跟朋友一起吗？','你一起跟朋友去吗？'],ans:0,
  ...
  dictation: [
    {num:1, lines:[
      {speaker:"男", pre:"你怎么又", blank:"不高兴了", post:"？",
       py:"Nǐ zěnme yòu bù gāoxìng le?",
       vn:"Sao bạn lại không vui vậy nữa?"},
      {speaker:"女", pre:"你工作一直忙，", blank:"一次电影都没跟我一起看过", post:"。",
       py:"Nǐ gōngzuò yìzhí máng, yí cì diànyǐng dōu méi gēn wǒ yìqǐ kànguo.",
       vn:"Anh làm việc bận suốt, một lần phim cũng chưa từng xem cùng em."}]},
    {num:2, lines:[
      {speaker:"男", pre:"喂，您好，", blank:"请问是搬家公司吗", post:"？我们要搬家。",
       py:"Wéi, nín hǎo, qǐngwèn shì bān jiā gōngsī ma? Wǒmen yào bān jiā.",
       vn:"Alô, xin chào, cho hỏi đây có phải công ty chuyển nhà không? Chúng tôi cần chuyển nhà."},
    ...
    {num:3, lines:[
      {speaker:"男", pre:"爸、妈，今天我给你们做晚饭，", blank:"你们打算吃什么", post:"？",
       py:"Bà, mā, jīntiān wǒ gěi nǐmen zuò wǎnfàn, nǐmen dǎsuàn chī shénme?",
       vn:"Bố, mẹ, hôm nay con nấu cơm tối cho bố mẹ, bố mẹ định ăn gì?"},
      {speaker:"女", pre:"真的啊？那我们", blank:"吃点儿牛肉吧", post:"。",
       py:"Zhēn de a? Nà wǒmen chī diǎnr niúròu ba.",
       vn:"Thật à? Vậy chúng ta ăn chút thịt bò đi."}]},
    {num:4, lines:[
    ...
    {num:5, lines:[
      {speaker:"女", pre:"这是哪儿啊？你开错了吧？", blank:"我们怎么回家啊", post:"？",
       py:"Zhè shì nǎr a? Nǐ kāicuò le ba? Wǒmen zěnme huí jiā a?",
       vn:"Đây là đâu vậy? Bạn lái nhầm đường rồi phải không? Chúng ta về nhà kiểu gì đây?"},
      {speaker:"男", pre:"别着急，", blank:"车上有电子地图", post:"。",
       py:"Bié zháojí, chē shang yǒu diànzǐ dìtú.",
       vn:"Đừng lo, trên xe có bản đồ điện tử."}]},
    {num:6, stmt:"他不喜欢这个电影。", judge:true, lines:[
      {pre:"这个电影一点儿意思也没有，", blank:"我们看书吧", post:"。",
       py:"Zhège diànyǐng yìdiǎnr yìsi yě méiyǒu, wǒmen kàn shū ba.",
       vn:"Bộ phim này chẳng thú vị chút nào, chúng ta đọc sách đi."}]},
    {num:7, stmt:"他一点儿也不着急。", judge:false, lines:[
      {pre:"你怎么还没准备好？", blank:"快点儿吧，没时间了", post:"。",
       py:"Nǐ zěnme hái méi zhǔnbèi hǎo? Kuài diǎnr ba, méi shíjiān le.",
       vn:"Sao bạn vẫn chưa chuẩn bị xong? Mau lên đi, hết thời gian rồi."}]},
    {num:8, stmt:"他考试考得很好。", judge:false, lines:[
      {pre:"明天的考试我都复习好了，", blank:"没问题", post:"。",
       py:"Míngtiān de kǎoshì wǒ dōu fùxí hǎo le, méi wèntí.",
       vn:"Kỳ thi ngày mai tôi đã ôn tập xong hết rồi, không thành vấn đề."}]},
    {num:9, stmt:"他还没想好去哪儿旅游。", judge:true, lines:[
      {pre:"去南方旅游？去北方旅游？", blank:"去哪儿旅游好呢", post:"？",
       py:"Qù nánfāng lǚyóu? Qù běifāng lǚyóu? Qù nǎr lǚyóu hǎo ne?",
       vn:"Đi du lịch miền Nam? Đi du lịch miền Bắc? Đi đâu du lịch thì tốt nhỉ?"}]},
    {num:10, stmt:"家里还有很多鸡蛋。", judge:false, lines:[
      {pre:"家里一个鸡蛋也没有，", blank:"明天早上吃什么啊", post:"？",
       py:"Jiā lǐ yí ge jīdàn yě méiyǒu, míngtiān zǎoshang chī shénme a?",
       vn:"Trong nhà một quả trứng cũng không có, sáng mai ăn gì đây?"}]}
  ],
  mc: [
    {num:11, options:["送朋友","送衣服","去外边"], ans:0, q:"男的打算做什么？",
     lines:[
      {speaker:"男", pre:"你们等一下，我穿好衣服，", blank:"送送你们", post:"。",
       py:"Nǐmen děng yíxià, wǒ chuānhǎo yīfu, sòngsong nǐmen.",
       vn:"Các bạn đợi chút, tôi mặc xong quần áo rồi tiễn các bạn."},
      {speaker:"女", pre:"你太客气了，外边冷，", blank:"别送了", post:"。",
       py:"Nǐ tài kèqi le, wàibian lěng, bié sòng le.",
       vn:"Bạn khách sáo quá, bên ngoài lạnh, đừng tiễn nữa."}
     ],
     explain:"男：你们等一下，我穿好衣服，送送你们。女：你太客气了，外边冷，别送了。问：男的打算做什么？ → 送朋友。"},
    {num:12, options:["去过一次南方","上个月去了南方","很想去南方"], ans:2, q:"关于女的，可以知道什么？",
     lines:[
      {speaker:"男", pre:"下个月我们去南方旅游，", blank:"怎么样", post:"？",
       py:"Xià ge yuè wǒmen qù nánfāng lǚyóu, zěnmeyàng?",
       vn:"Tháng sau chúng ta đi du lịch miền Nam, thế nào?"},
      {speaker:"女", pre:"南方我还", blank:"一次都没去过呢", post:"，一直想去看看。",
       py:"Nánfāng wǒ hái yí cì dōu méi qùguo ne, yìzhí xiǎng qù kànkan.",
       vn:"Miền Nam tôi vẫn chưa đi lần nào cả, vẫn luôn muốn đi xem thử."}
     ],
     explain:"男：下个月我们去南方旅游，怎么样？女：南方我还一次都没去过呢，一直想去看看。问：关于女的，可以知道什么？ → 很想去南方。"},
    {num:13, options:["买东西","搬东西","找儿子"], ans:1, q:"女的请男的做什么？",
     lines:[
      {speaker:"女", pre:"大雨，你快来", blank:"帮我一下", post:"。",
       py:"Dàyǔ, nǐ kuài lái bāng wǒ yíxià.",
       vn:"Đại Vũ, bạn mau lại đây giúp tôi một chút."},
      {speaker:"男", pre:"这么多东西，你怎么一个人搬？", blank:"你儿子去哪儿了", post:"？",
       py:"Zhème duō dōngxi, nǐ zěnme yí ge rén bān? Nǐ érzi qù nǎr le?",
       vn:"Nhiều đồ vậy, sao bạn khuân một mình được? Con trai bạn đi đâu rồi?"}
     ],
     explain:"女：大雨，你快来帮我一下。男：这么多东西，你怎么一个人搬？你儿子去哪儿了？问：女的请男的做什么？ → 搬东西。"},
    {num:14, options:["票卖完了","没有好看的电影","没带钱"], ans:1, q:"他们为什么没买票？",
     lines:[
      {speaker:"男", pre:"别买票了，", blank:"一个好看的电影都没有", post:"。",
       py:"Bié mǎi piào le, yí ge hǎokàn de diànyǐng dōu méiyǒu.",
       vn:"Đừng mua vé nữa, một phim hay cũng không có."},
      {speaker:"女", pre:"那", blank:"看看明天的吧", post:"。",
       py:"Nà kànkan míngtiān de ba.",
       vn:"Vậy xem phim của ngày mai vậy."}
     ],
     explain:"男：别买票了，一个好看的电影都没有。女：那看看明天的吧。问：他们为什么没买票？ → 没有好看的电影。"},
    {num:15, options:["他带地图了","他没带地图","他知道这是哪儿"], ans:2, q:"男的是什么意思？",
     lines:[
      {speaker:"女", pre:"这是哪儿啊？我没带地图，", blank:"我们问问那边的游客吧", post:"。",
       py:"Zhè shì nǎr a? Wǒ méi dài dìtú, wǒmen wènwen nàbiān de yóukè ba.",
       vn:"Đây là đâu vậy? Tôi không mang bản đồ, chúng ta hỏi thử du khách đằng kia đi."},
      {speaker:"男", pre:"不用，", blank:"我就是地图", post:"，你问我吧。",
    ...
    {num:16, options:["公司南边","医院北边","医院北门"], ans:1, q:"现在小周家在哪儿？",
     lines:[
      {speaker:"女", pre:"小周，", blank:"你们搬家了", post:"？",
       py:"Xiǎo Zhōu, nǐmen bān jiā le?",
       vn:"Tiểu Chu, các bạn chuyển nhà rồi à?"},
      {speaker:"男", pre:"是啊，", blank:"从公司南边搬到了医院北边", post:"。",
       py:"Shì a, cóng gōngsī nánbian bāndàole yīyuàn běibian.",
       vn:"Đúng vậy, chuyển từ phía nam công ty đến phía bắc bệnh viện."},
      {speaker:"女", pre:"是吗？", blank:"那你们离白雪家很近吧", post:"。",
       py:"Shì ma? Nà nǐmen lí Báixuě jiā hěn jìn ba.",
       vn:"Vậy à? Vậy các bạn ở gần nhà Bạch Tuyết nhỉ."},
      {speaker:"男", pre:"对，", blank:"他们家搬到了医院南边", post:"。",
       py:"Duì, tāmen jiā bāndàole yīyuàn nánbian.",
       vn:"Đúng, nhà họ chuyển đến phía nam bệnh viện rồi."}
     ],
     explain:"女：小周，你们搬家了？男：是啊，从公司南边搬到了医院北边。女：是吗？那你们离白雪家很近吧。男：对，他们家搬到了医院南边。问：现在小周家在哪儿？ → 医院北边。"},
    {num:17, options:["谢谢","漂亮","还没有名字"], ans:2, q:"女的的猫叫什么？",
     lines:[
      {speaker:"男", pre:"这是你的小猫吗？", blank:"真漂亮", post:"！",
       py:"Zhè shì nǐ de xiǎomāo ma? Zhēn piàoliang!",
       vn:"Đây là mèo con của bạn à? Đẹp thật đấy!"},
      {speaker:"女", pre:"", blank:"谢谢", post:"。",
       py:"Xièxie.",
       vn:"Cảm ơn."},
      {speaker:"男", pre:"它叫", blank:"什么名字", post:"？",
       py:"Tā jiào shénme míngzi?",
       vn:"Nó tên gì?"},
      {speaker:"女", pre:"我还没想好", blank:"叫它什么呢", post:"。",
       py:"Wǒ hái méi xiǎnghǎo jiào tā shénme ne.",
       vn:"Tôi vẫn chưa nghĩ xong nên đặt tên gì cho nó."}
     ],
     explain:"男：这是你的小猫吗？真漂亮！女：谢谢。男：它叫什么名字？女：我还没想好叫它什么呢。问：女的的猫叫什么？ → 还没有名字。"},
    {num:18, options:["没去过那个饭馆","晚上没有时间","要请男的吃饭"], ans:0, q:"关于女的，可以知道什么？",
     lines:[
      {speaker:"男", pre:"你帮了我这么多，", blank:"谢谢你", post:"。",
       py:"Nǐ bāngle wǒ zhème duō, xièxie nǐ.",
       vn:"Bạn giúp tôi nhiều như vậy, cảm ơn bạn."},
      {speaker:"男", pre:"晚上我请你吃饭，就去", blank:"公司南边的那家饭馆", post:"。",
       py:"Wǎnshang wǒ qǐng nǐ chīfàn, jiù qù gōngsī nánbian de nà jiā fànguǎn.",
       vn:"Tối nay tôi mời bạn ăn cơm, đến quán ăn ở phía nam công ty đó nhé."},
      {speaker:"女", pre:"好啊，我还", blank:"一次都没去过呢", post:"。",
       py:"Hǎo a, wǒ hái yí cì dōu méi qùguo ne.",
       vn:"Được đấy, tôi vẫn chưa đi lần nào cả."}
     ],
     explain:"男：你帮了我这么多，谢谢你。女：不客气。男：晚上我请你吃饭，就去公司南边的那家饭馆。女：好啊，我还一次都没去过呢。问：关于女的，可以知道什么？ → 没去过那个饭馆。"},
    {num:19, options:["考得不好","没带手表","还没复习"], ans:2, q:"关于女的，可以知道什么？",
     lines:[
      {speaker:"男", pre:"你怎么了？", blank:"一天都不高兴", post:"。",
       py:"Nǐ zěnme le? Yì tiān dōu bù gāoxìng.",
       vn:"Bạn sao vậy? Cả ngày đều không vui."},
      {speaker:"女", pre:"明天就要考试了，", blank:"我一点儿都没复习呢", post:"。",
       py:"Míngtiān jiù yào kǎoshì le, wǒ yìdiǎnr dōu méi fùxí ne.",
       vn:"Mai là thi rồi, tôi vẫn chưa ôn tập chút nào cả."},
      {speaker:"男", pre:"别着急，你学得好，", blank:"考试没问题", post:"。",
       py:"Bié zháojí, nǐ xué de hǎo, kǎoshì méi wèntí.",
       vn:"Đừng lo, bạn học tốt mà, thi không thành vấn đề đâu."}
     ],
     explain:"男：你怎么了？一天都不高兴。女：明天就要考试了，我一点儿都没复习呢。男：别着急，你学得好，考试没问题。女：希望这次能考好。问：关于女的，可以知道什么？ → 还没复习。"},
    {num:20, options:["爱买书","爱看书","读了一本书"], ans:0, q:"关于男的，可以知道什么？",
     lines:[
      {speaker:"女", pre:"你桌子上有", blank:"那么多书啊", post:"？",
       py:"Nǐ zhuōzi shang yǒu nàme duō shū a?",
       vn:"Trên bàn bạn có nhiều sách vậy à?"},
      {speaker:"男", pre:"对，都是", blank:"我买的", post:"。",
       py:"Duì, dōu shì wǒ mǎi de.",
       vn:"Đúng, đều là tôi mua đấy."},
      {speaker:"女", pre:"你真爱读书。哪本最有意思？", blank:"给我介绍一下吧", post:"。",
       py:"Nǐ zhēn ài dúshū. Nǎ běn zuì yǒu yìsi? Gěi wǒ jièshào yíxià ba.",
       vn:"Bạn thật thích đọc sách. Cuốn nào thú vị nhất? Giới thiệu cho tôi với."},
      {speaker:"男", pre:"我爱买书，但是这些书我", blank:"一本都没读过", post:"。",
       py:"Wǒ ài mǎi shū, dànshì zhèxiē shū wǒ yì běn dōu méi dúguo.",
       vn:"Tôi thích mua sách, nhưng những cuốn sách này tôi chưa đọc cuốn nào cả."}
     ],
