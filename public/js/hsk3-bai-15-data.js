...
var listenData = {
  ...
  mc: [
    {num:11, options:['环境不好','商店很远','夏天很热'], ans:2,
     lines:[
       {speaker:'男', pre:'你在这个地方生活了二十年，', blank:'对这儿很了解了吧', post:'？', py:'Nǐ zài zhège dìfang shēnghuóle èrshí nián, duì zhèr hěn liǎojiě le ba?', vn:'Bạn sống ở nơi này hai mươi năm rồi, chắc hiểu rõ nơi đây lắm nhỉ?'},
    ...
    {num:12, options:['裤子','裙子','衬衫'], ans:0,
     lines:[
       {speaker:'女', pre:'除了这条裤子以外，', blank:'还有什么要洗的吗', post:'？', py:'Chúle zhè tiáo kùzi yǐwài, hái yǒu shénme yào xǐ de ma?', vn:'Ngoài cái quần này ra, còn gì cần giặt không?'},
       {speaker:'男', pre:'那条裤子是干净的，不用洗，', blank:'你把那两件衬衫洗了吧', post:'。', py:'Nà tiáo kùzi shì gānjìng de, búyòng xǐ, nǐ bǎ nà liǎng jiàn chènshān xǐ le ba.', vn:'Cái quần đó sạch rồi, không cần giặt, bạn giặt hai cái áo sơ mi đó đi.'},
     ],
     explain:'女：除了这条裤子以外，还有什么要洗的吗？男：那条裤子是干净的，不用洗，你把那两件衬衫洗了吧。问：男的不让洗什么？ → 裤子。'},
    {num:13, options:['有电梯的','没电梯的','安静的'], ans:2,
     lines:[
       {speaker:'男', pre:'除了安静以外，您对房子还有什么要求吗？', blank:'有电梯的还是没电梯的', post:'？', py:'Chúle ānjìng yǐwài, nín duì fángzi hái yǒu shénme yāoqiú ma? Yǒu diàntī de háishi méi diàntī de?', vn:'Ngoài yên tĩnh ra, anh còn có yêu cầu gì về căn nhà không? Có thang máy hay không có thang máy?'},
       {speaker:'女', pre:'我只有这一个要求，', blank:'你们有这样的房子吗', post:'？', py:'Wǒ zhǐyǒu zhè yí ge yāoqiú, nǐmen yǒu zhèyàng de fángzi ma?', vn:'Tôi chỉ có mỗi một yêu cầu này thôi, các anh có nhà như vậy không?'},
     ],
     explain:'男：除了安静以外，您对房子还有什么要求吗？有电梯的还是没电梯的？女：我只有这一个要求，你们有这样的房子吗？问：女的想要什么样的房子？ → 安静的。'},
    {num:14, options:['不认真','特别漂亮','特别慢'], ans:1,
     lines:[
       {speaker:'男', pre:'你的字写得漂亮极了，你是怎么写的？', blank:'能教教我吗', post:'？', py:'Nǐ de zì xiě de piàoliang jí le, nǐ shì zěnme xiě de? Néng jiāojiao wǒ ma?', vn:'Chữ bạn viết đẹp lắm, bạn viết thế nào vậy? Dạy tôi được không?'},
       {speaker:'女', pre:'开始的时候除了认真学，慢慢写以外，还要努力练习，这样才能越写越快，', blank:'越写越漂亮', post:'。', py:'Kāishǐ de shíhou chúle rènzhēn xué, mànman xiě yǐwài, hái yào nǔlì liànxí, zhèyàng cái néng yuè xiě yuè kuài, yuè xiě yuè piàoliang.', vn:'Lúc đầu ngoài học nghiêm túc, viết chậm rãi ra, còn phải nỗ lực luyện tập, như vậy mới viết ngày càng nhanh, ngày càng đẹp.'},
     ],
    ...
    {num:15, options:['男的','自己','穿得漂亮的人'], ans:0,
     lines:[
       {speaker:'男', pre:'你今天穿得这么漂亮，', blank:'要见什么重要的人吗', post:'？', py:'Nǐ jīntiān chuān de zhème piàoliang, yào jiàn shénme zhòngyào de rén ma?', vn:'Hôm nay bạn ăn mặc đẹp thế, định gặp người quan trọng nào à?'},
       {speaker:'女', pre:'除了你以外，还有更重要的人吗？今天是中秋节，', blank:'我们一起去看个电影吧', post:'。', py:'Chúle nǐ yǐwài, hái yǒu gèng zhòngyào de rén ma? Jīntiān shì Zhōngqiū jié, wǒmen yìqǐ qù kàn ge diànyǐng ba.', vn:'Ngoài anh ra, còn ai quan trọng hơn nữa chứ? Hôm nay là Tết Trung thu, chúng ta cùng đi xem phim đi.'},
     ],
    ...
    {num:16, options:['喜欢夏天','不喜欢热','四个季节都喜欢'], ans:1,
     lines:[
       ...
       {speaker:'男', pre:'我怕热啊，这儿的夏天热极了，', blank:'你不觉得吗', post:'？', py:'Wǒ pà rè a, zhèr de xiàtiān rè jí le, nǐ bù juéde ma?', vn:'Tôi sợ nóng mà, mùa hè ở đây nóng lắm, bạn không thấy vậy sao?'},
     ],
    ...
    {num:17, options:['环境不错','不太安静','不太干净'], ans:0,
     lines:[
       ...
       {speaker:'男', pre:'是吗？', blank:'我看环境很好', post:'。', py:'Shì ma? Wǒ kàn huánjìng hěn hǎo.', vn:'Vậy à? Tôi thấy môi trường tốt lắm.'},
    ...
    {num:18, options:['颜色不好','不便宜','太大了'], ans:1,
     lines:[
       ...
       {speaker:'女', pre:'颜色也好看，我穿着它去参加朋友的生日晚会，', blank:'一定漂亮极了', post:'。', py:'Yánsè yě hǎokàn, wǒ chuānzhe tā qù cānjiā péngyou de shēngrì wǎnhuì, yídìng piàoliang jí le.', vn:'Màu sắc cũng đẹp, tôi mặc nó đi dự tiệc sinh nhật bạn, chắc chắn đẹp lắm.'},
       {speaker:'男', pre:'那你为什么不买？', blank:'有什么不满意吗', post:'？', py:'Nà nǐ wèishénme bù mǎi? Yǒu shénme bù mǎnyì ma?', vn:'Vậy sao bạn không mua? Có gì không hài lòng à?'},
       {speaker:'女', pre:'除了太贵以外，', blank:'没什么不满意的', post:'。', py:'Chúle tài guì yǐwài, méi shénme bù mǎnyì de.', vn:'Ngoài quá đắt ra, không có gì không hài lòng cả.'},
     ],
    ...
    {num:19, options:['不能打电话','没有声音','不能上网'], ans:2,
     lines:[
       ...
       {speaker:'男', pre:'除了上不去网以外，', blank:'还有什么其他问题吗', post:'？', py:'Chúle shàng bú qù wǎng yǐwài, hái yǒu shénme qítā wèntí ma?', vn:'Ngoài không lên mạng được ra, còn vấn đề gì khác không?'},
       {speaker:'女', pre:'打电话的时候声音特别小，', blank:'经常听不清楚', post:'。', py:'Dǎ diànhuà de shíhou shēngyīn tèbié xiǎo, jīngcháng tīng bu qīngchu.', vn:'Lúc gọi điện âm thanh rất nhỏ, thường nghe không rõ.'},
       {speaker:'男', pre:'您别着急，', blank:'我马上帮您看看', post:'。', py:'Nín bié zháojí, wǒ mǎshàng bāng nín kànkan.', vn:'Chị đừng lo, tôi xem giúp chị ngay đây.'},
     ],
