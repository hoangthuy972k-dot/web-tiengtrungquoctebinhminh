...
var sortData = [
  ...
  {words:['只要','你','穿','着','外套','，','天气','冷','也','没','关系','。'],ans:'只要你穿着外套，天气冷也没关系。',audio:'只要你穿着外套，天气冷也没关系。'},
...
var errorFixData = [
  {wrong:'桌子上一杯绿茶放着。',
   opts:['桌子上放着一杯绿茶。','桌子上一杯绿茶放着。','放着桌子上一杯绿茶。','一杯绿茶桌子上放着。'],ans:0,
   exp:'Câu tồn tại đúng thứ tự: [nơi chốn] + 放着 + [số lượng+danh từ]: 桌子上 + 放着 + 一杯绿茶, không đặt cụm danh từ trước động từ.'},
  {wrong:'桌子上放着花一朵。',
   opts:['桌子上放着一朵花。','桌子上放着花一朵。','桌子上花放着一朵。','一朵桌子上放着花。'],ans:0,
   exp:'Trong câu tồn tại "放着", cụm [số lượng+danh từ] phải đứng NGUYÊN VẸN sau 放着: 放着 + 一朵花, không tách rời số lượng ra sau danh từ.'},
  {wrong:'你想买裤子或者买衬衫？',
  ...
  {wrong:'洗衬衫小心的时候要点儿。',
   opts:['洗衬衫的时候要小心点儿。','洗衬衫小心的时候要点儿。','小心洗衬衫的时候要点儿。','洗衬衫的时候小心要点儿。'],ans:0,
   exp:'的时候 (lúc/khi) phải đứng NGAY SAU cụm từ chỉ hành động (洗衬衫的时候), không được chen vào giữa 小心 và 点儿.'},
  {wrong:'我不裤子记得放哪儿了。',
