...
var listenData = {
  ...
  mc: [
    {num:11, options:['不新鲜','太贵了','很新鲜'], ans:0,
     lines:[
       {speaker:'男', pre:'我们买点儿香蕉吧，', blank:'家里没有水果了', post:'。', py:'Wǒmen mǎi diǎnr xiāngjiāo ba, jiā li méiyǒu shuǐguǒ le.', vn:'Chúng ta mua ít chuối đi, nhà không còn trái cây nữa.'},
       {speaker:'女', pre:'买西瓜吧，', blank:'这些香蕉像是放了很久了', post:'。', py:'Mǎi xīguā ba, zhèxiē xiāngjiāo xiàng shì fàngle hěn jiǔ le.', vn:'Mua dưa hấu đi, mấy quả chuối này có vẻ để lâu rồi.'},
     ],
     explain:'男：我们买点儿香蕉吧，家里没有水果了。女：买西瓜吧，这些香蕉像是放了很久了。问：女的觉得香蕉怎么样？ → 不新鲜。'},
    {num:12, options:['画了很长时间','画得很像','画得不好看'], ans:1,
     lines:[
       {speaker:'男', pre:'你的熊猫画得真好，', blank:'像真的一样。我要多久才可以像你一样', post:'？', py:'Nǐ de xióngmāo huà de zhēn hǎo, xiàng zhēn de yíyàng. Wǒ yào duōjiǔ cái kěyǐ xiàng nǐ yíyàng?', vn:'Bạn vẽ con gấu trúc đẹp thật, giống như thật vậy. Tôi phải mất bao lâu mới được như bạn?'},
       {speaker:'女', pre:'这不是时间的问题，', blank:'主要是要有兴趣', post:'。', py:'Zhè bú shì shíjiān de wèntí, zhǔyào shì yào yǒu xìngqù.', vn:'Đây không phải vấn đề thời gian, chủ yếu là phải có hứng thú.'},
     ],
     explain:'男：你的熊猫画得真好，像真的一样。我要多久才可以像你一样？女：这不是时间的问题，主要是要有兴趣。问：女的画熊猫画得怎么样？ → 画得很像。'},
    {num:13, options:['以前像妈妈','以前像爸爸','现在像妈妈'], ans:0,
     lines:[
       {speaker:'男', pre:'你女儿像谁？', blank:'你还是她爸爸', post:'？', py:'Nǐ nǚ\'ér xiàng shéi? Nǐ háishi tā bàba?', vn:'Con gái bạn giống ai? Bạn hay bố nó?'},
       {speaker:'女', pre:'小时候像我，', blank:'现在越来越像她爸爸了', post:'。', py:'Xiǎoshíhou xiàng wǒ, xiànzài yuè lái yuè xiàng tā bàba le.', vn:'Lúc nhỏ giống tôi, giờ ngày càng giống bố nó rồi.'},
     ],
     explain:'男：你女儿像谁？你还是她爸爸？女：小时候像我，现在越来越像她爸爸了。问：关于女儿，可以知道什么？ → 以前像妈妈。'},
    {num:14, options:['词典在哪儿','这个字怎么写','这个字怎么读'], ans:2,
     lines:[
       {speaker:'男', pre:'这个字有几个读音？', blank:'我记得只有一个', post:'。', py:'Zhège zì yǒu jǐ ge dúyīn? Wǒ jìde zhǐyǒu yí ge.', vn:'Chữ này có mấy âm đọc? Tôi nhớ chỉ có một thôi.'},
       {speaker:'女', pre:'我记得有两个。你帮我把词典拿过来，', blank:'我们一起看看', post:'。', py:'Wǒ jìde yǒu liǎng ge. Nǐ bāng wǒ bǎ cídiǎn ná guolai, wǒmen yìqǐ kànkan.', vn:'Tôi nhớ có hai. Bạn giúp tôi lấy từ điển đến, chúng ta cùng xem.'},
     ],
     explain:'男：这个字有几个读音？我记得只有一个。女：我记得有两个。你帮我把词典拿过来，我们一起看看。问：他们想知道什么？ → 这个字怎么读。'},
    {num:15, options:['洗盘子','看节目','把声音开大'], ans:2,
     lines:[
       {speaker:'男', pre:'快来看啊，', blank:'这个节目太有意思了', post:'。', py:'Kuài lái kàn a, zhège jiémù tài yǒuyìsi le.', vn:'Mau lại xem đi, chương trình này thú vị lắm.'},
       {speaker:'女', pre:'我在洗盘子呢，', blank:'你把电视声音开大一点儿', post:'。', py:'Wǒ zài xǐ pánzi ne, nǐ bǎ diànshì shēngyīn kāi dà yìdiǎnr.', vn:'Tôi đang rửa đĩa đây, bạn vặn to tiếng tivi lên một chút.'},
     ],
     explain:'男：快来看啊，这个节目太有意思了。女：我在洗盘子呢，你把电视声音开大一点儿。问：女的想让男的做什么？ → 把声音开大。'},
    {num:16, options:['洗盘子','买水果','下楼'], ans:2,
     lines:[
       {speaker:'男', pre:'叔叔和阿姨第一次来我们家，是不是走错路了？', blank:'已经三点零五了', post:'。', py:'Shūshu hé āyí dì-yī cì lái wǒmen jiā, shì bu shì zǒu cuò lù le? Yǐjīng sān diǎn líng wǔ le.', vn:'Chú và cô lần đầu đến nhà chúng ta, có phải đi lạc đường không? Đã 3 giờ 5 phút rồi.'},
       {speaker:'女', pre:'你先把盘子洗一下，再从冰箱里把香蕉、苹果、饮料拿出来放好，', blank:'然后我们下楼去等他们', post:'。', py:'Nǐ xiān bǎ pánzi xǐ yíxià, zài cóng bīngxiāng li bǎ xiāngjiāo, píngguǒ, yǐnliào ná chulai fànghǎo, ránhòu wǒmen xiàlóu qù děng tāmen.', vn:'Anh rửa đĩa trước đã, rồi lấy chuối, táo, nước uống từ tủ lạnh ra xếp gọn, sau đó chúng ta xuống lầu đợi họ.'},
       ...
       {speaker:'女', pre:'不少。快把衣服穿好，', blank:'我们下去吧', post:'。', py:'Bù shǎo. Kuài bǎ yīfu chuānhǎo, wǒmen xiàqu ba.', vn:'Không ít đâu. Mau mặc đồ xong đi, chúng ta xuống thôi.'},
     ],
    ...
    {num:17, options:['开车','买伞','跑步'], ans:0,
     lines:[
       {speaker:'女', pre:'雨下得真大。你的车放哪儿了？', blank:'我们快点儿跑过去', post:'。', py:'Yǔ xià de zhēn dà. Nǐ de chē fàng nǎr le? Wǒmen kuài diǎnr pǎo guoqu.', vn:'Mưa to thật. Xe bạn để đâu vậy? Chúng ta chạy nhanh qua đó đi.'},
       {speaker:'男', pre:'你就在这儿等，我先过去把车开过来，', blank:'然后你再上车', post:'。', py:'Nǐ jiù zài zhèr děng, wǒ xiān guòqu bǎ chē kāi guolai, ránhòu nǐ zài shàng chē.', vn:'Bạn cứ đợi ở đây, tôi qua đó lái xe đến trước, sau đó bạn lên xe.'},
       {speaker:'女', pre:'那我把伞给你，', blank:'你拿着伞走过去', post:'。', py:'Nà wǒ bǎ sǎn gěi nǐ, nǐ názhe sǎn zǒu guoqu.', vn:'Vậy tôi đưa ô cho bạn, bạn cầm ô đi qua đó.'},
       {speaker:'男', pre:'刮这么大的风，', blank:'伞没有用', post:'。', py:'Guā zhème dà de fēng, sǎn méiyǒu yòng.', vn:'Gió to thế này, ô cũng vô dụng thôi.'},
     ],
    ...
    {num:18, options:['把电视声音关小','把房间打扫干净','过来看电视节目'], ans:2,
     lines:[
       ...
       {speaker:'男', pre:'这个节目里的小猫小狗特别有意思，你先过来看，', blank:'一会儿再打扫房间', post:'。', py:'Zhège jiémù li de xiǎomāo xiǎogǒu tèbié yǒuyìsi, nǐ xiān guòlai kàn, yíhuìr zài dǎsǎo fángjiān.', vn:'Mèo con chó con trong chương trình này thú vị lắm, bạn lại đây xem trước đã, lát nữa dọn phòng cũng được.'},
       {speaker:'女', pre:'把电视声音关小点儿，儿子明天考试，正复习呢，', blank:'别影响他', post:'。', py:'Bǎ diànshì shēngyīn guān xiǎo diǎnr, érzi míngtiān kǎoshì, zhèng fùxí ne, bié yǐngxiǎng tā.', vn:'Vặn nhỏ tiếng tivi lại, con trai mai thi, đang ôn bài đấy, đừng làm ảnh hưởng nó.'},
       {speaker:'男', pre:'好，', blank:'你快过来吧', post:'。', py:'Hǎo, nǐ kuài guòlai ba.', vn:'Được, bạn mau lại đây đi.'},
     ],
    ...
    {num:19, options:['看房子','买桌椅','找饭馆'], ans:1,
     lines:[
       {speaker:'女', pre:'这椅子有点儿矮，', blank:'坐着不舒服', post:'。', py:'Zhè yǐzi yǒudiǎnr ǎi, zuòzhe bù shūfu.', vn:'Cái ghế này hơi thấp, ngồi không thoải mái.'},
       {speaker:'男', pre:'没关系，我们去那边看看，', blank:'那儿也有', post:'。', py:'Méi guānxi, wǒmen qù nàbian kànkan, nàr yě yǒu.', vn:'Không sao, chúng ta qua bên kia xem thử, chỗ đó cũng có.'},
       {speaker:'女', pre:'这层有桌子吗？今天把桌子、', blank:'椅子都一起换了吧', post:'。', py:'Zhè céng yǒu zhuōzi ma? Jīntiān bǎ zhuōzi, yǐzi dōu yìqǐ huàn le ba.', vn:'Tầng này có bàn không? Hôm nay đổi luôn cả bàn lẫn ghế đi.'},
       {speaker:'男', pre:'好，我们先看椅子，再看桌子，', blank:'然后去吃饭', post:'。', py:'Hǎo, wǒmen xiān kàn yǐzi, zài kàn zhuōzi, ránhòu qù chī fàn.', vn:'Được, chúng ta xem ghế trước, rồi xem bàn, sau đó đi ăn cơm.'},
     ],
    ...
    {num:20, options:['爸爸回来了','她要唱歌','她想安静一会儿'], ans:2,
     lines:[
       ...
       {speaker:'女', pre:'我听不见啊，', blank:'你把音乐声音关小些', post:'。', py:'Wǒ tīng bu jiàn a, nǐ bǎ yīnyuè shēngyīn guān xiǎo xiē.', vn:'Chị không nghe thấy đâu, em vặn nhỏ tiếng nhạc lại đi.'},
       {speaker:'男', pre:'不是爸爸，', blank:'是楼上的周叔叔在说话。那我听歌了啊', post:'。', py:'Bú shì bàba, shì lóushàng de Zhōu shūshu zài shuōhuà. Nà wǒ tīng gē le a.', vn:'Không phải bố, là chú Chu trên lầu đang nói chuyện. Vậy em nghe nhạc tiếp nhé.'},
       {speaker:'女', pre:'你别把声音开那么大，', blank:'我想安静一会儿', post:'。', py:'Nǐ bié bǎ shēngyīn kāi nàme dà, wǒ xiǎng ānjìng yíhuìr.', vn:'Em đừng mở nhạc to thế, chị muốn yên tĩnh một lát.'},
     ],
