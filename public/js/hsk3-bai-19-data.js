...
var matchData = [
  ...
  {left:'一张',right:'照片'},
  {left:'学',right:'鸟叫'},
  {left:'使脸看上去',right:'漂亮一些。'},
  {left:'考试',right:'让我很紧张。'},
  {left:'前边的车越开越慢，',right:'停下来了。'},
...
var fillData = [
  ...
  {pre:'',blank:'哭',post:'的时候，只要他爸爸学小鸟叫。',hint:'(khóc)',ans:'哭'},
...
var sortData = [
  ...
  {words:['考试','让','我','很','紧张','。'],ans:'考试让我很紧张。',audio:'考试让我很紧张。'},
  ...
  mc: [
    {num:11, options:['他不高兴了','眼睛里有东西','不喜欢刮风'], ans:1,
     lines:[
       ...
       {speaker:'男', pre:'', blank:'没有啊，刚才风刮得太大，眼睛里进东西了', post:'。', py:'Méiyǒu a, gāngcái fēng guā de tài dà, yǎnjing li jìn dōngxi le.', vn:'Không có, vừa nãy gió thổi to quá, có vật gì vào mắt rồi.'},
     ],
     explain:'女：你哭了？男：没有啊，刚才风刮得太大，眼睛里进东西了。问：男的怎么了？ → 眼睛里有东西。'},
    {num:12, options:['她骑得不快','她不太小心','她会骑马'], ans:2,
     lines:[
       {speaker:'男', pre:'', blank:'小心点儿，别骑太快了', post:'。', py:'Xiǎoxīn diǎnr, bié qí tài kuài le.', vn:'Cẩn thận chút, đừng cưỡi nhanh quá.'},
       {speaker:'女', pre:'', blank:'放心，我又不是第一次骑马', post:'。', py:'Fàngxīn, wǒ yòu bú shì dì-yī cì qí mǎ.', vn:'Yên tâm, tôi cũng đâu phải lần đầu cưỡi ngựa.'},
     ],
     explain:'男：小心点儿，别骑太快了。女：放心，我又不是第一次骑马。问：女的是什么意思？ → 她会骑马。'},
    {num:13, options:['睡觉','吃糖','起床'], ans:0,
     lines:[
       {speaker:'男', pre:'', blank:'都这么晚了，你怎么还吃糖', post:'？', py:'Dōu zhème wǎn le, nǐ zěnme hái chī táng?', vn:'Muộn thế này rồi, sao bạn còn ăn kẹo?'},
       {speaker:'女', pre:'', blank:'不吃了，我现在就去刷牙洗脸', post:'。', py:'Bù chī le, wǒ xiànzài jiù qù shuā yá xǐliǎn.', vn:'Không ăn nữa, tôi đi đánh răng rửa mặt ngay đây.'},
     ],
     explain:'男：都这么晚了，你怎么还吃糖？女：不吃了，我现在就去刷牙洗脸。问：女的打算做什么？ → 睡觉。'},
    {num:14, options:['坐船','坐公共汽车','打车'], ans:1,
     lines:[
       {speaker:'男', pre:'', blank:'你终于来了，船马上就开了', post:'。', py:'Nǐ zhōngyú lái le, chuán mǎshàng jiù kāi le.', vn:'Bạn cuối cùng cũng đến rồi, thuyền sắp chạy rồi.'},
       {speaker:'女', pre:'', blank:'我没想到坐公共汽车要花这么长时间，早知道就打车来了', post:'。', py:'Wǒ méi xiǎngdào zuò gōnggòng qìchē yào huā zhème cháng shíjiān, zǎo zhīdào jiù dǎchē lái le.', vn:'Tôi không ngờ đi xe buýt lại mất nhiều thời gian thế, biết vậy thì bắt taxi đến rồi.'},
     ],
     explain:'男：你终于来了，船马上就开了。女：我没想到坐公共汽车要花这么长时间，早知道就打车来了。问：女的是怎么来这儿的？ → 坐公共汽车。'},
    {num:15, options:['他喜欢做面条','女的过生日','面条很好吃'], ans:1,
     lines:[
       {speaker:'男', pre:'', blank:'过生日要吃面条，这是我第一次做面条，看看好吃不好吃', post:'。', py:'Guò shēngrì yào chī miàntiáo, zhè shì wǒ dì-yī cì zuò miàntiáo, kànkan hǎochī bù hǎochī.', vn:'Sinh nhật phải ăn mì, đây là lần đầu tiên tôi làm mì, xem thử ngon không.'},
    ...
    {num:16, options:['喜欢玩儿游戏','看错了一个人','去开花园的灯'], ans:1,
     lines:[
       ...
       {speaker:'男', pre:'', blank:'没有，我一直在家里玩儿电脑游戏', post:'。', py:'Méiyǒu, wǒ yìzhí zài jiā li wánr diànnǎo yóuxì.', vn:'Không có, tôi cứ ở nhà chơi game máy tính mãi.'},
       {speaker:'女', pre:'', blank:'那是我看错了，那个人看上去真像你', post:'。', py:'Nà shì wǒ kàn cuò le, nàge rén kàn shangqu zhēn xiàng nǐ.', vn:'Vậy là tôi nhìn nhầm rồi, người đó trông giống bạn thật đấy.'},
       {speaker:'男', pre:'', blank:'花园里没有灯，看错了也不奇怪', post:'。', py:'Huāyuán li méiyǒu dēng, kàn cuò le yě bù qíguài.', vn:'Vườn hoa không có đèn, nhìn nhầm cũng không lạ.'},
     ],
    ...
    {num:17, options:['担心男的的身体','耳朵进水了','游泳很小心'], ans:1,
     lines:[
       {speaker:'男', pre:'', blank:'小丽，你怎么了', post:'？', py:'Xiǎolì, nǐ zěnme le?', vn:'Tiểu Lệ, bạn sao thế?'},
       {speaker:'女', pre:'', blank:'刚才游泳时耳朵进水了，现在耳朵里一直不舒服', post:'。', py:'Gāngcái yóuyǒng shí ěrduo jìn shuǐ le, xiànzài ěrduo li yìzhí bù shūfu.', vn:'Vừa nãy bơi bị nước vào tai, giờ trong tai cứ khó chịu mãi.'},
       ...
       {speaker:'女', pre:'', blank:'好多了，让你担心了', post:'。', py:'Hǎo duō le, ràng nǐ dānxīn le.', vn:'Đỡ nhiều rồi, để bạn lo lắng rồi.'},
     ],
    ...
    {num:18, options:['白色','蓝色','黑色'], ans:1,
     lines:[
       {speaker:'女', pre:'', blank:'先生，您看这件衬衫怎么样', post:'？', py:'Xiānsheng, nín kàn zhè jiàn chènshān zěnme yàng?', vn:'Thưa anh, anh xem cái áo sơ mi này thế nào?'},
       {speaker:'男', pre:'', blank:'还不错，除了白色，还有其他颜色的吗', post:'？', py:'Hái búcuò, chúle báisè, hái yǒu qítā yánsè de ma?', vn:'Cũng được, ngoài màu trắng ra, còn có màu khác không?'},
       {speaker:'女', pre:'', blank:'还有蓝色和黑色的，拿一件您试试', post:'？', py:'Hái yǒu lánsè hé hēisè de, ná yí jiàn nín shìshi?', vn:'Còn có màu xanh và màu đen nữa, lấy một cái anh mặc thử nhé?'},
    ...
    {num:19, options:['感冒了','没洗脸','要买西药'], ans:0,
     lines:[
       {speaker:'男', pre:'', blank:'你的脸色看上去不太好，哪儿不舒服啊', post:'？', py:'Nǐ de liǎnsè kàn shangqu bú tài hǎo, nǎr bù shūfu a?', vn:'Sắc mặt bạn trông không tốt lắm, chỗ nào khó chịu vậy?'},
       {speaker:'女', pre:'', blank:'我感冒了，都快一个星期了', post:'。', py:'Wǒ gǎnmào le, dōu kuài yí ge xīngqī le.', vn:'Tôi bị cảm rồi, sắp một tuần rồi.'},
       {speaker:'男', pre:'', blank:'我去药店给你买点儿药吧，买西药还是中药', post:'？', py:'Wǒ qù yàodiàn gěi nǐ mǎi diǎnr yào ba, mǎi xīyào háishi zhōngyào?', vn:'Tôi đi hiệu thuốc mua thuốc cho bạn nhé, mua thuốc tây hay thuốc bắc?'},
    ...
    {num:20, options:['买船票','买机票','回国'], ans:1,
     lines:[
       ...
       {speaker:'女', pre:'', blank:'坐船虽然便宜，但是太慢了，要十四个小时', post:'。', py:'Zuò chuán suīrán piányi, dànshì tài màn le, yào shísì ge xiǎoshí.', vn:'Đi tàu tuy rẻ, nhưng chậm quá, phải mất mười bốn tiếng.'},
       {speaker:'男', pre:'', blank:'那我们还是坐飞机吧，你去买两张机票，下周末的', post:'。', py:'Nà wǒmen háishi zuò fēijī ba, nǐ qù mǎi liǎng zhāng jīpiào, xià zhōumò de.', vn:'Vậy chúng ta đi máy bay thì hơn, bạn đi mua hai vé máy bay, cuối tuần sau nhé.'},
       {speaker:'女', pre:'', blank:'好的，我现在就去', post:'。', py:'Hǎo de, wǒ xiànzài jiù qù.', vn:'Được, tôi đi ngay đây.'},
     ],
