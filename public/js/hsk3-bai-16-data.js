...
var matchData = [
  ...
  {left:'虽然钱不是问题了，',right:'但是主要是没有时间。'},
  {left:'如果能多用"您好""谢谢"这样的词语，',right:'关系就会更好。'},
...
var sortData = [
  ...
  {words:['那个','小','孩子','长','得','瘦瘦','的','、','高高','的','，','很','可爱','。'],ans:'那个小孩子长得瘦瘦的、高高的，很可爱。',audio:'那个小孩子长得瘦瘦的、高高的，很可爱。'},
  {words:['我','每天','累','得','下','了','班','就','想','睡着','。'],ans:'我每天累得下了班就想睡着。',audio:'我每天累得下了班就想睡着。'},
  {words:['如果','你','想','学好','中文','，','就','应该','每天','多','说','多','问','。'],ans:'如果你想学好中文，就应该每天多说多问。',audio:'如果你想学好中文，就应该每天多说多问。'},
  {words:['虽然','工作','很','忙','，','但是','他','每天','都','回家','休息','。'],ans:'虽然工作很忙，但是他每天都回家休息。',audio:'虽然工作很忙，但是他每天都回家休息。'},
  {words:['如果','能','多','用','您好','、','谢谢','这样','的','词语','，','关系','就','会','更好','。'],ans:'如果能多用您好、谢谢这样的词语，关系就会更好。',audio:'如果能多用您好、谢谢这样的词语，关系就会更好。'},
  ...
  dictation: [
    {num:1, lines:[
      {speaker:"女", pre:"你好，", blank:"你有什么问题？哪儿不舒服", post:"？",
       py:"Nǐ hǎo, nǐ yǒu shénme wèntí? Nǎr bù shūfu?",
       vn:"Chào bạn, bạn có vấn đề gì vậy? Chỗ nào khó chịu?"},
      {speaker:"男", pre:"医生，", blank:"我最近一直头疼，疼得晚上睡不着觉。有什么药吗", post:"？",
       py:"Yīshēng, wǒ zuìjìn yìzhí tóuténg, téng de wǎnshang shuì bu zháo jiào. Yǒu shénme yào ma?",
       vn:"Bác sĩ ơi, gần đây tôi cứ đau đầu, đau đến mức tối không ngủ được. Có thuốc gì không ạ?"}]},
    {num:2, lines:[
      {speaker:"女", pre:"常医生，", blank:"我的牙不疼了，应该没什么问题了吧", post:"？",
       py:"Cháng yīshēng, wǒ de yá bù téng le, yīnggāi méi shénme wèntí le ba?",
       vn:"Bác sĩ Thường ơi, răng tôi không đau nữa rồi, chắc không có vấn đề gì nữa nhỉ?"},
    ...
    {num:3, lines:[
      {speaker:"女", pre:"你看！那边真漂亮！", blank:"有山有水，有树有花，还有几个小房子，美得像画一样", post:"。",
       py:"Nǐ kàn! Nàbian zhēn piàoliang! Yǒu shān yǒu shuǐ, yǒu shù yǒu huā, hái yǒu jǐ ge xiǎo fángzi, měi de xiàng huà yíyàng.",
       vn:"Bạn xem! Chỗ đó đẹp thật! Có núi có nước, có cây có hoa, còn có mấy căn nhà nhỏ, đẹp như tranh vậy."},
      {speaker:"男", pre:"", blank:"那还等什么？快过去看看吧", post:"。",
       py:"Nà hái děng shénme? Kuài guòqu kànkan ba.",
       vn:"Vậy còn chờ gì nữa? Mau qua xem thử đi."}]},
    {num:4, lines:[
      {speaker:"男", pre:"", blank:"你的两个女儿长得真像！这个头发长长的是姐姐吧", post:"？",
       py:"Nǐ de liǎng ge nǚ'ér zhǎng de zhēn xiàng! Zhège tóufa chángcháng de shì jiějie ba?",
       vn:"Hai đứa con gái bạn giống nhau thật! Đứa tóc dài dài này là chị gái phải không?"},
      {speaker:"女", pre:"", blank:"这是我二女儿，她喜欢长头发。大女儿不喜欢", post:"。",
       py:"Zhè shì wǒ èr nǚ'ér, tā xǐhuan cháng tóufa. Dà nǚ'ér bù xǐhuan.",
       vn:"Đây là con gái thứ hai của tôi, con bé thích để tóc dài. Con gái lớn thì không thích."}]},
    {num:5, lines:[
      ...
      {speaker:"女", pre:"还很聪明呢。", blank:"它跟我女儿的关系特别好，每天都帮她把小皮鞋放好", post:"。",
       py:"Hái hěn cōngming ne. Tā gēn wǒ nǚ'ér de guānxi tèbié hǎo, měi tiān dōu bāng tā bǎ xiǎo píxié fànghǎo.",
       vn:"Còn thông minh nữa. Nó với con gái tôi quan hệ rất tốt, ngày nào cũng giúp con bé xếp gọn đôi giày da nhỏ."}]},
    {num:6, stmt:"他不知道常月现在变胖了还是变瘦了。", judge:true, lines:[
      {pre:"常月是我上大学时的好朋友。那时候她很瘦，瘦得只有40公斤。", blank:"听说她现在已经是三个孩子的妈妈了，不知道长胖一点儿没有", post:"。",
       py:"Cháng Yuè shì wǒ shàng dàxué shí de hǎo péngyou. Nà shíhou tā hěn shòu, shòu de zhǐyǒu sìshí gōngjīn. Tīngshuō tā xiànzài yǐjīng shì sān ge háizi de māma le, bù zhīdào zhǎngpàng yìdiǎnr méiyǒu.",
       vn:"Thường Nguyệt là bạn thân thời đại học của tôi. Lúc đó cô ấy rất gầy, gầy đến mức chỉ có 40 cân. Nghe nói bây giờ cô ấy đã là mẹ của ba đứa con rồi, không biết có mập lên chút nào không."}]},
    {num:7, stmt:"小丽没听明白自己的工作是什么。", judge:false, lines:[
      {pre:"今天的会议就到这儿吧，大家对自己的工作都清楚了吗？", blank:"如果有什么不明白的地方，就去秘书办公室问小丽", post:"。",
       py:"Jīntiān de huìyì jiù dào zhèr ba, dàjiā duì zìjǐ de gōngzuò dōu qīngchu le ma? Rúguǒ yǒu shénme bù míngbai de dìfang, jiù qù mìshū bàngōngshì wèn Xiǎolì.",
       vn:"Cuộc họp hôm nay đến đây thôi, mọi người đều rõ công việc của mình chưa? Nếu có chỗ nào không hiểu, thì đến văn phòng thư ký hỏi Tiểu Lệ."}]},
    {num:8, stmt:"女儿喜欢新衣服和新鞋。", judge:false, lines:[
      {pre:"我女儿每天都说\"从明天开始我每天跑五千米\"，我和妻子很早就给她买好了运动服、运动鞋。", blank:"直到今天，鞋和衣服还都是新的", post:"。",
       py:"Wǒ nǚ'ér měi tiān dōu shuō \"cóng míngtiān kāishǐ wǒ měi tiān pǎo wǔqiān mǐ\", wǒ hé qīzi hěn zǎo jiù gěi tā mǎihǎole yùndòngfú, yùndòngxié. Zhídào jīntiān, xié hé yīfu hái dōu shì xīn de.",
       vn:"Con gái tôi ngày nào cũng nói \"từ mai con sẽ chạy năm nghìn mét mỗi ngày\", vợ chồng tôi mua sẵn đồ thể thao, giày thể thao cho con từ sớm. Đến tận hôm nay, giày và quần áo vẫn còn mới nguyên."}]},
    {num:9, stmt:"儿子没让我买东西给他。", judge:true, lines:[
      {pre:"赛前，我跟儿子说：\"如果你拿了第一，你要什么我就给你买什么。\"", blank:"没想到儿子真的拿了第一，更没想到他的要求是让我在家休息一天", post:"。",
       py:"Sài qián, wǒ gēn érzi shuō: \"Rúguǒ nǐ nále dì yī, nǐ yào shénme wǒ jiù gěi nǐ mǎi shénme.\" Méi xiǎngdào érzi zhēn de nále dì yī, gèng méi xiǎngdào tā de yāoqiú shì ràng wǒ zài jiā xiūxi yì tiān.",
       vn:"Trước cuộc thi, tôi nói với con trai: \"Nếu con giành giải nhất, con muốn gì bố mua cái đó cho.\" Không ngờ con trai thật sự giành giải nhất, càng không ngờ yêu cầu của con là để bố nghỉ ở nhà một ngày."}]},
    {num:10, stmt:"每个星期五老师都送给每个学生一件礼物。", judge:false, lines:[
      {pre:"每个星期五，我们班中文老师都带着同学们复习。", blank:"如果有人能把这个星期学的词语都写对，老师就送给他一件礼物", post:"。",
       py:"Měi ge xīngqīwǔ, wǒmen bān Zhōngwén lǎoshī dōu dàizhe tóngxuémen fùxí. Rúguǒ yǒu rén néng bǎ zhège xīngqī xué de cíyǔ dōu xiěduì, lǎoshī jiù sòng gěi tā yí jiàn lǐwù.",
       vn:"Thứ Sáu hàng tuần, thầy giáo tiếng Trung lớp tôi đều dẫn các bạn ôn tập. Nếu ai viết đúng hết những từ ngữ học trong tuần này, thầy sẽ tặng người đó một món quà."}]}
  ],
  mc: [
    {num:11, options:["眼睛红","打算去医院","买了一个红眼镜"], ans:0, q:"关于女的，可以知道什么？",
     lines:[
      {speaker:"男", pre:"最近你的眼睛一直红红的，", blank:"我带你去医院检查一下吧", post:"。",
       py:"Zuìjìn nǐ de yǎnjing yìzhí hónghóng de, wǒ dài nǐ qù yīyuàn jiǎnchá yíxià ba.",
       vn:"Gần đây mắt bạn cứ đỏ đỏ, tôi đưa bạn đi bệnh viện khám thử đi."},
      {speaker:"女", pre:"我去过了，医生说没什么事，不用吃药，", blank:"让我多休息", post:"。",
       py:"Wǒ qùguo le, yīshēng shuō méi shénme shì, búyòng chī yào, ràng wǒ duō xiūxi.",
       vn:"Tôi đi rồi, bác sĩ nói không sao, không cần uống thuốc, bảo tôi nghỉ ngơi nhiều."}
     ],
     explain:"男：最近你的眼睛一直红红的，我带你去医院检查一下吧。女：我去过了，医生说没什么事，不用吃药，让我多休息。问：关于女的，可以知道什么？ → 眼睛红。"},
    {num:12, options:["明天天气好","太阳能从西边出来","认为男的不可能去跑步"], ans:2, q:"女的是什么意思？",
     lines:[
      {speaker:"男", pre:"我打算从明天开始，", blank:"每天去运动场跑两千米", post:"。",
       py:"Wǒ dǎsuàn cóng míngtiān kāishǐ, měi tiān qù yùndòngchǎng pǎo liǎng qiān mǐ.",
       vn:"Tôi định từ mai bắt đầu, mỗi ngày ra sân vận động chạy hai nghìn mét."},
      {speaker:"女", pre:"真的吗？如果你能这么做，", blank:"太阳就能从西边出来", post:"。",
       py:"Zhēn de ma? Rúguǒ nǐ néng zhème zuò, tàiyáng jiù néng cóng xībian chūlai.",
       vn:"Thật à? Nếu bạn làm được vậy thì mặt trời sẽ mọc từ hướng tây mất."}
     ],
     explain:"男：我打算从明天开始，每天去运动场跑两千米。女：真的吗？如果你能这么做，太阳就能从西边出来。问：女的是什么意思？ → 认为男的不可能去跑步。"},
    {num:13, options:["女儿","妈妈","奶奶"], ans:2, q:"女的是男的的什么人？",
     lines:[
      {speaker:"女", pre:"乐乐，快让奶奶看看，你长高了，也长胖了。", blank:"这双小皮鞋真好看，谁给你买的", post:"？",
       py:"Lèlè, kuài ràng nǎinai kànkan, nǐ zhǎnggāo le, yě zhǎngpàng le. Zhè shuāng xiǎo píxié zhēn hǎokàn, shéi gěi nǐ mǎi de?",
       vn:"Lạc Lạc, mau để bà xem, con cao lên rồi, cũng mập lên rồi. Đôi giày da nhỏ này đẹp thật, ai mua cho con vậy?"},
      {speaker:"男", pre:"是妈妈，她说如果我这次考试还拿第一，", blank:"就再给我买一双", post:"。",
       py:"Shì māma, tā shuō rúguǒ wǒ zhè cì kǎoshì hái ná dì yī, jiù zài gěi wǒ mǎi yì shuāng.",
       vn:"Là mẹ mua đấy, mẹ nói nếu lần thi này con vẫn giành giải nhất thì mẹ sẽ mua thêm cho con một đôi nữa."}
     ],
     explain:"女：乐乐，快让奶奶看看，你长高了，也长胖了。这双小皮鞋真好看，谁给你买的？男：是妈妈，她说如果我这次考试还拿第一，就再给我买一双。问：女的是男的的什么人？ → 奶奶。"},
    {num:14, options:["中午吃过药了","现在要去医院","现在能吃甜的"], ans:0, q:"关于男的，可以知道什么？",
     lines:[
      {speaker:"男", pre:"我觉得中午吃的药没什么用，牙还是很疼，", blank:"不能吃甜的", post:"。",
       py:"Wǒ juéde zhōngwǔ chī de yào méi shénme yòng, yá háishi hěn téng, bù néng chī tián de.",
       vn:"Tôi thấy thuốc uống buổi trưa chẳng có tác dụng gì, răng vẫn đau lắm, không ăn được đồ ngọt."},
      {speaker:"女", pre:"等一晚上，如果明天还不好，就带你去医院检查一下，", blank:"看看医生怎么说", post:"。",
       py:"Děng yì wǎnshang, rúguǒ míngtiān hái bù hǎo, jiù dài nǐ qù yīyuàn jiǎnchá yíxià, kànkan yīshēng zěnme shuō.",
       vn:"Đợi qua đêm nay, nếu mai vẫn không đỡ thì đưa bạn đi bệnh viện khám, xem bác sĩ nói sao."}
     ],
     explain:"男：我觉得中午吃的药没什么用，牙还是很疼，不能吃甜的。女：等一晚上，如果明天还不好，就带你去医院检查一下，看看医生怎么说。问：关于男的，可以知道什么？ → 中午吃过药了。"},
    {num:15, options:["老高","高山","高静"], ans:2, q:"男的打算给女儿起什么名字？",
     lines:[
      {speaker:"女", pre:"老高，", blank:"你说我们给孩子起什么名字好", post:"？",
       py:"Lǎo Gāo, nǐ shuō wǒmen gěi háizi qǐ shénme míngzi hǎo?",
       vn:"Lão Cao ơi, anh nói xem đặt tên gì cho con mình đây?"},
      {speaker:"男", pre:"如果是男孩儿，就叫高山，如果是女孩儿，", blank:"就叫高静，怎么样", post:"？",
       py:"Rúguǒ shì nánháir, jiù jiào Gāo Shān, rúguǒ shì nǚháir, jiù jiào Gāo Jìng, zěnme yàng?",
       vn:"Nếu là con trai thì đặt là Cao Sơn, nếu là con gái thì đặt là Cao Tĩnh, thế nào?"}
     ],
     explain:"女：老高，你说我们给孩子起什么名字好？男：如果是男孩儿，就叫高山，如果是女孩儿，就叫高静，怎么样？问：男的打算给女儿起什么名字？ → 高静。"},
    {num:16, options:["一直工作","坐错车了","坐过站了"], ans:2, q:"男的为什么回来晚了？",
     lines:[
      {speaker:"女", pre:"", blank:"你今天回来得有点儿晚啊", post:"。",
       py:"Nǐ jīntiān huílai de yǒudiǎnr wǎn a.",
       vn:"Hôm nay bạn về hơi muộn nhỉ."},
      {speaker:"男", pre:"今天不知道怎么了，特别累，", blank:"回家的时候累得我在公共汽车上就睡着了", post:"。",
       py:"Jīntiān bù zhīdào zěnme le, tèbié lèi, huí jiā de shíhou lèi de wǒ zài gōnggòng qìchē shang jiù shuì zháo le.",
       vn:"Hôm nay không biết sao nữa, mệt quá, lúc về nhà mệt đến mức tôi ngủ luôn trên xe buýt."},
      {speaker:"女", pre:"", blank:"我有时候也在车上睡一会儿", post:"。",
       py:"Wǒ yǒushíhou yě zài chē shang shuì yíhuìr.",
       vn:"Tôi thỉnh thoảng cũng ngủ một lát trên xe."},
      {speaker:"男", pre:"但是我坐过站了，", blank:"只好下了车再往回坐", post:"。",
       py:"Dànshì wǒ zuò guò zhàn le, zhǐhǎo xiàle chē zài wǎng huí zuò.",
       vn:"Nhưng tôi ngồi quá trạm rồi, đành phải xuống xe rồi ngồi ngược lại."}
     ],
     explain:"女：你今天回来得有点儿晚啊。男：今天不知道怎么了，特别累，回家的时候累得我在公共汽车上就睡着了。女：我有时候也在车上睡一会儿。男：但是我坐过站了，只好下了车再往回坐。问：男的为什么回来晚了？ → 坐过站了。"},
    {num:17, options:["不认识男的","变瘦了","没想到男的这么瘦"], ans:2, q:"关于女的，可以知道什么？",
     lines:[
      {speaker:"男", pre:"周新，好久不见！", blank:"你还是那么年轻、漂亮", post:"。",
       py:"Zhōu Xīn, hǎojiǔ bú jiàn! Nǐ háishi nàme niánqīng, piàoliang.",
       vn:"Chu Tân, lâu rồi không gặp! Bạn vẫn trẻ và xinh đẹp như vậy."},
      {speaker:"女", pre:"对不起，", blank:"请问您是——", post:"？",
       py:"Duìbuqǐ, qǐngwèn nín shì——?",
       vn:"Xin lỗi, xin hỏi anh là——?"},
      {speaker:"男", pre:"我是常亮啊，", blank:"你不认识我了", post:"？",
       py:"Wǒ shì Cháng Liàng a, nǐ bú rènshi wǒ le?",
       vn:"Tôi là Thường Lượng đây, bạn không nhận ra tôi nữa à?"},
      {speaker:"女", pre:"常亮？你现在怎么变得这么瘦？", blank:"瘦得我都不认识你了", post:"。",
       py:"Cháng Liàng? Nǐ xiànzài zěnme biàn de zhème shòu? Shòu de wǒ dōu bú rènshi nǐ le.",
       vn:"Thường Lượng? Sao bạn bây giờ gầy thế? Gầy đến mức tôi không nhận ra bạn nữa."}
     ],
     explain:"男：周新，好久不见！你还是那么年轻、漂亮。女：对不起，请问您是——？男：我是常亮啊，你不认识我了？女：常亮？你现在怎么变得这么瘦？瘦得我都不认识你了。问：关于女的，可以知道什么？ → 没想到男的这么瘦。"},
    {num:18, options:["不太胖","大眼睛","小鼻子"], ans:1, q:"关于小白的孩子，可以知道什么？",
     lines:[
      {speaker:"男", pre:"", blank:"听说上个月小白生了个儿子", post:"？",
       py:"Tīngshuō shàng ge yuè Xiǎobái shēngle ge érzi?",
       vn:"Nghe nói tháng trước Tiểu Bạch sinh con trai à?"},
      {speaker:"女", pre:"是啊，", blank:"那孩子特别可爱，出生时特别胖，四公斤呢，他们高兴得一晚上没睡", post:"。",
       py:"Shì a, nà háizi tèbié kě'ài, chūshēng shí tèbié pàng, sì gōngjīn ne, tāmen gāoxìng de yì wǎnshang méi shuì.",
       vn:"Đúng vậy, đứa bé đó đặc biệt đáng yêu, lúc sinh ra rất mũm mĩm, tận bốn cân đấy, họ vui đến mức cả đêm không ngủ."},
      {speaker:"男", pre:"孩子长得像谁？", blank:"像小白还是像她丈夫", post:"？",
       py:"Háizi zhǎng de xiàng shéi? Xiàng Xiǎobái háishi xiàng tā zhàngfu?",
       vn:"Đứa bé giống ai vậy? Giống Tiểu Bạch hay giống chồng cô ấy?"},
      {speaker:"女", pre:"鼻子像爸爸，高高的，眼睛像妈妈，大大的，", blank:"头发也像妈妈，黑黑的", post:"。",
       py:"Bízi xiàng bàba, gāogāo de, yǎnjing xiàng māma, dàdà de, tóufa yě xiàng māma, hēihēi de.",
       vn:"Mũi giống bố, cao cao, mắt giống mẹ, to to, tóc cũng giống mẹ, đen đen."}
     ],
    ...
    {num:19, options:["热牛奶","冰可乐","热水"], ans:1, q:"女的喝什么比较好？",
     lines:[
      {speaker:"女", pre:"我睡不着，", blank:"怎么办呢", post:"？",
       py:"Wǒ shuì bu zháo, zěnme bàn ne?",
       vn:"Tôi không ngủ được, làm sao đây?"},
      {speaker:"男", pre:"喝杯热牛奶，能帮助你快点儿睡，", blank:"也能睡得好", post:"。",
       py:"Hē bēi rè niúnǎi, néng bāngzhù nǐ kuài diǎnr shuì, yě néng shuì de hǎo.",
       vn:"Uống ly sữa nóng đi, có thể giúp bạn ngủ nhanh hơn, cũng ngủ ngon hơn."},
      {speaker:"女", pre:"热牛奶？", blank:"我是热得睡不着，喝热的更睡不着了", post:"。",
       py:"Rè niúnǎi? Wǒ shì rè de shuì bu zháo, hē rè de gèng shuì bu zháo le.",
       vn:"Sữa nóng á? Tôi là nóng nên không ngủ được, uống đồ nóng càng không ngủ được nữa."},
      {speaker:"男", pre:"如果觉得太热，就喝杯冰可乐吧，", blank:"甜甜的，很舒服", post:"。",
       py:"Rúguǒ juéde tài rè, jiù hē bēi bīng kělè ba, tiántián de, hěn shūfu.",
       vn:"Nếu thấy nóng quá thì uống ly cô-ca đá đi, ngọt ngọt, rất dễ chịu."}
     ],
     explain:"女：我睡不着，怎么办呢？男：喝杯热牛奶，能帮助你快点儿睡，也能睡得好。女：热牛奶？我是热得睡不着，喝热的更睡不着了。男：如果觉得太热，就喝杯冰可乐吧，甜甜的，很舒服。问：女的喝什么比较好？ → 冰可乐。"},
    {num:20, options:["有地铁","人很好","不太安静"], ans:1, q:"关于这个城市，可以知道什么？",
     lines:[
      {speaker:"男", pre:"这个城市真不错，干净、", blank:"安静、漂亮", post:"。",
       py:"Zhège chéngshì zhēn búcuò, gānjìng, ānjìng, piàoliang.",
       vn:"Thành phố này thật không tệ, sạch sẽ, yên tĩnh, đẹp đẽ."},
      {speaker:"女", pre:"超市、洗衣店、饭馆、咖啡店，", blank:"都有，很方便", post:"。",
       py:"Chāoshì, xǐyīdiàn, fànguǎn, kāfēidiàn, dōu yǒu, hěn fāngbiàn.",
       vn:"Siêu thị, tiệm giặt, nhà hàng, quán cà phê, đều có, rất tiện."},
      {speaker:"男", pre:"人和人的关系也不错，遇到问题时，", blank:"别人都愿意帮助你", post:"。",
      ...
      {speaker:"女", pre:"如果这个地方有地铁，", blank:"那就更好了", post:"。",
       py:"Rúguǒ zhège dìfang yǒu dìtiě, nà jiù gèng hǎo le.",
       vn:"Nếu nơi này có tàu điện ngầm nữa thì càng tốt."}
     ],
