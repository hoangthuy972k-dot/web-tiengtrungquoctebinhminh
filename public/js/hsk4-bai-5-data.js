...
var listenData = {
  type:'workbook',
  audio:'/audio/hsk4-bai-5/listen-full.mp3',
  dictation:[
  ...
  mc:[
    ...
    {num:3,options:['两千多','三千多','一千多'],ans:0,
    ...
    {num:4,options:['现金不够','没带钱包','信用卡坏了'],ans:0,
    ...
    {num:7,options:['质量要好，不能太贵','要流行','要便宜'],ans:0,
    ...
    {num:8,options:['是一种浪费','很划算','没关系'],ans:0,
    ...
    {num:9,options:['东西多，比商店便宜','速度快','服务好'],ans:0,
    ...
    {num:10,options:['寄到办公室或者家里','必须自己去取','只能去邮局取'],ans:0,
    ...
    {num:11,options:['王静','李进','李老师'],ans:2,
    ...
    {num:12,options:['不能完全相信广告','可以完全相信广告','广告都是假的'],ans:0,
