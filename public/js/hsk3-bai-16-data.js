...
var listenData = {
  ...
  mc: [
    {num:11, options:['眼睛红','打算去医院','买了一个红眼镜'], ans:0,
     lines:[
       {speaker:'男', pre:'最近你的眼睛一直红红的，', blank:'我带你去医院检查一下吧', post:'。', py:'Zuìjìn nǐ de yǎnjing yìzhí hónghóng de, wǒ dài nǐ qù yīyuàn jiǎnchá yíxià ba.', vn:'Gần đây mắt bạn cứ đỏ đỏ, tôi đưa bạn đi bệnh viện khám thử đi.'},
       {speaker:'女', pre:'我去过了，医生说没什么事，不用吃药，', blank:'让我多休息', post:'。', py:'Wǒ qùguo le, yīshēng shuō méi shénme shì, búyòng chī yào, ràng wǒ duō xiūxi.', vn:'Tôi đi rồi, bác sĩ nói không sao, không cần uống thuốc, bảo tôi nghỉ ngơi nhiều.'},
     ],
    ...
    {num:12, options:['明天天气好','太阳能从西边出来','认为男的不可能去跑步'], ans:2,
     lines:[
       {speaker:'男', pre:'我打算从明天开始，', blank:'每天去运动场跑两千米', post:'。', py:'Wǒ dǎsuàn cóng míngtiān kāishǐ, měi tiān qù yùndòngchǎng pǎo liǎng qiān mǐ.', vn:'Tôi định từ mai bắt đầu, mỗi ngày ra sân vận động chạy hai nghìn mét.'},
       {speaker:'女', pre:'真的吗？如果你能这么做，', blank:'太阳就能从西边出来', post:'。', py:'Zhēn de ma? Rúguǒ nǐ néng zhème zuò, tàiyáng jiù néng cóng xībian chūlai.', vn:'Thật à? Nếu bạn làm được vậy thì mặt trời sẽ mọc từ hướng tây mất.'},
     ],
    ...
    {num:13, options:['女儿','妈妈','奶奶'], ans:2,
     lines:[
       ...
       {speaker:'男', pre:'是妈妈，她说如果我这次考试还拿第一，', blank:'就再给我买一双', post:'。', py:'Shì māma, tā shuō rúguǒ wǒ zhè cì kǎoshì hái ná dì yī, jiù zài gěi wǒ mǎi yì shuāng.', vn:'Là mẹ mua đấy, mẹ nói nếu lần thi này con vẫn giành giải nhất thì mẹ sẽ mua thêm cho con một đôi nữa.'},
     ],
    ...
    {num:14, options:['中午吃过药了','现在要去医院','现在能吃甜的'], ans:0,
     lines:[
       {speaker:'男', pre:'我觉得中午吃的药没什么用，牙还是很疼，', blank:'不能吃甜的', post:'。', py:'Wǒ juéde zhōngwǔ chī de yào méi shénme yòng, yá háishi hěn téng, bù néng chī tián de.', vn:'Tôi thấy thuốc uống buổi trưa chẳng có tác dụng gì, răng vẫn đau lắm, không ăn được đồ ngọt.'},
       {speaker:'女', pre:'等一晚上，如果明天还不好，就带你去医院检查一下，', blank:'看看医生怎么说', post:'。', py:'Děng yì wǎnshang, rúguǒ míngtiān hái bù hǎo, jiù dài nǐ qù yīyuàn jiǎnchá yíxià, kànkan yīshēng zěnme shuō.', vn:'Đợi qua đêm nay, nếu mai vẫn không đỡ thì đưa bạn đi bệnh viện khám, xem bác sĩ nói sao.'},
     ],
     explain:'男：我觉得中午吃的药没什么用，牙还是很疼，不能吃甜的。女：等一晚上，如果明天还不好，就带你去医院检查一下，看看医生怎么说。问：关于男的，可以知道什么？ → 中午吃过药了。'},
    {num:15, options:['老高','高山','高静'], ans:2,
     lines:[
       {speaker:'女', pre:'老高，', blank:'你说我们给孩子起什么名字好', post:'？', py:'Lǎo Gāo, nǐ shuō wǒmen gěi háizi qǐ shénme míngzi hǎo?', vn:'Lão Cao ơi, anh nói xem đặt tên gì cho con mình đây?'},
       {speaker:'男', pre:'如果是男孩儿，就叫高山，如果是女孩儿，', blank:'就叫高静，怎么样', post:'？', py:'Rúguǒ shì nánháir, jiù jiào Gāo Shān, rúguǒ shì nǚháir, jiù jiào Gāo Jìng, zěnme yàng?', vn:'Nếu là con trai thì đặt là Cao Sơn, nếu là con gái thì đặt là Cao Tĩnh, thế nào?'},
     ],
    ...
    {num:16, options:['一直工作','坐错车了','坐过站了'], ans:2,
     lines:[
       ...
       {speaker:'男', pre:'今天不知道怎么了，特别累，', blank:'回家的时候累得我在公共汽车上就睡着了', post:'。', py:'Jīntiān bù zhīdào zěnme le, tèbié lèi, huí jiā de shíhou lèi de wǒ zài gōnggòng qìchē shang jiù shuì zháo le.', vn:'Hôm nay không biết sao nữa, mệt quá, lúc về nhà mệt đến mức tôi ngủ luôn trên xe buýt.'},
       ...
       {speaker:'男', pre:'但是我坐过站了，', blank:'只好下了车再往回坐', post:'。', py:'Dànshì wǒ zuò guò zhàn le, zhǐhǎo xiàle chē zài wǎng huí zuò.', vn:'Nhưng tôi ngồi quá trạm rồi, đành phải xuống xe rồi ngồi ngược lại.'},
     ],
    ...
    {num:17, options:['不认识男的','变瘦了','没想到男的这么瘦'], ans:2,
     lines:[
       {speaker:'男', pre:'周新，好久不见！', blank:'你还是那么年轻、漂亮', post:'。', py:'Zhōu Xīn, hǎojiǔ bú jiàn! Nǐ háishi nàme niánqīng, piàoliang.', vn:'Chu Tân, lâu rồi không gặp! Bạn vẫn trẻ và xinh đẹp như vậy.'},
       {speaker:'女', pre:'对不起，', blank:'请问您是——', post:'？', py:'Duìbuqǐ, qǐngwèn nín shì——?', vn:'Xin lỗi, xin hỏi anh là——?'},
       {speaker:'男', pre:'我是常亮啊，', blank:'你不认识我了', post:'？', py:'Wǒ shì Cháng Liàng a, nǐ bú rènshi wǒ le?', vn:'Tôi là Thường Lượng đây, bạn không nhận ra tôi nữa à?'},
       {speaker:'女', pre:'常亮？你现在怎么变得这么瘦？', blank:'瘦得我都不认识你了', post:'。', py:'Cháng Liàng? Nǐ xiànzài zěnme biàn de zhème shòu? Shòu de wǒ dōu bú rènshi nǐ le.', vn:'Thường Lượng? Sao bạn bây giờ gầy thế? Gầy đến mức tôi không nhận ra bạn nữa.'},
     ],
    ...
    {num:18, options:['不太胖','大眼睛','小鼻子'], ans:1,
     lines:[
       ...
       {speaker:'女', pre:'鼻子像爸爸，高高的，眼睛像妈妈，大大的，', blank:'头发也像妈妈，黑黑的', post:'。', py:'Bízi xiàng bàba, gāogāo de, yǎnjing xiàng māma, dàdà de, tóufa yě xiàng māma, hēihēi de.', vn:'Mũi giống bố, cao cao, mắt giống mẹ, to to, tóc cũng giống mẹ, đen đen.'},
     ],
    ...
    {num:19, options:['热牛奶','冰可乐','热水'], ans:1,
     lines:[
       {speaker:'女', pre:'我睡不着，', blank:'怎么办呢', post:'？', py:'Wǒ shuì bu zháo, zěnme bàn ne?', vn:'Tôi không ngủ được, làm sao đây?'},
       {speaker:'男', pre:'喝杯热牛奶，能帮助你快点儿睡，', blank:'也能睡得好', post:'。', py:'Hē bēi rè niúnǎi, néng bāngzhù nǐ kuài diǎnr shuì, yě néng shuì de hǎo.', vn:'Uống ly sữa nóng đi, có thể giúp bạn ngủ nhanh hơn, cũng ngủ ngon hơn.'},
       ...
       {speaker:'男', pre:'如果觉得太热，就喝杯冰可乐吧，', blank:'甜甜的，很舒服', post:'。', py:'Rúguǒ juéde tài rè, jiù hē bēi bīng kělè ba, tiántián de, hěn shūfu.', vn:'Nếu thấy nóng quá thì uống ly cô-ca đá đi, ngọt ngọt, rất dễ chịu.'},
     ],
    ...
    {num:20, options:['有地铁','人很好','不太安静'], ans:1,
     lines:[
       {speaker:'男', pre:'这个城市真不错，干净、', blank:'安静、漂亮', post:'。', py:'Zhège chéngshì zhēn búcuò, gānjìng, ānjìng, piàoliang.', vn:'Thành phố này thật không tệ, sạch sẽ, yên tĩnh, đẹp đẽ.'},
       {speaker:'女', pre:'超市、洗衣店、饭馆、咖啡店，', blank:'都有，很方便', post:'。', py:'Chāoshì, xǐyīdiàn, fànguǎn, kāfēidiàn, dōu yǒu, hěn fāngbiàn.', vn:'Siêu thị, tiệm giặt, nhà hàng, quán cà phê, đều có, rất tiện.'},
       {speaker:'男', pre:'人和人的关系也不错，遇到问题时，', blank:'别人都愿意帮助你', post:'。', py:'Rén hé rén de guānxi yě búcuò, yùdào wèntí shí, biéren dōu yuànyì bāngzhù nǐ.', vn:'Quan hệ giữa người với người cũng không tệ, khi gặp vấn đề, người khác đều sẵn lòng giúp bạn.'},
       {speaker:'女', pre:'如果这个地方有地铁，', blank:'那就更好了', post:'。', py:'Rúguǒ zhège dìfang yǒu dìtiě, nà jiù gèng hǎo le.', vn:'Nếu nơi này có tàu điện ngầm nữa thì càng tốt.'},
     ],
