  ...
  mc: [
    {num:11, options:['地铁站','眼镜店','地图'], ans:1,
     lines:[
       ...
       {speaker:'女', pre:'地铁站旁边有一个，', blank:'在地铁站的北边', post:'。', py:'Dìtiě zhàn pángbiān yǒu yí ge, zài dìtiě zhàn de běibian.', vn:'Bên cạnh ga tàu điện ngầm có một cái, ở phía bắc ga tàu điện ngầm.'},
     ],
    ...
    {num:12, options:['给妹妹喝牛奶','去超市买牛奶','带妹妹去医院'], ans:0,
     lines:[
       ...
       {speaker:'女', pre:'可能饿了，', blank:'你把奶瓶给我吧', post:'。', py:'Kěnéng è le, nǐ bǎ nǎipíng gěi wǒ ba.', vn:'Có lẽ đói rồi, bạn đưa bình sữa cho mình đi.'},
     ],
     explain:'男：妹妹怎么了？病了吗？女：可能饿了，你把奶瓶给我吧。问：女的要做什么？ → 给妹妹喝牛奶。'},
    {num:13, options:['同事','经理和客人','医生和病人'], ans:0,
     lines:[
       {speaker:'男', pre:'会议结束后，', blank:'你记得把空调和灯都关了', post:'。', py:'Huìyì jiéshù hòu, nǐ jìde bǎ kōngtiáo hé dēng dōu guān le.', vn:'Sau khi họp xong, bạn nhớ tắt cả máy điều hòa và đèn nhé.'},
       {speaker:'女', pre:'好的，', blank:'我知道了，明天见', post:'。', py:'Hǎo de, wǒ zhīdào le, míngtiān jiàn.', vn:'Được ạ, tôi biết rồi, hẹn mai gặp.'},
     ],
     explain:'男：会议结束后，你记得把空调和灯都关了。女：好的，我知道了，明天见。问：他们最可能是什么关系？ → 同事。'},
    {num:14, options:['出去开会','照顾小雨','和女的去公园'], ans:1,
     lines:[
       {speaker:'女', pre:'我明天出去开会，', blank:'你能帮我照顾一下小雨吗', post:'？', py:'Wǒ míngtiān chūqu kāihuì, nǐ néng bāng wǒ zhàogù yíxià Xiǎoyǔ ma?', vn:'Ngày mai tôi ra ngoài họp, bạn có thể giúp tôi trông Tiểu Vũ một chút không?'},
    ...
    {num:15, options:['让女的去还书','书已经还了','女的忘了还书'], ans:1,
     lines:[
       {speaker:'女', pre:'我的那本历史书呢，', blank:'你看见了吗', post:'？', py:'Wǒ de nà běn lìshǐ shū ne, nǐ kànjiàn le ma?', vn:'Quyển sách Lịch Sử của tôi đâu rồi, bạn thấy không?'},
    ...
    {num:16, options:['今天比较忙','空调有问题','叫人来换水'], ans:1,
     lines:[
       ...
       {speaker:'男', pre:'我也是刚看见，', blank:'我已经打电话叫人来看了', post:'。', py:'Wǒ yě shì gāng kànjiàn, wǒ yǐjīng dǎ diànhuà jiào rén lái kàn le.', vn:'Tôi cũng vừa mới thấy, tôi gọi điện kêu người đến xem rồi.'},
    ...
    {num:17, options:['已经洗澡了','不喜欢出去跑步','想去超市买东西'], ans:0,
     lines:[
       {speaker:'男', pre:'我要去跑步，', blank:'你去不去', post:'？', py:'Wǒ yào qù pǎobù, nǐ qù bu qù?', vn:'Tôi định đi chạy bộ, bạn đi không?'},
       {speaker:'女', pre:'我已经洗完澡了，', blank:'不想出去了', post:'。', py:'Wǒ yǐjīng xǐwán zǎo le, bù xiǎng chūqu le.', vn:'Tôi tắm xong rồi, không muốn ra ngoài nữa.'},
    ...
    {num:18, options:['比以前便宜了','太旧了','又大又方便'], ans:0,
     lines:[
       {speaker:'女', pre:'我的笔记本电脑太旧了，我想换一个，', blank:'你说买个什么样的好', post:'？', py:'Wǒ de bǐjìběn diànnǎo tài jiù le, wǒ xiǎng huàn yí ge, nǐ shuō mǎi ge shénme yàng de hǎo?', vn:'Máy tính xách tay của tôi cũ quá rồi, tôi muốn đổi một cái, bạn thấy mua loại nào tốt?'},
       {speaker:'男', pre:'我用的这个就不错，也不大，', blank:'带着很方便', post:'。', py:'Wǒ yòng de zhège jiù búcuò, yě bú dà, dàizhe hěn fāngbiàn.', vn:'Cái tôi đang dùng cũng được đấy, cũng không to, mang theo rất tiện.'},
    ...
    {num:19, options:['来周先生家吃晚饭','每天八点左右下班','总是照顾周先生的小狗'], ans:2,
     lines:[
       {speaker:'女', pre:'周先生，我公司突然有事，', blank:'您能帮我去接一下孩子吗', post:'？', py:'Zhōu xiānsheng, wǒ gōngsī tūrán yǒu shì, nín néng bāng wǒ qù jiē yíxià háizi ma?', vn:'Anh Chu, công ty tôi đột nhiên có việc, anh giúp tôi đón cháu một chút được không?'},
       {speaker:'男', pre:'没问题，', blank:'我带她来我家吃晚饭', post:'。', py:'Méi wèntí, wǒ dài tā lái wǒ jiā chī wǎnfàn.', vn:'Không vấn đề gì, tôi đưa cháu về nhà tôi ăn tối.'},
