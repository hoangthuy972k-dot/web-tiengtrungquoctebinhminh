  ...
  mc: [
    {num:11, options:['今天过生日','买了本字典','正在学汉语'], ans:2,
     lines:[
       ...
       {speaker:'女', pre:'', blank:'你怎么知道我在学汉语？我还一直觉得你不关心我的学习呢', post:'。', py:'Nǐ zěnme zhīdào wǒ zài xué Hànyǔ? Wǒ hái yìzhí juéde nǐ bù guānxīn wǒ de xuéxí ne.', vn:'Sao anh biết em đang học tiếng Trung? Em cứ nghĩ là anh không quan tâm việc học của em đấy.'},
     ],
     explain:'男：妹妹，明天是你的生日，我给你买了本汉语字典。女：你怎么知道我在学汉语？我还一直觉得你不关心我的学习呢。问：关于女的，可以知道什么？ → 正在学汉语。'},
    {num:12, options:['往东走','往南走','往车站那边走'], ans:0,
     lines:[
       {speaker:'男', pre:'', blank:'放心，你就听我的吧，只有往东走才能到国家公园', post:'。', py:'Fàngxīn, nǐ jiù tīng wǒ de ba, zhǐyǒu wǎng dōng zǒu cái néng dào guójiā gōngyuán.', vn:'Yên tâm, nghe tôi đi, chỉ có đi về hướng đông mới đến được công viên quốc gia.'},
       {speaker:'女', pre:'', blank:'但是从地图上看，走南边那条路才对。我们还是去车站问问那些等车的人吧', post:'。', py:'Dànshì cóng dìtú shang kàn, zǒu nánbian nà tiáo lù cái duì. Wǒmen háishi qù chēzhàn wènwen nàxiē děng chē de rén ba.', vn:'Nhưng nhìn trên bản đồ, đi con đường phía nam mới đúng. Chúng ta ra trạm xe hỏi những người đang chờ xe thì hơn.'},
     ],
     explain:'男：放心，你就听我的吧，只有往东走才能到国家公园。女：但是从地图上看，走南边那条路才对。我们还是去车站问问那些等车的人吧。问：男的觉得到国家公园怎么走？ → 往东走。'},
    {num:13, options:['帽子','书','地图'], ans:2,
     lines:[
       {speaker:'男', pre:'', blank:'快点儿，拿上帽子走吧，明天你再找书', post:'。', py:'Kuài diǎnr, náshang màozi zǒu ba, míngtiān nǐ zài zhǎo shū.', vn:'Nhanh lên, cầm mũ đi thôi, mai tìm sách sau.'},
       {speaker:'女', pre:'', blank:'我没找书，出去玩儿还是得带上地图啊，被你放哪儿了', post:'？', py:'Wǒ méi zhǎo shū, chūqu wánr háishi děi dàishang dìtú a, bèi nǐ fàng nǎr le?', vn:'Tôi không tìm sách, đi chơi vẫn phải mang theo bản đồ chứ, bị anh để đâu rồi?'},
     ],
     explain:'男：快点儿，拿上帽子走吧，明天你再找书。女：我没找书，出去玩儿还是得带上地图啊，被你放哪儿了？问：女的在找什么？ → 地图。'},
    {num:14, options:['在找运动服','准备去跑步','穿好了运动服'], ans:0,
     lines:[
       {speaker:'女', pre:'', blank:'看见我的运动服了吗？怎么找不到了', post:'？', py:'Kànjiàn wǒ de yùndòngfú le ma? Zěnme zhǎo bu dào le?', vn:'Có thấy đồ thể thao của tôi không? Sao tìm không thấy nữa?'},
       {speaker:'男', pre:'', blank:'是不是被笑笑穿走了？她刚才说要出去跑步', post:'。', py:'Shì bu shì bèi Xiàoxiao chuān zǒu le? Tā gāngcái shuō yào chūqu pǎobù.', vn:'Có phải bị Tiếu Tiếu mặc đi rồi không? Vừa nãy nó nói định ra ngoài chạy bộ.'},
     ],
     explain:'女：看见我的运动服了吗？怎么找不到了？男：是不是被笑笑穿走了？她刚才说要出去跑步。问：关于女的，可以知道什么？ → 在找运动服。'},
    {num:15, options:['去找服务员','去拿房卡','回房间去'], ans:2,
     lines:[
       {speaker:'男', pre:'', blank:'我的房卡找不到了，我怎么进去啊', post:'？', py:'Wǒ de fángkǎ zhǎo bu dào le, wǒ zěnme jìnqu a?', vn:'Thẻ phòng của tôi tìm không thấy, tôi vào bằng cách nào đây?'},
       {speaker:'女', pre:'', blank:'你给服务员打个电话，他们会帮你想办法解决的', post:'。', py:'Nǐ gěi fúwùyuán dǎ ge diànhuà, tāmen huì bāng nǐ xiǎng bànfǎ jiějué de.', vn:'Bạn gọi điện cho nhân viên đi, họ sẽ giúp bạn nghĩ cách giải quyết.'},
     ],
     explain:'男：我的房卡找不到了，我怎么进去啊？女：你给服务员打个电话，他们会帮你想办法解决的。问：男的要做什么？ → 回房间去。'},
    {num:16, options:['去银行还钱','去教室上课','去借照相机'], ans:1,
     lines:[
       {speaker:'女', pre:'', blank:'你这么着急，是要去哪儿啊', post:'？', py:'Nǐ zhème zháojí, shì yào qù nǎr a?', vn:'Bạn gấp gáp thế, định đi đâu vậy?'},
       {speaker:'男', pre:'', blank:'我去银行，我的信用卡该还钱了。你去哪儿', post:'？', py:'Wǒ qù yínháng, wǒ de xìnyòngkǎ gāi huán qián le. Nǐ qù nǎr?', vn:'Tôi đi ngân hàng, thẻ tín dụng của tôi phải trả tiền rồi. Bạn đi đâu?'},
       {speaker:'女', pre:'', blank:'我去教室上课', post:'。', py:'Wǒ qù jiàoshì shàngkè.', vn:'Tôi đi lớp học.'},
       {speaker:'男', pre:'', blank:'这个照相机是小晴的，请你帮我还给她吧', post:'。', py:'Zhège zhàoxiàngjī shì Xiǎoqíng de, qǐng nǐ bāng wǒ huán gěi tā ba.', vn:'Cái máy ảnh này là của Tiểu Tình, nhờ bạn trả lại giúp tôi.'},
     ],
    ...
    {num:17, options:['找不到照相机','忘了去教室','男的不帮她找'], ans:0,
     lines:[
       {speaker:'男', pre:'', blank:'小云，这个照相机是你要找的吗', post:'？', py:'Xiǎoyún, zhège zhàoxiàngjī shì nǐ yào zhǎo de ma?', vn:'Tiểu Vân, cái máy ảnh này có phải bạn đang tìm không?'},
       ...
       {speaker:'男', pre:'', blank:'我是在教室找到的，一定是被你忘在教室里了', post:'。', py:'Wǒ shì zài jiàoshì zhǎodào de, yídìng shì bèi nǐ wàng zài jiàoshì li le.', vn:'Tôi tìm thấy ở lớp học, chắc chắn là bị bạn để quên trong lớp rồi.'},
       {speaker:'女', pre:'', blank:'真奇怪，教室我也找过了，怎么没发现呢', post:'？', py:'Zhēn qíguài, jiàoshì wǒ yě zhǎoguo le, zěnme méi fāxiàn ne?', vn:'Lạ thật, lớp học tôi cũng tìm rồi, sao lại không phát hiện ra nhỉ?'},
     ],
    ...
    {num:18, options:['客人已经离开了','客人对房间很满意','客人可以换个房间'], ans:2,
     lines:[
       {speaker:'女', pre:'', blank:'我觉得这样做，客人是不会满意的', post:'。', py:'Wǒ juéde zhèyàng zuò, kèrén shì bú huì mǎnyì de.', vn:'Tôi thấy làm vậy, khách sẽ không hài lòng đâu.'},
       ...
       {speaker:'女', pre:'', blank:'我觉得可以给客人换一个房间，他离开时，我们还可以找车送他去机场', post:'。', py:'Wǒ juéde kěyǐ gěi kèrén huàn yí ge fángjiān, tā líkāi shí, wǒmen hái kěyǐ zhǎo chē sòng tā qù jīchǎng.', vn:'Tôi thấy có thể đổi cho khách một phòng khác, lúc khách rời đi, chúng ta còn có thể tìm xe đưa khách ra sân bay.'},
    ...
    {num:19, options:['不能再跳舞了','脚就快好了','坐电梯不小心'], ans:1,
     lines:[
       {speaker:'男', pre:'', blank:'电梯来了，您小心点儿。您的脚怎么样了', post:'？', py:'Diàntī lái le, nín xiǎoxīn diǎnr. Nín de jiǎo zěnme yàng le?', vn:'Thang máy đến rồi, chị cẩn thận chút. Chân chị thế nào rồi?'},
       ...
       {speaker:'男', pre:'', blank:'那太好了，只有您来了，我们才能跳得更快乐', post:'。', py:'Nà tài hǎo le, zhǐyǒu nín lái le, wǒmen cái néng tiào de gèng kuàilè.', vn:'Vậy tốt quá, chỉ có chị đến, chúng tôi mới nhảy vui hơn được.'},
       {speaker:'女', pre:'', blank:'跟你们一起玩儿我也更快乐，我多么希望早点儿好啊', post:'。', py:'Gēn nǐmen yìqǐ wánr wǒ yě gèng kuàilè, wǒ duōme xīwàng zǎo diǎnr hǎo a.', vn:'Chơi cùng mọi người tôi cũng vui hơn, tôi mong sao mau khỏi biết bao.'},
     ],
    ...
    {num:20, options:['饭馆','商店','动物园'], ans:1,
     lines:[
       {speaker:'男', pre:'', blank:'小姐，这双黑色的皮鞋多少钱？有43号的吗', post:'？', py:'Xiǎojiě, zhè shuāng hēisè de píxié duōshao qián? Yǒu sìshísān hào de ma?', vn:'Cô ơi, đôi giày da đen này bao nhiêu tiền? Có cỡ 43 không?'},
       {speaker:'女', pre:'', blank:'六百八，帮您找双43号的试试', post:'？', py:'Liùbǎi bā, bāng nín zhǎo shuāng sìshísān hào de shìshi?', vn:'Sáu trăm tám, tôi tìm giúp anh đôi cỡ 43 thử nhé?'},
       {speaker:'男', pre:'', blank:'这么贵，是真牛皮的吗', post:'？', py:'Zhème guì, shì zhēn niúpí de ma?', vn:'Đắt thế, có phải da bò thật không?'},
       {speaker:'女', pre:'', blank:'当然了，只有真的好牛皮做出来的鞋，穿着才舒服', post:'。', py:'Dāngrán le, zhǐyǒu zhēn de hǎo niúpí zuò chulai de xié, chuānzhe cái shūfu.', vn:'Đương nhiên rồi, chỉ có giày làm từ da bò tốt thật, mang mới thoải mái.'},
     ],
