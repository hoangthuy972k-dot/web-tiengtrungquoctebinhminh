...
var listenData = {
  ...
  mc: [
    {num:11, options:['司机','老师','医生'], ans:1,
     lines:[
       {speaker:'男', pre:'', blank:'你明天上午要去哪儿，陪我去医院吧', post:'？', py:'Nǐ míngtiān shàngwǔ yào qù nǎr, péi wǒ qù yīyuàn ba?', vn:'Sáng mai bạn định đi đâu, đi cùng tôi đến bệnh viện đi?'},
       {speaker:'女', pre:'', blank:'我要带学生去动物园看大熊猫，后天行吗', post:'？', py:'Wǒ yào dài xuésheng qù dòngwùyuán kàn dàxióngmāo, hòutiān xíng ma?', vn:'Tôi phải dẫn học sinh đến sở thú xem gấu trúc, ngày kia được không?'},
     ],
    ...
    {num:13, options:['帮她找手机','找她有事情','跟女的见面'], ans:0,
     lines:[
       {speaker:'女', pre:'', blank:'奇怪，我记得把手机放进包里了，怎么找不到了', post:'？', py:'Qíguài, wǒ jìde bǎ shǒujī fàng jìn bāo li le, zěnme zhǎo bu dào le?', vn:'Lạ thật, tôi nhớ để điện thoại vào túi rồi mà, sao tìm không thấy?'},
    ...
    {num:15, options:['身体不好','吃得很饱','吃得很少'], ans:1,
     lines:[
       {speaker:'女', pre:'', blank:'吃饭不能吃太饱，那对你的身体不好', post:'。', py:'Chīfàn bù néng chī tài bǎo, nà duì nǐ de shēntǐ bù hǎo.', vn:'Ăn cơm không được ăn quá no, cái đó không tốt cho sức khỏe bạn đâu.'},
       {speaker:'男', pre:'', blank:'关于这一点，我同意，可是吃太少，我晚上睡不着觉', post:'。', py:'Guānyú zhè yì diǎn, wǒ tóngyì, kěshì chī tài shǎo, wǒ wǎnshang shuì bu zháo jiào.', vn:'Về điểm này, tôi đồng ý, nhưng ăn ít quá thì tối tôi không ngủ được.'},
     ],
    ...
    {num:16, options:['喜欢照相','长得很矮','长得很高'], ans:1,
     lines:[
       ...
       {speaker:'男', pre:'', blank:'一米九一，我都不相信自己能长这么高', post:'。', py:'Yì mǐ jiǔ yī, wǒ dōu bù xiāngxìn zìjǐ néng zhǎng zhème gāo.', vn:'Một mét chín mươi mốt, tôi còn không tin mình có thể cao đến thế.'},
     ],
    ...
    {num:17, options:['她是外地人','买票的人多','开门比较晚'], ans:1,
     lines:[
       ...
       {speaker:'男', pre:'', blank:'怎么那么多人啊？我们的票买到了吗', post:'？', py:'Zěnme nàme duō rén a? Wǒmen de piào mǎidào le ma?', vn:'Sao đông người thế? Vé của chúng ta mua được chưa?'},
       {speaker:'女', pre:'', blank:'买到了，今天不但来了很多北京人，而且还有很多外地人', post:'。', py:'Mǎidào le, jīntiān búdàn láile hěn duō Běijīngrén, érqiě hái yǒu hěn duō wàidìrén.', vn:'Mua được rồi, hôm nay không những đến rất nhiều người Bắc Kinh, mà còn có rất nhiều người ngoại tỉnh.'},
     ],
    ...
    {num:18, options:['去体育馆','洗澡','洗车'], ans:1,
     lines:[
       ...
       {speaker:'男', pre:'', blank:'只要你不累，我们就去', post:'。', py:'Zhǐyào nǐ bú lèi, wǒmen jiù qù.', vn:'Chỉ cần bạn không mệt, chúng ta sẽ đi.'},
       {speaker:'女', pre:'', blank:'那你等我一会儿，我先洗个澡', post:'。', py:'Nà nǐ děng wǒ yíhuìr, wǒ xiān xǐ ge zǎo.', vn:'Vậy bạn đợi tôi một chút, tôi tắm cái đã.'},
    ...
    {num:19, options:['羊肉','牛肉','鱼'], ans:0,
     lines:[
       {speaker:'男', pre:'', blank:'听说这家饭馆的羊肉非常有名，要不要来一盘', post:'？', py:'Tīngshuō zhè jiā fànguǎn de yángròu fēicháng yǒumíng, yào bu yào lái yì pán?', vn:'Nghe nói thịt cừu của nhà hàng này rất nổi tiếng, có muốn gọi một đĩa không?'},
       {speaker:'女', pre:'', blank:'我不吃牛羊肉，有没有别的菜', post:'？', py:'Wǒ bù chī niú yángròu, yǒu méiyǒu biéde cài?', vn:'Tôi không ăn thịt bò thịt cừu, có món khác không?'},
       {speaker:'男', pre:'', blank:'我看看菜单，你看这个鱼怎么样', post:'？', py:'Wǒ kànkan càidān, nǐ kàn zhège yú zěnme yàng?', vn:'Tôi xem thực đơn, bạn xem con cá này thế nào?'},
    ...
    {num:20, options:['去学习了','生病了','工作不认真'], ans:0,
     lines:[
       {speaker:'男', pre:'', blank:'奇怪，这段时间怎么没看见小周来上班？她病了吗', post:'？', py:'Qíguài, zhè duàn shíjiān zěnme méi kànjiàn Xiǎo Zhōu lái shàngbān? Tā bìng le ma?', vn:'Lạ thật, dạo này sao không thấy Tiểu Chu đi làm nhỉ? Cô ấy ốm à?'},
       {speaker:'女', pre:'', blank:'你不知道吗？公司已经送她去外地学习了', post:'。', py:'Nǐ bù zhīdào ma? Gōngsī yǐjīng sòng tā qù wàidì xuéxí le.', vn:'Bạn không biết à? Công ty đã cử cô ấy đi học ở nơi khác rồi.'},
       {speaker:'男', pre:'是吗？', blank:'她有这么好的机会啊', post:'。', py:'Shì ma? Tā yǒu zhème hǎo de jīhuì a.', vn:'Vậy à? Cô ấy có cơ hội tốt vậy đấy.'},
       {speaker:'女', pre:'', blank:'小周工作认真，经理当然让她去', post:'。', py:'Xiǎo Zhōu gōngzuò rènzhēn, jīnglǐ dāngrán ràng tā qù.', vn:'Tiểu Chu làm việc nghiêm túc, giám đốc đương nhiên cho cô ấy đi.'},
     ],
