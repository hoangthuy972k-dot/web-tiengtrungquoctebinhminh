  ...
  mc: [
    {num:11, options:['她去爬山了','她喝了很多水','她是走上楼来的'], ans:2,
     lines:[
       ...
       {speaker:'女', pre:'', blank:'电梯坏了，我是爬上来的。快给我喝口水', post:'。', py:'Diàntī huài le, wǒ shì pá shanglai de. Kuài gěi wǒ hē kǒu shuǐ.', vn:'Thang máy hỏng rồi, tôi trèo lên đấy. Mau cho tôi ngụm nước.'},
     ],
     explain:'男：你怎么这么累？女：电梯坏了，我是爬上来的。快给我喝口水。问：女的为什么很累？ → 她是走上楼来的。'},
    {num:12, options:['走回家去','聊天儿','去超市'], ans:0,
     lines:[
       {speaker:'男', pre:'', blank:'超市离家这么远，我们真的要走回去吗', post:'？', py:'Chāoshì lí jiā zhème yuǎn, wǒmen zhēn de yào zǒu huiqu ma?', vn:'Siêu thị cách nhà xa thế, chúng ta thật sự phải đi bộ về à?'},
    ...
    {num:13, options:['已经不年轻了','很想爸妈','要去国外'], ans:2,
     lines:[
       {speaker:'男', pre:'', blank:'你真的要出国？去那么远的地方，不是想回来就能回来的，你爸妈多想你啊', post:'！', py:'Nǐ zhēn de yào chūguó? Qù nàme yuǎn de dìfang, bú shì xiǎng huílai jiù néng huílai de, nǐ bàmā duō xiǎng nǐ a!', vn:'Bạn thật sự muốn ra nước ngoài à? Đi nơi xa thế, không phải muốn về là về được đâu, bố mẹ bạn nhớ bạn lắm đấy!'},
       {speaker:'女', pre:'', blank:'他们说年轻人应该走出去，多看看外边的人和事', post:'。', py:'Tāmen shuō niánqīngrén yīnggāi zǒu chuqu, duō kànkan wàibian de rén hé shì.', vn:'Bố mẹ tôi nói người trẻ nên đi ra ngoài, xem nhiều hơn về con người và sự việc bên ngoài.'},
     ],
    ...
    {num:14, options:['饭馆门口','饭馆里边','离饭馆不远的地方'], ans:2,
     lines:[
       {speaker:'男', pre:'', blank:'那么多车，吃饭的人真不少', post:'。', py:'Nàme duō chē, chīfàn de rén zhēn bù shǎo.', vn:'Nhiều xe thế, người đến ăn thật không ít.'},
       {speaker:'女', pre:'', blank:'我们把车放在这儿，走过去吧，也不远，两分钟就到了', post:'。', py:'Wǒmen bǎ chē fàng zài zhèr, zǒu guoqu ba, yě bù yuǎn, liǎng fēnzhōng jiù dào le.', vn:'Chúng ta để xe ở đây, đi bộ tới đi, cũng không xa, hai phút là đến rồi.'},
     ],
     explain:'男：那么多车，吃饭的人真不少。女：我们把车放在这儿，走过去吧，也不远，两分钟就到了。问：他们现在最可能在哪儿？ → 离饭馆不远的地方。'},
    {num:15, options:['坐火车','坐飞机','开车'], ans:1,
     lines:[
       {speaker:'女', pre:'', blank:'你几号到北京？票买好了没有', post:'？', py:'Nǐ jǐ hào dào Běijīng? Piào mǎihǎo le méiyǒu?', vn:'Bạn ngày mấy đến Bắc Kinh? Vé mua xong chưa?'},
       {speaker:'男', pre:'', blank:'别担心，我下个星期六就飞回去了', post:'。', py:'Bié dānxīn, wǒ xià ge xīngqīliù jiù fēi huiqu le.', vn:'Đừng lo, thứ Bảy tuần sau tôi bay về rồi.'},
     ],
    ...
    {num:17, options:['回公司','给老周带东西','开车'], ans:1,
     lines:[
       ...
       {speaker:'男', pre:'', blank:'我是走过来的，车放在公司门口了。怎么了，有事吗', post:'？', py:'Wǒ shì zǒu guolai de, chē fàng zài gōngsī ménkǒu le. Zěnme le, yǒu shì ma?', vn:'Tôi đi bộ tới đấy, xe để ở cổng công ty rồi. Sao thế, có việc gì à?'},
       {speaker:'女', pre:'', blank:'你能帮我给老周带回去点儿东西吗？他放在我这儿好长时间了', post:'。', py:'Nǐ néng bāng wǒ gěi Lǎo Zhōu dài huiqu diǎnr dōngxi ma? Tā fàng zài wǒ zhèr hǎo cháng shíjiān le.', vn:'Bạn giúp tôi mang đồ về cho lão Chu được không? Anh ấy để ở chỗ tôi lâu rồi.'},
    ...
    {num:19, options:['今天是他生日','没开车来','想喝点儿酒'], ans:1,
     lines:[
       ...
       {speaker:'女', pre:'', blank:'你不是开车了吗，能喝酒吗', post:'？', py:'Nǐ bú shì kāichē le ma, néng hē jiǔ ma?', vn:'Bạn chẳng phải đang lái xe à, uống rượu được sao?'},
       {speaker:'男', pre:'', blank:'今天是你的生日，喝几口没关系', post:'。', py:'Jīntiān shì nǐ de shēngrì, hē jǐ kǒu méi guānxi.', vn:'Hôm nay là sinh nhật em, uống vài ngụm không sao đâu.'},
       {speaker:'女', pre:'', blank:'那你的车今天放在这儿吧，明天再过来开回去', post:'。', py:'Nà nǐ de chē jīntiān fàng zài zhèr ba, míngtiān zài guolai kāi huiqu.', vn:'Vậy xe của anh cứ để ở đây, mai quay lại lái về.'},
     ],
    ...
    {num:20, options:['太阳咖啡店','西西蛋糕店','西西咖啡店'], ans:1,
     lines:[
       {speaker:'男', pre:'', blank:'走累了吧？我们去"太阳咖啡店"坐一会儿吧', post:'。', py:'Zǒu lèi le ba? Wǒmen qù "Tàiyáng Kāfēidiàn" zuò yíhuìr ba.', vn:'Đi mệt rồi phải không? Chúng ta đến "quán cà phê Mặt Trời" ngồi một lát đi.'},
       {speaker:'女', pre:'', blank:'那家店在三层，也没有电梯，要走上去，喝完咖啡还要走下来，我腿疼', post:'。', py:'Nà jiā diàn zài sān céng, yě méiyǒu diàntī, yào zǒu shangqu, hēwán kāfēi hái yào zǒu xialai, wǒ tuǐ téng.', vn:'Quán đó ở tầng ba, cũng không có thang máy, phải đi bộ lên, uống xong cà phê còn phải đi bộ xuống, chân tôi đau.'},
