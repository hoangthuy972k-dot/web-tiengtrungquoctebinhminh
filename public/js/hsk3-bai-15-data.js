...
var matchData = [
  ...
  {left:'如果你有什么不明白的地方，',right:'就可以给我发电子邮件。'},
...
var fillData = [
  ...
  {pre:'我的中文',blank:'水平',post:'提高得一点儿也不快。',hint:'(trình độ)',ans:'水平'},
  {pre:'中文水平',blank:'提高',post:'得一点儿也不快。',hint:'(nâng cao, tiến bộ)',ans:'提高'},
  {pre:'每天',blank:'练习',post:'、完成作业。',hint:'(bài tập)',ans:'练习'},
  {pre:'他认真',blank:'完成',post:'了这次的作业。',hint:'(hoàn thành)',ans:'完成'},
  {pre:'这个',blank:'句子',post:'意思不太清楚。',hint:'(câu)',ans:'句子'},
  {pre:'',blank:'其他',post:'都没什么问题。',hint:'(cái khác)',ans:'其他'},
  {pre:'可以找我或者',blank:'发',post:'电子邮件。',hint:'(gửi, gửi đi)',ans:'发'},
  {pre:'我先给大家讲讲这次比赛的',blank:'要求',post:'。',hint:'(yêu cầu)',ans:'要求'},
  {pre:'需要',blank:'注意',post:'的地方。',hint:'(chú ý)',ans:'注意'},
  {pre:'在家用手机',blank:'上网',post:'也很方便。',hint:'(lên mạng)',ans:'上网'},
  {pre:'',blank:'除了',post:'看新闻，人们还可以上网听歌。',hint:'(ngoài...ra)',ans:'除了'},
  ...
  {pre:'新年也是这里很重要的一个',blank:'节日',post:'。',hint:'(ngày lễ)',ans:'节日'},
  {pre:'每年夏天都要',blank:'举行',post:'一次比赛。',hint:'(tổ chức)',ans:'举行'},
...
// ══════════════════════════════════════════
var sortData = [
  {words:['你','每天','认真','复习','，','完成','作业','。'],ans:'你每天认真复习，完成作业。',audio:'你每天认真复习，完成作业。'},
  {words:['除了','这次','的','练习','有点儿','难','以外','，','其他','都','没','什么','问题','。'],ans:'除了这次的练习有点儿难以外，其他都没什么问题。',audio:'除了这次的练习有点儿难以外，其他都没什么问题。'},
  {words:['在','图书馆','用','笔记本电脑','上网','很','方便','。'],ans:'在图书馆用笔记本电脑上网很方便。',audio:'在图书馆用笔记本电脑上网很方便。'},
  {words:['这个','蛋糕','好吃','极了','。'],ans:'这个蛋糕好吃极了。',audio:'这个蛋糕好吃极了。'},
  {words:['虽然','妹妹','每天','认真','练习','，','但是','句子','写','得','还','不','够','好','。'],ans:'虽然妹妹每天认真练习，但是句子写得还不够好。',audio:'虽然妹妹每天认真练习，但是句子写得还不够好。'},
  {words:['如果','你','有','什么','不明白','的','地方','，','就','可以','给','我','发','电子邮件','。'],ans:'如果你有什么不明白的地方，就可以给我发电子邮件。',audio:'如果你有什么不明白的地方，就可以给我发电子邮件。'},
  {words:['只要','你','努力','练习','，','就','能','越','写','越','漂亮','。'],ans:'只要你努力练习，就能越写越漂亮。',audio:'只要你努力练习，就能越写越漂亮。'},
  {words:['除了','游泳','、','爬山','以外','，','跑步','也','是','他','很','喜欢','的','一个','运动','。'],ans:'除了游泳、爬山以外，跑步也是他很喜欢的一个运动。',audio:'除了游泳、爬山以外，跑步也是他很喜欢的一个运动。'},
];
...
// ══════════════════════════════════════════
var errorFixData = [
  {wrong:'除了这个词语，别的词语我不都认识。',
   opts:['除了这个词语以外，别的词语我都认识。','除了这个词语，别的词语我不都认识。','除了这个词语以外，别的词语我都不认识。','我除了这个词语以外都认识别的词语不。'],ans:0,
  ...
  dictation: [
    ...
    {num:2, lines:[
      {speaker:"男", pre:"", blank:"你要发电子邮件吗？我去把电脑打开", post:"。",
       py:"Nǐ yào fā diànzǐ yóujiàn ma? Wǒ qù bǎ diànnǎo dǎkāi.",
       vn:"Bạn cần gửi email à? Tôi bật máy tính lên đây."},
      {speaker:"女", pre:"不用，", blank:"我的手机能上网，用手机也能发", post:"。",
       py:"Búyòng, wǒ de shǒujī néng shàng wǎng, yòng shǒujī yě néng fā.",
       vn:"Không cần, điện thoại tôi lên mạng được, dùng điện thoại cũng gửi được."}]},
    {num:3, lines:[
      {speaker:"男1", pre:"", blank:"你们这儿除了鱼以外，还有什么好吃的吗", post:"？",
       py:"Nǐmen zhèr chúle yú yǐwài, hái yǒu shénme hǎochī de ma?",
       vn:"Chỗ các bạn ngoài cá ra, còn món gì ngon không?"},
      {speaker:"男2", pre:"", blank:"今天的羊肉也很新鲜，您要不要来一个", post:"？",
       py:"Jīntiān de yángròu yě hěn xīnxiān, nín yào bu yào lái yí ge?",
       vn:"Hôm nay thịt cừu cũng rất tươi, anh có muốn dùng một phần không?"}]},
    {num:4, lines:[
      ...
      {speaker:"女", pre:"", blank:"我记得我只买了几件衣服，其他也没买什么啊", post:"。",
       py:"Wǒ jìde wǒ zhǐ mǎile jǐ jiàn yīfu, qítā yě méi mǎi shénme a.",
       vn:"Tôi nhớ tôi chỉ mua vài cái áo, cái khác cũng chẳng mua gì đâu."}]},
    {num:5, lines:[
      {speaker:"男", pre:"", blank:"看什么呢？今天报纸上有什么新闻吗", post:"？",
       py:"Kàn shénme ne? Jīntiān bàozhǐ shang yǒu shénme xīnwén ma?",
       vn:"Xem gì thế? Hôm nay báo có tin tức gì không?"},
      {speaker:"女", pre:"", blank:"我没看新闻，我看看今天天气怎么样", post:"。",
       py:"Wǒ méi kàn xīnwén, wǒ kànkan jīntiān tiānqì zěnme yàng.",
       vn:"Tôi không xem tin tức, tôi xem thử hôm nay thời tiết thế nào."}]},
    {num:6, stmt:"叔叔希望我花钱买本书。", judge:false, lines:[
      {pre:"叔叔让我花时间认真地读一读这本书，他说书里的故事对他的影响很大。", blank:"他希望我也能从书中学到一些东西", post:"。",
       py:"Shūshu ràng wǒ huā shíjiān rènzhēn de dú yi dú zhè běn shū, tā shuō shū li de gùshi duì tā de yǐngxiǎng hěn dà. Tā xīwàng wǒ yě néng cóng shū zhōng xuédào yìxiē dōngxi.",
       vn:"Chú bảo tôi dành thời gian đọc kỹ quyển sách này, chú nói câu chuyện trong sách ảnh hưởng đến chú rất lớn. Chú mong tôi cũng học được điều gì đó từ sách."}]},
    {num:7, stmt:"弟弟每天晚上都上网看新闻。", judge:false, lines:[
      {pre:"每天晚上的这个时间，电视上除了新闻以外，没什么其他节目，", blank:"所以弟弟只好上网看自己喜欢的电视节目", post:"。",
       py:"Měi tiān wǎnshang de zhège shíjiān, diànshì shang chúle xīnwén yǐwài, méi shénme qítā jiémù, suǒyǐ dìdi zhǐhǎo shàng wǎng kàn zìjǐ xǐhuan de diànshì jiémù.",
       vn:"Mỗi tối vào giờ này, tivi ngoài tin tức ra, không có chương trình nào khác, nên em trai đành lên mạng xem chương trình tivi mình thích."}]},
    {num:8, stmt:"女儿边留学边在饭馆工作。", judge:true, lines:[
      {pre:"女儿在国外留学三年了，除了每天上课学习以外，", blank:"课后还要去饭馆帮忙洗盘子", post:"。",
       py:"Nǚ'ér zài guówài liú xué sān nián le, chúle měi tiān shàngkè xuéxí yǐwài, kèhòu hái yào qù fànguǎn bāngmáng xǐ pánzi.",
       vn:"Con gái đi du học nước ngoài được ba năm rồi, ngoài mỗi ngày lên lớp học ra, sau giờ học còn phải đến nhà hàng phụ rửa bát."},
      {pre:"虽然每个月我们都给她不少钱，", blank:"但是她说花自己的钱更舒服", post:"。",
       py:"Suīrán měi ge yuè wǒmen dōu gěi tā bù shǎo qián, dànshì tā shuō huā zìjǐ de qián gèng shūfu.",
       vn:"Tuy mỗi tháng chúng tôi đều cho con không ít tiền, nhưng con nói tiêu tiền tự kiếm được thoải mái hơn."}]},
    {num:9, stmt:"老方每天都看报纸。", judge:true, lines:[
      {pre:"老方每天都坐在办公室中间的那把椅子上，边看报纸边喝茶，", blank:"报纸上有什么有意思的新闻，他都读给我们听", post:"。",
       py:"Lǎo Fāng měi tiān dōu zuò zài bàngōngshì zhōngjiān de nà bǎ yǐzi shang, biān kàn bàozhǐ biān hē chá, bàozhǐ shang yǒu shénme yǒuyìsi de xīnwén, tā dōu dú gěi wǒmen tīng.",
       vn:"Lão Phương ngày nào cũng ngồi trên cái ghế giữa văn phòng, vừa đọc báo vừa uống trà, báo có tin tức gì thú vị, ông ấy đều đọc cho chúng tôi nghe."}]},
    {num:10, stmt:"他们以后能经常见面。", judge:false, lines:[
      {pre:"这个短期班下周日就要结束了，以后我们不能像现在这样经常见面了，", blank:"有什么事情可以给我打电话或者发电子邮件", post:"。",
       py:"Zhège duǎnqībān xià zhōurì jiù yào jiéshù le, yǐhòu wǒmen bù néng xiàng xiànzài zhèyàng jīngcháng jiànmiàn le, yǒu shénme shìqing kěyǐ gěi wǒ dǎ diànhuà huòzhě fā diànzǐ yóujiàn.",
       vn:"Lớp học ngắn hạn này tuần sau chủ nhật là kết thúc rồi, sau này chúng ta không thể thường xuyên gặp nhau như bây giờ nữa, có việc gì có thể gọi điện hoặc gửi email cho tôi."}]}
  ],
  mc: [
    {num:11, options:["环境不好","商店很远","夏天很热"], ans:2, q:"女的觉得这个地方怎么样？",
     lines:[
      {speaker:"男", pre:"你在这个地方生活了二十年，", blank:"对这儿很了解了吧", post:"？",
       py:"Nǐ zài zhège dìfang shēnghuóle èrshí nián, duì zhèr hěn liǎojiě le ba?",
       vn:"Bạn sống ở nơi này hai mươi năm rồi, chắc hiểu rõ nơi đây lắm nhỉ?"},
      {speaker:"女", pre:"对，", blank:"这个地方除了夏天太热以外，其他都很好。环境不错，买东西也方便", post:"。",
       py:"Duì, zhège dìfang chúle xiàtiān tài rè yǐwài, qítā dōu hěn hǎo. Huánjìng búcuò, mǎi dōngxi yě fāngbiàn.",
       vn:"Đúng vậy, nơi này ngoài mùa hè quá nóng ra, còn lại đều tốt. Môi trường không tệ, mua đồ cũng tiện."}
     ],
     explain:"男：你在这个地方生活了二十年，对这儿很了解了吧？女：对，这个地方除了夏天太热以外，其他都很好。环境不错，买东西也方便。问：女的觉得这个地方怎么样？ → 夏天很热。"},
    {num:12, options:["裤子","裙子","衬衫"], ans:0, q:"男的不让洗什么？",
     lines:[
      {speaker:"女", pre:"除了这条裤子以外，", blank:"还有什么要洗的吗", post:"？",
       py:"Chúle zhè tiáo kùzi yǐwài, hái yǒu shénme yào xǐ de ma?",
       vn:"Ngoài cái quần này ra, còn gì cần giặt không?"},
      {speaker:"男", pre:"那条裤子是干净的，不用洗，", blank:"你把那两件衬衫洗了吧", post:"。",
       py:"Nà tiáo kùzi shì gānjìng de, búyòng xǐ, nǐ bǎ nà liǎng jiàn chènshān xǐ le ba.",
       vn:"Cái quần đó sạch rồi, không cần giặt, bạn giặt hai cái áo sơ mi đó đi."}
     ],
     explain:"女：除了这条裤子以外，还有什么要洗的吗？男：那条裤子是干净的，不用洗，你把那两件衬衫洗了吧。问：男的不让洗什么？ → 裤子。"},
    {num:13, options:["有电梯的","没电梯的","安静的"], ans:2, q:"女的想要什么样的房子？",
     lines:[
      {speaker:"男", pre:"除了安静以外，您对房子还有什么要求吗？", blank:"有电梯的还是没电梯的", post:"？",
       py:"Chúle ānjìng yǐwài, nín duì fángzi hái yǒu shénme yāoqiú ma? Yǒu diàntī de háishi méi diàntī de?",
       vn:"Ngoài yên tĩnh ra, anh còn có yêu cầu gì về căn nhà không? Có thang máy hay không có thang máy?"},
      {speaker:"女", pre:"我只有这一个要求，", blank:"你们有这样的房子吗", post:"？",
       py:"Wǒ zhǐyǒu zhè yí ge yāoqiú, nǐmen yǒu zhèyàng de fángzi ma?",
       vn:"Tôi chỉ có mỗi một yêu cầu này thôi, các anh có nhà như vậy không?"}
     ],
     explain:"男：除了安静以外，您对房子还有什么要求吗？有电梯的还是没电梯的？女：我只有这一个要求，你们有这样的房子吗？问：女的想要什么样的房子？ → 安静的。"},
    {num:14, options:["不认真","特别漂亮","特别慢"], ans:1, q:"女的写字写得怎么样？",
     lines:[
      {speaker:"男", pre:"你的字写得漂亮极了，你是怎么写的？", blank:"能教教我吗", post:"？",
       py:"Nǐ de zì xiě de piàoliang jí le, nǐ shì zěnme xiě de? Néng jiāojiao wǒ ma?",
       vn:"Chữ bạn viết đẹp lắm, bạn viết thế nào vậy? Dạy tôi được không?"},
      {speaker:"女", pre:"开始的时候除了认真学，慢慢写以外，还要努力练习，这样才能越写越快，", blank:"越写越漂亮", post:"。",
       py:"Kāishǐ de shíhou chúle rènzhēn xué, mànman xiě yǐwài, hái yào nǔlì liànxí, zhèyàng cái néng yuè xiě yuè kuài, yuè xiě yuè piàoliang.",
       vn:"Lúc đầu ngoài học nghiêm túc, viết chậm rãi ra, còn phải nỗ lực luyện tập, như vậy mới viết ngày càng nhanh, ngày càng đẹp."}
     ],
     explain:"男：你的字写得漂亮极了，你是怎么写的？能教教我吗？女：开始的时候除了认真学，慢慢写以外，还要努力练习，这样才能越写越快，越写越漂亮。问：女的写字写得怎么样？ → 特别漂亮。"},
    {num:15, options:["男的","自己","穿得漂亮的人"], ans:0, q:"女的觉得谁是最重要的人？",
     lines:[
      {speaker:"男", pre:"你今天穿得这么漂亮，", blank:"要见什么重要的人吗", post:"？",
       py:"Nǐ jīntiān chuān de zhème piàoliang, yào jiàn shénme zhòngyào de rén ma?",
       vn:"Hôm nay bạn ăn mặc đẹp thế, định gặp người quan trọng nào à?"},
      {speaker:"女", pre:"除了你以外，还有更重要的人吗？今天是中秋节，", blank:"我们一起去看个电影吧", post:"。",
       py:"Chúle nǐ yǐwài, hái yǒu gèng zhòngyào de rén ma? Jīntiān shì Zhōngqiū jié, wǒmen yìqǐ qù kàn ge diànyǐng ba.",
       vn:"Ngoài anh ra, còn ai quan trọng hơn nữa chứ? Hôm nay là Tết Trung thu, chúng ta cùng đi xem phim đi."}
     ],
     explain:"男：你今天穿得这么漂亮，要见什么重要的人吗？女：除了你以外，还有更重要的人吗？今天是中秋节，我们一起去看个电影吧。问：女的觉得谁是最重要的人？ → 男的。"},
    {num:16, options:["喜欢夏天","不喜欢热","四个季节都喜欢"], ans:1, q:"关于男的，可以知道什么？",
     lines:[
      {speaker:"女", pre:"大明，", blank:"一年四季，你最喜欢哪个季节", post:"？",
       py:"Dàmíng, yì nián sì jì, nǐ zuì xǐhuan nǎge jìjié?",
       vn:"Đại Minh, một năm bốn mùa, bạn thích mùa nào nhất?"},
      {speaker:"男", pre:"我啊，", blank:"除了夏天以外，我都喜欢", post:"。",
       py:"Wǒ a, chúle xiàtiān yǐwài, wǒ dōu xǐhuan.",
       vn:"Tôi á, ngoài mùa hè ra, tôi đều thích."},
      {speaker:"女", pre:"", blank:"能告诉我为什么吗", post:"？",
       py:"Néng gàosu wǒ wèishénme ma?",
       vn:"Có thể nói cho tôi biết tại sao không?"},
      {speaker:"男", pre:"我怕热啊，这儿的夏天热极了，", blank:"你不觉得吗", post:"？",
       py:"Wǒ pà rè a, zhèr de xiàtiān rè jí le, nǐ bù juéde ma?",
       vn:"Tôi sợ nóng mà, mùa hè ở đây nóng lắm, bạn không thấy vậy sao?"}
     ],
     explain:"女：大明，一年四季，你最喜欢哪个季节？男：我啊，除了夏天以外，我都喜欢。女：能告诉我为什么吗？男：我怕热啊，这儿的夏天热极了，你不觉得吗？问：关于男的，可以知道什么？ → 不喜欢热。"},
    {num:17, options:["环境不错","不太安静","不太干净"], ans:0, q:"关于那个房子，可以知道什么？",
     lines:[
      {speaker:"女", pre:"", blank:"我们新买的房子就在刚才过去的那条街上", post:"。",
      ...
      {speaker:"男", pre:"是吗？", blank:"我看环境很好", post:"。",
       py:"Shì ma? Wǒ kàn huánjìng hěn hǎo.",
       vn:"Vậy à? Tôi thấy môi trường tốt lắm."},
      {speaker:"女", pre:"没错，", blank:"那儿的街道除了很干净以外，也很安静，附近还有个花园", post:"。",
       py:"Méi cuò, nàr de jiēdào chúle hěn gānjìng yǐwài, yě hěn ānjìng, fùjìn hái yǒu ge huāyuán.",
       vn:"Đúng vậy, đường phố ở đó ngoài rất sạch sẽ ra, cũng rất yên tĩnh, gần đó còn có một vườn hoa."},
      {speaker:"男", pre:"有树有草，好极了！", blank:"真想快点儿搬过去", post:"。",
       py:"Yǒu shù yǒu cǎo, hǎo jí le! Zhēn xiǎng kuài diǎnr bān guoqu.",
       vn:"Có cây có cỏ, tốt quá! Thật muốn dọn đến sớm."}
     ],
     explain:"女：我们新买的房子就在刚才过去的那条街上。男：是吗？我看环境很好。女：没错，那儿的街道除了很干净以外，也很安静，附近还有个花园。男：有树有草，好极了！真想快点儿搬过去。问：关于那个房子，可以知道什么？ → 环境不错。"},
    {num:18, options:["颜色不好","不便宜","太大了"], ans:1, q:"女的觉得这件衣服怎么样？",
     lines:[
      {speaker:"男", pre:"", blank:"这条裙子不大不小，真不错", post:"。",
       py:"Zhè tiáo qúnzi bú dà bù xiǎo, zhēn búcuò.",
       vn:"Cái váy này không to không nhỏ, đẹp thật."},
      {speaker:"女", pre:"颜色也好看，我穿着它去参加朋友的生日晚会，", blank:"一定漂亮极了", post:"。",
       py:"Yánsè yě hǎokàn, wǒ chuānzhe tā qù cānjiā péngyou de shēngrì wǎnhuì, yídìng piàoliang jí le.",
       vn:"Màu sắc cũng đẹp, tôi mặc nó đi dự tiệc sinh nhật bạn, chắc chắn đẹp lắm."},
      {speaker:"男", pre:"那你为什么不买？", blank:"有什么不满意吗", post:"？",
       py:"Nà nǐ wèishénme bù mǎi? Yǒu shénme bù mǎnyì ma?",
       vn:"Vậy sao bạn không mua? Có gì không hài lòng à?"},
      {speaker:"女", pre:"除了太贵以外，", blank:"没什么不满意的", post:"。",
       py:"Chúle tài guì yǐwài, méi shénme bù mǎnyì de.",
       vn:"Ngoài quá đắt ra, không có gì không hài lòng cả."}
     ],
     explain:"男：这条裙子不大不小，真不错。女：颜色也好看，我穿着它去参加朋友的生日晚会，一定漂亮极了。男：那你为什么不买？有什么不满意吗？女：除了太贵以外，没什么不满意的。问：女的觉得这件衣服怎么样？ → 不便宜。"},
    {num:19, options:["不能打电话","没有声音","不能上网"], ans:2, q:"女的的手机有什么问题？",
     lines:[
      {speaker:"女", pre:"您好，", blank:"我的手机从前天开始就不能上网了，您帮我看看吧", post:"。",
       py:"Nín hǎo, wǒ de shǒujī cóng qiántiān kāishǐ jiù bù néng shàng wǎng le, nín bāng wǒ kànkan ba.",
       vn:"Chào anh, điện thoại tôi từ hôm kia không lên mạng được nữa, anh xem giúp tôi với."},
      {speaker:"男", pre:"除了上不去网以外，", blank:"还有什么其他问题吗", post:"？",
       py:"Chúle shàng bú qù wǎng yǐwài, hái yǒu shénme qítā wèntí ma?",
       vn:"Ngoài không lên mạng được ra, còn vấn đề gì khác không?"},
      {speaker:"女", pre:"打电话的时候声音特别小，", blank:"经常听不清楚", post:"。",
       py:"Dǎ diànhuà de shíhou shēngyīn tèbié xiǎo, jīngcháng tīng bu qīngchu.",
       vn:"Lúc gọi điện âm thanh rất nhỏ, thường nghe không rõ."},
      {speaker:"男", pre:"您别着急，", blank:"我马上帮您看看", post:"。",
       py:"Nín bié zháojí, wǒ mǎshàng bāng nín kànkan.",
       vn:"Chị đừng lo, tôi xem giúp chị ngay đây."}
     ],
     explain:"女：您好，我的手机从前天开始就不能上网了，您帮我看看吧。男：除了上不去网以外，还有什么其他问题吗？女：打电话的时候声音特别小，经常听不清楚。男：您别着急，我马上帮您看看。问：女的的手机有什么问题？ → 不能上网。"},
    {num:20, options:["喝水","上网","打电话"], ans:0, q:"在这个宾馆里做什么不用花钱？",
     lines:[
      {speaker:"男", pre:"您好，", blank:"我在这儿只住了一个星期，怎么这么贵", post:"？",
       py:"Nín hǎo, wǒ zài zhèr zhǐ zhùle yí ge xīngqī, zěnme zhème guì?",
       vn:"Chào chị, tôi ở đây chỉ có một tuần, sao đắt thế?"},
      {speaker:"女", pre:"对不起，", blank:"我们宾馆除了水以外，房间里其他吃的、喝的都是要花钱的", post:"。",
       py:"Duìbuqǐ, wǒmen bīnguǎn chúle shuǐ yǐwài, fángjiān li qítā chī de, hē de dōu shì yào huā qián de.",
       vn:"Xin lỗi anh, khách sạn chúng tôi ngoài nước ra, đồ ăn đồ uống khác trong phòng đều phải trả tiền."},
      {speaker:"男", pre:"", blank:"上网和打电话也要自己花钱吗", post:"？",
       py:"Shàng wǎng hé dǎ diànhuà yě yào zìjǐ huā qián ma?",
       vn:"Lên mạng và gọi điện cũng phải tự trả tiền à?"},
      {speaker:"女", pre:"对，", blank:"上网每个小时5块，打电话一分钟也是5块", post:"。",
       py:"Duì, shàng wǎng měi ge xiǎoshí wǔ kuài, dǎ diànhuà yì fēnzhōng yě shì wǔ kuài.",
       vn:"Đúng vậy, lên mạng mỗi giờ 5 đồng, gọi điện mỗi phút cũng 5 đồng."}
     ],
