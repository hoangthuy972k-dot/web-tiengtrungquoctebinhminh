  ...
  mc: [
    {num:11, options:['公园里边','公园西门','公园北门'], ans:1,
     lines:[
       ...
       {speaker:'男', pre:'你别过来了，', blank:'我快到西门了', post:'。', py:'Nǐ bié guòlai le, wǒ kuài dào xīmén le.', vn:'Bạn đừng qua nữa, tôi sắp đến cổng tây rồi.'},
     ],
    ...
    {num:12, options:['太阳从西边出来','女的不可能每天跑步','明天要跑一千米'], ans:1,
     lines:[
       ...
       {speaker:'男', pre:'真的吗？', blank:'太阳从西边出来了', post:'？', py:'Zhēn de ma? Tàiyáng cóng xībian chūlai le?', vn:'Thật á? Mặt trời mọc từ hướng tây à?'},
     ],
    ...
    {num:15, options:['开车','打车','坐公共汽车'], ans:1,
     lines:[
       {speaker:'女', pre:'火车站离这儿很远，坐车不太方便，', blank:'我开车送你去', post:'。', py:'Huǒchēzhàn lí zhèr hěn yuǎn, zuò chē bú tài fāngbiàn, wǒ kāichē sòng nǐ qù.', vn:'Ga tàu cách đây xa lắm, đi xe không tiện lắm, tôi lái xe đưa bạn đi.'},
    ...
    {num:16, options:['太阳','小猫','花儿'], ans:2,
     lines:[
       ...
       {speaker:'女', pre:'太阳是我画的，', blank:'小猫是妹妹画的', post:'。', py:'Tàiyáng shì wǒ huà de, xiǎomāo shì mèimei huà de.', vn:'Mặt trời là tôi vẽ, con mèo nhỏ là em gái vẽ.'},
    ...
    {num:17, options:['帮女的拿西瓜','想再吃点儿米饭','想吃点儿西瓜'], ans:2,
     lines:[
       {speaker:'女', pre:'吃好了吗？', blank:'要不要再来点儿米饭', post:'？', py:'Chīhǎo le ma? Yào bu yào zài lái diǎnr mǐfàn?', vn:'Ăn xong chưa? Có muốn ăn thêm chút cơm không?'},
       {speaker:'男', pre:'', blank:'不吃了。家里还有西瓜吗', post:'？', py:'Bù chī le. Jiā li hái yǒu xīguā ma?', vn:'Không ăn nữa. Nhà còn dưa hấu không?'},
       {speaker:'女', pre:'还有半个，', blank:'你自己拿吧', post:'。', py:'Hái yǒu bàn ge, nǐ zìjǐ ná ba.', vn:'Còn nửa quả, bạn tự lấy đi.'},
    ...
    {num:18, options:['去接人','坐火车','找司机'], ans:0,
     lines:[
       {speaker:'男', pre:'喂，', blank:'是小马吗', post:'？', py:'Wéi, shì Xiǎomǎ ma?', vn:'Alo, có phải Tiểu Mã không?'},
       {speaker:'女', pre:'是我，周经理，', blank:'您有什么事', post:'？', py:'Shì wǒ, Zhōu jīnglǐ, nín yǒu shénme shì?', vn:'Là em đây, giám đốc Chu, anh có việc gì ạ?'},
    ...
    {num:19, options:['骑车去上课','教女的骑车','学骑自行车'], ans:1,
     lines:[
       ...
       {speaker:'男', pre:'当然，', blank:'我以前经常骑车去上课', post:'。', py:'Dāngrán, wǒ yǐqián jīngcháng qí chē qù shàngkè.', vn:'Đương nhiên, trước đây tôi thường đi xe đạp đến lớp.'},
       {speaker:'女', pre:'那你教教我吧，', blank:'我一直想学', post:'。', py:'Nà nǐ jiāojiao wǒ ba, wǒ yìzhí xiǎng xué.', vn:'Vậy bạn dạy tôi đi, tôi muốn học mãi rồi.'},
       {speaker:'男', pre:'可以啊，', blank:'你什么时候有时间', post:'？', py:'Kěyǐ a, nǐ shénme shíhou yǒu shíjiān?', vn:'Được đấy, bạn khi nào rảnh?'},
     ],
     explain:'女：你会骑自行车吗？男：当然，我以前经常骑车去上课。女：那你教教我吧，我一直想学。男：可以啊，你什么时候有时间？问：男的要做什么？ → 教女的骑车。'},
    {num:20, options:['来机场晚了','找不到护照了','忘了给女的打电话'], ans:0,
     lines:[
       {speaker:'女', pre:'你怎么才来，', blank:'都八点一刻了', post:'。', py:'Nǐ zěnme cái lái, dōu bā diǎn yí kè le.', vn:'Sao giờ bạn mới đến, đã 8 giờ 15 rồi.'},
       ...
       {speaker:'男', pre:'你一直给我打电话，我很着急，', blank:'就出了问题', post:'。', py:'Nǐ yìzhí gěi wǒ dǎ diànhuà, wǒ hěn zháojí, jiù chūle wèntí.', vn:'Bạn cứ gọi điện cho tôi mãi, tôi vội quá, nên mới xảy ra vấn đề.'},
     ],
