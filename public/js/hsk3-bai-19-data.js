  ...
  dictation: [
    {num:1, lines:[
      ...
      {speaker:"男", pre:"", blank:"不知道，我也是第一次见", post:"。",
       py:"Bù zhīdào, wǒ yě shì dì-yī cì jiàn.",
       vn:"Không biết, tôi cũng là lần đầu thấy."}]},
    {num:2, lines:[
      ...
      {speaker:"女", pre:"医生，怎么样？没事吧？", blank:"我最近总是听不清别人说话", post:"。",
       py:"Yīshēng, zěnme yàng? Méi shì ba? Wǒ zuìjìn zǒngshì tīng bu qīng biéren shuōhuà.",
       vn:"Bác sĩ, thế nào? Không sao chứ? Gần đây tôi cứ nghe không rõ người khác nói."}]},
    {num:3, lines:[
      {speaker:"女", pre:"", blank:"都几点了，儿子的房间里一点儿声音都没有，他还在睡觉吗", post:"？",
       py:"Dōu jǐ diǎn le, érzi de fángjiān li yìdiǎnr shēngyīn dōu méiyǒu, tā hái zài shuìjiào ma?",
       vn:"Mấy giờ rồi, phòng con trai không có tiếng động gì, con vẫn đang ngủ à?"},
      {speaker:"男", pre:"没有，", blank:"他已经起床了，现在在洗脸呢", post:"。",
       py:"Méiyǒu, tā yǐjīng qǐchuáng le, xiànzài zài xǐliǎn ne.",
       vn:"Không có, con dậy rồi, đang rửa mặt đấy."}]},
    {num:4, lines:[
    ...
    {num:5, lines:[
      {speaker:"男", pre:"", blank:"你穿的这件红色运动服真好看", post:"。",
       py:"Nǐ chuān de zhè jiàn hóngsè yùndòngfú zhēn hǎokàn.",
       vn:"Bộ đồ thể thao đỏ bạn đang mặc đẹp thật."},
      {speaker:"女", pre:"谢谢，", blank:"我觉得穿上它，让我年轻了不少", post:"。",
       py:"Xièxie, wǒ juéde chuānshang tā, ràng wǒ niánqīngle bù shǎo.",
       vn:"Cảm ơn, tôi thấy mặc nó vào, khiến tôi trẻ hơn hẳn."}]},
    {num:6, stmt:"他每天上下班都很快乐。", judge:true, lines:[
      {pre:"上下班的时候，我都会经过这条街。", blank:"街道两边的树，还有树上的小鸟，会使我觉得很快乐", post:"。",
       py:"Shàng xià bān de shíhou, wǒ dōu huì jīngguò zhè tiáo jiē. Jiēdào liǎng biān de shù, hái yǒu shù shang de xiǎo niǎo, huì shǐ wǒ juéde hěn kuàilè.",
       vn:"Lúc đi làm về, tôi đều đi ngang qua con phố này. Hàng cây hai bên đường phố, còn có chim nhỏ trên cây, khiến tôi cảm thấy rất vui."}]},
    {num:7, stmt:"小雨哭是因为耳朵有问题了。", judge:false, lines:[
      {pre:"最近，我家小雨一直哭，说耳朵疼。我带他去医院，", blank:"但是医生说他的耳朵没问题，不用吃药，多喝些水就可以了", post:"。",
       py:"Zuìjìn, wǒ jiā Xiǎoyǔ yìzhí kū, shuō ěrduo téng. Wǒ dài tā qù yīyuàn, dànshì yīshēng shuō tā de ěrduo méi wèntí, búyòng chī yào, duō hē xiē shuǐ jiù kěyǐ le.",
       vn:"Gần đây, bé Tiểu Vũ nhà tôi cứ khóc mãi, nói tai đau. Tôi đưa bé đi bệnh viện, nhưng bác sĩ nói tai bé không có vấn đề gì, không cần uống thuốc, uống nhiều nước là được."}]},
    {num:8, stmt:"他以前住在黄河附近。", judge:true, lines:[
      {pre:"这张照片让我想起了我的家，", blank:"以前我家住在黄河边上，后来因为爸爸工作的关系搬到了这里", post:"。",
       py:"Zhè zhāng zhàopiàn ràng wǒ xiǎngqǐle wǒ de jiā, yǐqián wǒ jiā zhù zài Huáng Hé biānshang, hòulái yīnwèi bàba gōngzuò de guānxi bāndàole zhèli.",
       vn:"Tấm ảnh này khiến tôi nhớ đến nhà mình, trước đây nhà tôi sống ở bên bờ Hoàng Hà, sau đó vì công việc của bố nên chuyển đến đây."}]},
    {num:9, stmt:"他终于找到那本书了。", judge:true, lines:[
      {pre:"我一直在找这本书，", blank:"没想到今天下班路过一家书店时看见了它，我太高兴了", post:"。",
       py:"Wǒ yìzhí zài zhǎo zhè běn shū, méi xiǎngdào jīntiān xiàbān lùguò yì jiā shūdiàn shí kànjiànle tā, wǒ tài gāoxìng le.",
       vn:"Tôi cứ tìm mãi quyển sách này, không ngờ hôm nay tan làm đi ngang qua một hiệu sách lại thấy nó, tôi vui quá."}]},
    {num:10, stmt:"现在她是长头发。", judge:true, lines:[
      {pre:"你看，", blank:"这张照片是前年夏天照的，那时她比较瘦，还是短头发", post:"。",
       py:"Nǐ kàn, zhè zhāng zhàopiàn shì qiánnián xiàtiān zhào de, nà shí tā bǐjiào shòu, háishi duǎn tóufa.",
       vn:"Bạn xem, tấm ảnh này chụp hè năm kia đấy, lúc đó cô ấy khá gầy, vẫn để tóc ngắn."}]}
  ],
  mc: [
    {num:11, options:["他不高兴了","眼睛里有东西","不喜欢刮风"], ans:1, q:"男的怎么了？",
     lines:[
      {speaker:"女", pre:"", blank:"你哭了", post:"？",
       py:"Nǐ kū le?",
       vn:"Bạn khóc à?"},
      {speaker:"男", pre:"没有啊，刚才风刮得太大，", blank:"眼睛里进东西了", post:"。",
       py:"Méiyǒu a, gāngcái fēng guā de tài dà, yǎnjing li jìn dōngxi le.",
       vn:"Không có, vừa nãy gió thổi to quá, có vật gì vào mắt rồi."}
     ],
     explain:"女：你哭了？男：没有啊，刚才风刮得太大，眼睛里进东西了。问：男的怎么了？ → 眼睛里有东西。"},
    {num:12, options:["她骑得不快","她不太小心","她会骑马"], ans:2, q:"女的是什么意思？",
     lines:[
      {speaker:"男", pre:"小心点儿，", blank:"别骑太快了", post:"。",
       py:"Xiǎoxīn diǎnr, bié qí tài kuài le.",
       vn:"Cẩn thận chút, đừng cưỡi nhanh quá."},
      {speaker:"女", pre:"放心，", blank:"我又不是第一次骑马", post:"。",
       py:"Fàngxīn, wǒ yòu bú shì dì-yī cì qí mǎ.",
       vn:"Yên tâm, tôi cũng đâu phải lần đầu cưỡi ngựa."}
     ],
     explain:"男：小心点儿，别骑太快了。女：放心，我又不是第一次骑马。问：女的是什么意思？ → 她会骑马。"},
    {num:13, options:["睡觉","吃糖","起床"], ans:0, q:"女的打算做什么？",
     lines:[
      {speaker:"男", pre:"都这么晚了，", blank:"你怎么还吃糖", post:"？",
       py:"Dōu zhème wǎn le, nǐ zěnme hái chī táng?",
       vn:"Muộn thế này rồi, sao bạn còn ăn kẹo?"},
      {speaker:"女", pre:"不吃了，", blank:"我现在就去刷牙洗脸", post:"。",
       py:"Bù chī le, wǒ xiànzài jiù qù shuā yá xǐliǎn.",
       vn:"Không ăn nữa, tôi đi đánh răng rửa mặt ngay đây."}
     ],
     explain:"男：都这么晚了，你怎么还吃糖？女：不吃了，我现在就去刷牙洗脸。问：女的打算做什么？ → 睡觉。"},
    {num:14, options:["坐船","坐公共汽车","打车"], ans:1, q:"女的是怎么来这儿的？",
     lines:[
      {speaker:"男", pre:"你终于来了，", blank:"船马上就开了", post:"。",
       py:"Nǐ zhōngyú lái le, chuán mǎshàng jiù kāi le.",
       vn:"Bạn cuối cùng cũng đến rồi, thuyền sắp chạy rồi."},
      {speaker:"女", pre:"我没想到坐公共汽车要花这么长时间，", blank:"早知道就打车来了", post:"。",
       py:"Wǒ méi xiǎngdào zuò gōnggòng qìchē yào huā zhème cháng shíjiān, zǎo zhīdào jiù dǎchē lái le.",
       vn:"Tôi không ngờ đi xe buýt lại mất nhiều thời gian thế, biết vậy thì bắt taxi đến rồi."}
     ],
     explain:"男：你终于来了，船马上就开了。女：我没想到坐公共汽车要花这么长时间，早知道就打车来了。问：女的是怎么来这儿的？ → 坐公共汽车。"},
    {num:15, options:["他喜欢做面条","女的过生日","面条很好吃"], ans:1, q:"男的为什么要做面条？",
     lines:[
      {speaker:"男", pre:"过生日要吃面条，这是我第一次做面条，", blank:"看看好吃不好吃", post:"。",
       py:"Guò shēngrì yào chī miàntiáo, zhè shì wǒ dì-yī cì zuò miàntiáo, kànkan hǎochī bù hǎochī.",
       vn:"Sinh nhật phải ăn mì, đây là lần đầu tiên tôi làm mì, xem thử ngon không."},
      {speaker:"女", pre:"", blank:"一定很好吃，谢谢你", post:"！",
       py:"Yídìng hěn hǎochī, xièxie nǐ!",
       vn:"Chắc chắn ngon lắm, cảm ơn bạn!"}
     ],
     explain:"男：过生日要吃面条，这是我第一次做面条，看看好吃不好吃。女：一定很好吃，谢谢你！问：男的为什么要做面条？ → 女的过生日。"},
    {num:16, options:["喜欢玩儿游戏","看错了一个人","去开花园的灯"], ans:1, q:"关于女的，可以知道什么？",
     lines:[
      {speaker:"女", pre:"", blank:"刚才你去后面的花园了", post:"？",
       py:"Gāngcái nǐ qù hòumian de huāyuán le?",
       vn:"Vừa nãy bạn ra vườn hoa phía sau à?"},
      {speaker:"男", pre:"没有，", blank:"我一直在家里玩儿电脑游戏", post:"。",
       py:"Méiyǒu, wǒ yìzhí zài jiā li wánr diànnǎo yóuxì.",
       vn:"Không có, tôi cứ ở nhà chơi game máy tính mãi."},
      {speaker:"女", pre:"那是我看错了，", blank:"那个人看上去真像你", post:"。",
       py:"Nà shì wǒ kàn cuò le, nàge rén kàn shangqu zhēn xiàng nǐ.",
       vn:"Vậy là tôi nhìn nhầm rồi, người đó trông giống bạn thật đấy."},
      {speaker:"男", pre:"花园里没有灯，", blank:"看错了也不奇怪", post:"。",
       py:"Huāyuán li méiyǒu dēng, kàn cuò le yě bù qíguài.",
       vn:"Vườn hoa không có đèn, nhìn nhầm cũng không lạ."}
     ],
     explain:"女：刚才你去后面的花园了？男：没有，我一直在家里玩儿电脑游戏。女：那是我看错了，那个人看上去真像你。男：花园里没有灯，看错了也不奇怪。问：关于女的，可以知道什么？ → 看错了一个人。"},
    {num:17, options:["担心男的的身体","耳朵进水了","游泳很小心"], ans:1, q:"女的怎么了？",
     lines:[
      {speaker:"男", pre:"小丽，", blank:"你怎么了", post:"？",
       py:"Xiǎolì, nǐ zěnme le?",
       vn:"Tiểu Lệ, bạn sao thế?"},
      {speaker:"女", pre:"刚才游泳时耳朵进水了，", blank:"现在耳朵里一直不舒服", post:"。",
      ...
      {speaker:"男", pre:"过来，我帮你看一下。", blank:"现在好些了吗？下次小心点儿", post:"。",
       py:"Guòlai, wǒ bāng nǐ kàn yíxià. Xiànzài hǎo xiē le ma? Xiàcì xiǎoxīn diǎnr.",
       vn:"Lại đây, tôi xem giúp bạn chút. Bây giờ đỡ hơn chưa? Lần sau cẩn thận hơn nhé."},
      {speaker:"女", pre:"好多了，", blank:"让你担心了", post:"。",
       py:"Hǎo duō le, ràng nǐ dānxīn le.",
       vn:"Đỡ nhiều rồi, để bạn lo lắng rồi."}
     ],
     explain:"男：小丽，你怎么了？女：刚才游泳时耳朵进水了，现在耳朵里一直不舒服。男：过来，我帮你看一下。现在好些了吗？下次小心点儿。女：好多了，让你担心了。问：女的怎么了？ → 耳朵进水了。"},
    {num:18, options:["白色","蓝色","黑色"], ans:1, q:"男的想试哪种颜色的衬衫？",
     lines:[
      {speaker:"女", pre:"先生，", blank:"您看这件衬衫怎么样", post:"？",
       py:"Xiānsheng, nín kàn zhè jiàn chènshān zěnme yàng?",
       vn:"Thưa anh, anh xem cái áo sơ mi này thế nào?"},
      {speaker:"男", pre:"还不错，除了白色，", blank:"还有其他颜色的吗", post:"？",
       py:"Hái búcuò, chúle báisè, hái yǒu qítā yánsè de ma?",
       vn:"Cũng được, ngoài màu trắng ra, còn có màu khác không?"},
      {speaker:"女", pre:"还有蓝色和黑色的，", blank:"拿一件您试试", post:"？",
       py:"Hái yǒu lánsè hé hēisè de, ná yí jiàn nín shìshi?",
       vn:"Còn có màu xanh và màu đen nữa, lấy một cái anh mặc thử nhé?"},
      {speaker:"男", pre:"好，", blank:"蓝色会让我的脸看上去更年轻些", post:"。",
       py:"Hǎo, lánsè huì ràng wǒ de liǎn kàn shangqu gèng niánqīng xiē.",
       vn:"Được, màu xanh sẽ khiến khuôn mặt tôi trông trẻ hơn một chút."}
     ],
     explain:"女：先生，您看这件衬衫怎么样？男：还不错，除了白色，还有其他颜色的吗？女：还有蓝色和黑色的，拿一件您试试？男：好，蓝色会让我的脸看上去更年轻些。问：男的想试哪种颜色的衬衫？ → 蓝色。"},
    {num:19, options:["感冒了","没洗脸","要买西药"], ans:0, q:"关于女的，可以知道什么？",
     lines:[
      {speaker:"男", pre:"你的脸色看上去不太好，", blank:"哪儿不舒服啊", post:"？",
       py:"Nǐ de liǎnsè kàn shangqu bú tài hǎo, nǎr bù shūfu a?",
       vn:"Sắc mặt bạn trông không tốt lắm, chỗ nào khó chịu vậy?"},
      {speaker:"女", pre:"我感冒了，", blank:"都快一个星期了", post:"。",
       py:"Wǒ gǎnmào le, dōu kuài yí ge xīngqī le.",
       vn:"Tôi bị cảm rồi, sắp một tuần rồi."},
      {speaker:"男", pre:"我去药店给你买点儿药吧，", blank:"买西药还是中药", post:"？",
       py:"Wǒ qù yàodiàn gěi nǐ mǎi diǎnr yào ba, mǎi xīyào háishi zhōngyào?",
       vn:"Tôi đi hiệu thuốc mua thuốc cho bạn nhé, mua thuốc tây hay thuốc bắc?"},
      {speaker:"女", pre:"好，", blank:"买点儿中药吧", post:"。",
       py:"Hǎo, mǎi diǎnr zhōngyào ba.",
       vn:"Được, mua chút thuốc bắc đi."}
     ],
     explain:"男：你的脸色看上去不太好，哪儿不舒服啊？女：我感冒了，都快一个星期了。男：我去药店给你买点儿药吧，买西药还是中药？女：好，买点儿中药吧。问：关于女的，可以知道什么？ → 感冒了。"},
    {num:20, options:["买船票","买机票","回国"], ans:1, q:"女的要去做什么？",
     lines:[
      {speaker:"男", pre:"", blank:"回国的船票买好了吗", post:"？",
       py:"Huí guó de chuánpiào mǎihǎo le ma?",
       vn:"Vé tàu về nước mua được chưa?"},
      {speaker:"女", pre:"坐船虽然便宜，但是太慢了，", blank:"要十四个小时", post:"。",
       py:"Zuò chuán suīrán piányi, dànshì tài màn le, yào shísì ge xiǎoshí.",
       vn:"Đi tàu tuy rẻ, nhưng chậm quá, phải mất mười bốn tiếng."},
      {speaker:"男", pre:"那我们还是坐飞机吧，你去买两张机票，", blank:"下周末的", post:"。",
       py:"Nà wǒmen háishi zuò fēijī ba, nǐ qù mǎi liǎng zhāng jīpiào, xià zhōumò de.",
       vn:"Vậy chúng ta đi máy bay thì hơn, bạn đi mua hai vé máy bay, cuối tuần sau nhé."},
      {speaker:"女", pre:"好的，", blank:"我现在就去", post:"。",
       py:"Hǎo de, wǒ xiànzài jiù qù.",
       vn:"Được, tôi đi ngay đây."}
     ],
