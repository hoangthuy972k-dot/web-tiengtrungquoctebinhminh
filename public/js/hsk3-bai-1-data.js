...
// ══════════════════════════════════════════
var fillData = [
  {pre:'虽然这个',blank:'周末',post:'工作很多，但是我还是想去看电影。',hint:'(cuối tuần)',ans:'周末'},
...
var sortData = [
  ...
  {words:['只要','天气','不','太','热','，','我们','就','打算','去','南方','旅游','。'],ans:'只要天气不太热，我们就打算去南方旅游。',audio:'只要天气不太热，我们就打算去南方旅游。'},
  {words:['他','早','就','把','作业','写','好','了','。'],ans:'他早就把作业写好了。',audio:'他早就把作业写好了。'},
  {words:['这','是','我','昨天','下午','准备','好','的','。'],ans:'这是我昨天下午准备好的。',audio:'这是我昨天下午准备好的。'},
  {words:['他','一边','收拾','行李','，','一边','检查','地图','和','手机','。'],ans:'他一边收拾行李，一边检查地图和手机。',audio:'他一边收拾行李，一边检查地图和手机。'},
...
var errorFixData = [
  ...
  {wrong:'那不能一直也睡觉啊。',
   opts:['那也不能一直睡觉啊。','那不能一直也睡觉啊。','那一直也不能睡觉啊。','那不能也一直睡觉啊。'],ans:0,
   exp:'也 (cũng) phải đứng NGAY SAU liên từ 那 và TRƯỚC động từ năng nguyện 能: 那 + 也 + 不能 + 一直睡觉.'},
  {wrong:'你跟去朋友一起吗？',
