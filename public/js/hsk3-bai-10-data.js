...
var listenData = {
  ...
  mc: [
    ...
    {num:12, options:['好点儿了','好多了','越来越不好'], ans:0,
     lines:[
       {speaker:'男', pre:'今天怎么样？', blank:'还发烧吗', post:'？', py:'Jīntiān zěnmeyàng? Hái fā shāo ma?', vn:'Hôm nay thế nào? Còn sốt không?'},
       {speaker:'女', pre:'吃了药比昨天好一些了，', blank:'但还头疼', post:'。', py:'Chīle yào bǐ zuótiān hǎo yìxiē le, dàn hái tóuténg.', vn:'Uống thuốc rồi đỡ hơn hôm qua một chút, nhưng vẫn đau đầu.'},
     ],
    ...
    {num:15, options:['三个','三十个','很多'], ans:2,
     lines:[
       ...
       {speaker:'男', pre:'我们这儿有三四个姓王的老师呢，', blank:'您找哪一个', post:'？', py:'Wǒmen zhèr yǒu sān-sì ge xìng Wáng de lǎoshī ne, nín zhǎo nǎ yí ge?', vn:'Ở đây chúng tôi có ba bốn giáo viên họ Vương, anh/chị tìm ai vậy?'},
     ],
    ...
    {num:17, options:['明天很冷','明天是阴天','下雪时最冷'], ans:0,
     lines:[
       ...
       {speaker:'男', pre:'上午下雪，', blank:'下午就晴了', post:'。', py:'Shàngwǔ xiàxuě, xiàwǔ jiù qíng le.', vn:'Sáng có tuyết, chiều thì nắng lại.'},
       ...
       {speaker:'男', pre:'雪后晴天比下雪时冷得多，', blank:'你不知道吗', post:'？', py:'Xuě hòu qíngtiān bǐ xiàxuě shí lěng de duō, nǐ bù zhīdào ma?', vn:'Trời nắng sau tuyết lạnh hơn lúc có tuyết nhiều đấy, bạn không biết à?'},
     ],
    ...
    {num:18, options:['买了一辆旧车','买的是自行车','买了五辆车'], ans:1,
     lines:[
       {speaker:'男', pre:'我昨天换了辆新车，', blank:'比那辆旧的舒服多了', post:'。', py:'Wǒ zuótiān huànle liàng xīn chē, bǐ nà liàng jiù de shūfu duō le.', vn:'Hôm qua tôi đổi chiếc xe mới rồi, thoải mái hơn chiếc cũ nhiều.'},
       {speaker:'女', pre:'又换了？', blank:'你已经换了四五辆了吧？多少钱', post:'？', py:'Yòu huàn le? Nǐ yǐjīng huànle sì-wǔ liàng le ba? Duōshao qián?', vn:'Lại đổi nữa à? Bạn đổi bốn năm chiếc rồi nhỉ? Bao nhiêu tiền?'},
       ...
       {speaker:'女', pre:'一百多？', blank:'自行车啊', post:'！', py:'Yìbǎi duō? Zìxíngchē a!', vn:'Hơn một trăm á? Xe đạp cơ đấy!'},
     ],
    ...
    {num:19, options:['妈妈高得多','一样高','女儿高得多'], ans:1,
     lines:[
       {speaker:'男', pre:'你女儿个子真高，', blank:'比你高多了吧', post:'？', py:'Nǐ nǚ\'ér gèzi zhēn gāo, bǐ nǐ gāo duō le ba?', vn:'Con gái bạn cao thật đấy, cao hơn bạn nhiều nhỉ?'},
       {speaker:'女', pre:'其实我跟她一样高，', blank:'只是她比我瘦多了', post:'。', py:'Qíshí wǒ gēn tā yíyàng gāo, zhǐshì tā bǐ wǒ shòu duō le.', vn:'Thực ra tôi cao bằng con bé, chỉ là con bé gầy hơn tôi nhiều thôi.'},
       ...
       {speaker:'女', pre:'今年十九了，正在国外学习，', blank:'学历史和数学', post:'。', py:'Jīnnián shíjiǔ le, zhèngzài guówài xuéxí, xué lìshǐ hé shùxué.', vn:'Năm nay 19 tuổi rồi, đang học ở nước ngoài, học Lịch Sử và Toán.'},
     ],
    ...
    {num:20, options:['去咖啡店','听音乐会','买东西'], ans:0,
     lines:[
       ...
       {speaker:'女', pre:'那就在这儿坐坐，', blank:'喝点儿水', post:'。', py:'Nà jiù zài zhèr zuòzuo, hē diǎnr shuǐ.', vn:'Vậy ngồi đây một chút, uống chút nước.'},
       {speaker:'男', pre:'楼上有个咖啡店，比这儿安静得多，环境也不错，', blank:'还有音乐', post:'。', py:'Lóushàng yǒu ge kāfēidiàn, bǐ zhèr ānjìng de duō, huánjìng yě búcuò, hái yǒu yīnyuè.', vn:'Trên lầu có một quán cà phê, yên tĩnh hơn ở đây nhiều, môi trường cũng đẹp, còn có nhạc nữa.'},
