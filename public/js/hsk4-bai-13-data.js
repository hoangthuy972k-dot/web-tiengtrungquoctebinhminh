...
var listenData = {
  type:'workbook',
  audio:'/audio/hsk4-bai-13/listen-full.mp3',
  dictation:[
  ...
  mc:[
    {num:1,options:['京剧演员','老师','医生'],ans:0,
    ...
    {num:2,options:['60多年','30多年','8年'],ans:0,
    ...
    {num:3,options:['跟着电视学唱','在学校学的','爷爷教的'],ans:0,
    ...
    {num:4,options:['有一些音乐基础','是中国人','接受过专门教育'],ans:0,
    ...
    {num:5,options:['流行音乐','京剧','古典音乐'],ans:0,
    ...
    {num:6,options:['举办中国传统文化节活动','放假一周','去春游'],ans:0,
    ...
    {num:7,options:['继续由李老师负责','由校长负责','由学生负责'],ans:0,
    ...
    {num:8,options:['星期五之前','下个月','明天'],ans:0,
    ...
    {num:9,options:['3000多年','300多年','30多年'],ans:0,
    ...
    {num:10,options:['一种药','一种饮料','一种菜'],ans:0,
